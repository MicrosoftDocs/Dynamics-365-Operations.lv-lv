...
description: "Šis raksts sniedz informāciju un piemērus par starpuzņēmumu rēķinu projektiem programmā Microsoft Dynamics 365 operācijām."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Šis raksts sniedz informāciju un piemērus par starpuzņēmumu rēķinu projektiem programmā Microsoft Dynamics 365 operācijām.

Jūsu organizācijai var būt vairākas nodaļās, meitasuzņēmumi un citas juridiskās personas, kas projektos savstarpēji pārsūta preces un pakalpojumus. Juridiska persona, kas sniedz pakalpojumu vai produktu sauc *kreditēšanas juridiska persona*, un juridiskās personas, kas saņem pakalpojumu vai produktu sauc *aizņēmumu juridiska persona*. 
...
[![Starpuzņēmumu rēķinu piemērs](./media/interco.invoicing-01.jpg)](./media/interco.invoicing-01.jpg) 

Mērķis ir veikt izmaksu kontroli, ieņēmumu atzīšana, nodokļus un pārsūtīt cenu starpuzņēmumu projekta darbībām, elastīgs un spēcīgs. Turklāt tiek sniegtas šādas iespējas:
...
1.  Iestatiet FRSI kā debitoru juridiskajā personā USSI un iestatiet USSI kā kreditoru juridiskajā personā FRSI. Šī uzdevuma izpildīšanai pastāv trīs ievades punkti.
    ...
    |------|-----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | A    | USSI, noklikšķiniet uz **Debitori**&gt;**klientiem**&gt;**visus klientus**. | Izveidojiet jaunu debitora ierakstu juridiskajai personai FRSI un atlasiet debitoru grupu.                                                                                                                                                                                                                           |
    | mljrd.    | FRSI, noklikšķiniet **kreditoru parādi**&gt;**kreditoriem**&gt;**visiem kreditoriem**.        | Izveidot jaunu kreditora ierakstu juridiskajai personai USSI un atlasiet kreditoru grupu.                                                                                                                                                                                                                               |
...
2.  Noklikšķiniet uz **projektu pārvaldības un grāmatvedības**&gt;**Setup**&gt;**projekta vadības uzskaites parametros**, un pēc tam noklikšķiniet uz **starpuzņēmumu** tab. Veids, kādā iestatāt parametrus, ir atkarīgs no tā, vai jūs esat piesaistīšanas juridiskā persona vai patapināšanas juridiskā persona.
...
3.  Noklikšķiniet uz **projektu pārvaldības un grāmatvedības**&gt;**Setup**&gt;**cenu**&gt;**transfertcenu**.
...
5.  Noklikšķiniet uz **Virsgrāmatas**&gt;**kontējumu uzstādījumi**&gt;**starpuzņēmumu kontiem**, un USSI un FRSI iestatīt relāciju.
...
| Solis | Ieejas punkts                                                                       | apraksts                                                                                                                                                                                       |
|------|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A    | **Projekta vadības un grāmatvedības**&gt;**tabeles**&gt;**visām tabeles** | Izveidot jaunu darba laika uzskaites tabulu. Darba laika uzskaites tabulas rindā, laukā **Juridiskā persona** atlasiet **FRSI**. Laukā **Projekta ID** atlasiet attiecīgo projektu juridiskajā personā FRSI. Ievadiet stundas katrai nedēļas dienai. |
...
| Solis | Ieejas punkts                                                                                      | apraksts                                                                                                                                                                                                                                                                          |
|------|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A    | **Kreditoru parādi**&gt;**rēķinus**&gt;**atvērtu kreditoru rēķinus**&gt;**jaunu kreditora rēķinu** | Izveidojiet jaunu kreditora rēķinu un ievadiet pakalpojumus, kas tika sniegti FRSI projekta vārdā.                                                                                                                                                                                  |
...
| Solis | Ieejas punkts                                                                                             | apraksts                                                                                                                                      |
|------|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| A    | **Projekta vadības un grāmatvedības**&gt;**projektu rēķiniem**&gt;**starpuzņēmumu debitora rēķina**  | Noklikšķiniet uz **Jauns**, lai atvērtu lapu **Izveidot starpuzņēmumu rēķinu**.                                                                                  |
| mljrd.    | **Projekta vadības un grāmatvedības**&gt;**projektu rēķiniem**&gt;**starpuzņēmumu debitoru rēķiniem** | Lapā **Izveidot starpuzņēmumu rēķinu** ievadiet juridisko personu, norādiet transakciju, ko vēlaties iekļaut, un pēc tam noklikšķiniet uz **Meklēt**. |
| K    | **Projekta vadības un grāmatvedības**&gt;**projektu rēķiniem**&gt;**starpuzņēmumu debitoru rēķiniem** | Atlasiet transakcijas, kuras iekļaut rēķinā, vai noklikšķiniet uz **Atlasīt visus**, lai rēķinā iekļautu visas sarakstā esošās transakcijas, un pēc tam noklikšķiniet uz **Labi**.                  |
...
| Solis | Ieejas punkts                                                                                        | apraksts                                                                                                             |
|------|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| A    | **Kreditoru parādi**&gt;**rēķinus**&gt;**izskata kreditoru rēķinus**                            | Pārskatiet rēķinu, lai pārbaudītu, vai darba laika uzskaites vērtības ir iekļautas, un pēc tam grāmatojiet kreditora rēķinu.                  |
| mljrd.    | **Projekta vadības un grāmatvedības**&gt;**projektu rēķiniem**&gt;**projekta rēķinu priekšlikumus** | Izveidojiet jaunu projektu rēķinu attiecīgajam projektam un pārbaudiet, vai tajā tiek rādītas grāmatotās stundu transakcijas.            |
