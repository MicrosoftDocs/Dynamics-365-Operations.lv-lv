---
title: "PVN likmes, pamatojoties uz nakti bāzes un aprēķinu metodes"
...
# <a name="sales-tax-rates-based-on-the-marginal-base-and-calculation-methods"></a>PVN likmes, pamatojoties uz nakti bāzes un aprēķinu metodes

Šajā rakstā ir paskaidrots, kā laukos Aprēķina pamatā un Aprēķina metode norādītās vērtības nosaka nodokļu likmes pārdošanas un pirkšanas transakcijās.
...
Marginālā base: **neto summa vienā rindiņā** 
...
Kopējā PVN = 50 x 30 % + 50 x 20 % + 100 x 10 % = 15 + 10 + 10 = 35,00 

Kopējā rēķina summa = 200.00 + 35,00 = 235,00 

**Variation** 

Ja rēķins ir divas rindas ar četriem vienumiem katrā rindā, neto summa par katru pozīciju ir 100,00 un PVN aprēķina šādi: 

PVN līnija 1 = 50 x 30 % + 50 x 20 % = 15 + 10 = 25,00 

PVN līnija 2 = 50 x 30 % + 50 x 20 % = 15 + 10 = 25,00 

Kopējā PVN = 25,00 + 25.00 = 50,00 

Kopējā rēķina summa = 200.00 + 50.00 = 250,00
...
Marginālā base: **neto summa uz vienu vienību** 

Aprēķina metode: **visu summu** 
...
Marginālā base: **neto summu rēķina bilance** 

Aprēķina metode: **intervāla** pārdošanas rēķins ir 2 rindiņas ar 4 lukturiem katra rindās katru 25,00. Rēķina bilances neto summa ir 4 x 25,00 + 4 x 25,00 = 200,00. Nodoklis tiek aprēķināts šādi: Kopējais pārdošanas nodoklis = 50 x 0,30 + 50 x 0,20 + 100 x 0,10 = 15 + 10 + 10 = 35,00 Rēķina kopsumma = 200,00 + 35,00 = 235,00
...
Aprēķina pamatā: **Bruto summa uz rindu** Aprēķina metode: **Intervāls** Papildus ir aprēķināts vēl viens nodokļa kods speciālam nodoklim 5,00 par katru lampu. Nodokli pievieno neto summai pirms PVN aprēķina. Jūs iegādājaties 8 lampas, kas maksā 25,00/gabalā. Rēķina rindas neto summa ir 200,00. Rēķina rindas bruto summa ir 8 x 25,00 + 8 x 5,00 = 240,00. Nodokļu aprēķina šādi: kopējā PVN = 50 x 0,30 + 50 x 0,20 + 140 x 0,10 = 15 + 20 + 14 = 39,00 kopējais nodoklis = 5.00 x 8 = 40,00 kopējai rēķina summai = 200.00 + 39,00 + 40,00 = 279,00

**Variation** 

Ja rēķins ir izveidots, izmantojot 2 rēķina rindās ar 4 vienumi katrā rindā, katram rēķina rindas neto summa ir 100,00. Bruto summa (iekļaujot nodokli 4 x 5,00) uz rēķina rindu būtu 120,00, un pārdošanas nodoklis tiek izveidots šādi: 1. pārdošanas nodokļa rēķina rinda = 50 x 0,30 + 50 x 0,20 + 20 x 0,10 = 15 + 10 + 2 = 27,00 2. pārdošanas nodokļa rēķina rinda = 50 x 0,30 + 50 x 0,20 + 20 x 0,10 = 15 + 10 + 2 = 27,00 Kopējais pārdošanas nodoklis = 27,00 + 27,00 = 54,00 Kopējais nodoklis = 5,00 x 8 = 40,00 Rēķina kopsumma = 200,00 + 54,00 + 40,00 = 294,00
...
> [!NOTE]
> PVN grupā, var būt tikai viena PVN kods ar šo izvēli marginālā bāzes laukā
...
Marginālā base: **rēķinu kopsummas iesk. citu PVN** aprēķina metode: **intervāls**   
Ir īpašs nodoklis 5,00 par katru lukturi. Nodokli pievieno neto summai pirms PVN aprēķina. Jūs iegādājaties 8 lampas, kas maksā 25,00/gabalā. Rēķina neto summa ir 200,00. Rēķina bruto summa ir 200,00 + (8 x 5,00) = 240,00. Nodoklis tiek aprēķināts šādi: Kopējais pārdošanas nodoklis = 50 x 0,30 + 50 x 0,20 + 140 x 0,10 = 15 + 10 + 14 = 39,00 Kopējais nodoklis = 5,00 x 8 = 40,00 Rēķina kopsumma = 200,00 + 39,00 + 40,00 = 279,00

Plašāku informāciju skatiet [visu summu un intervāla aprēķina opcijas PVN kodus](whole-amount-interval-options-sales-tax-codes.md) un [PVN aprēķina metožu jomā izcelsmes](sales-tax-calculation-methods-origin-field.md).
