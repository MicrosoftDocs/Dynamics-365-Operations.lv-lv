...
| Vārds, uzvārds                        | Dimensijas elementu datu savienotājs |
|-----------------------------|--------------------------------------|
...
| Vārds, uzvārds                  | Uzskaites valūta | Maiņas kursa veids | Finanšu kalendārs | Izmaksu elementa dimensija | Statiskā dimensija       |
|-----------------------|---------------------|--------------------|-----------------|------------------------|-----------------------------|
...
| Vārds, uzvārds        | Datu savienotājs                                                                     | Statisko dimensiju elements |
|-------------|------------------------------------------------------------------------------------|------------------------------|
