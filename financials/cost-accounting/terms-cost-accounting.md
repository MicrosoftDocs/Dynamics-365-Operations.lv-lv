...
- **Fiksētas izmaksas** -fiksētās izmaksas ir izmaksas, kas nav mainīties tuvākajā laikā neatkarīgi no darbības līmeņa izmaiņas. Fiksētas izmaksas var būt, piemēram, biznesa pamata saimnieciskās darbības izdevumi, piemēram, noma, ka netiks ietekmēta pat tad, ja aktivitātes līmenis palielinās vai samazinās.

- **Mainīgo izmaksu** -mainīgo izmaksu izmaiņas atbilstoši izmaiņām aktivitātes līmeni. Piemēram, noteiktu tiešo materiālu izmaksas ir saistītas ar katru pārdoto preci. Jo vairāk preču tiek pārdots, jo vairāk ir tiešo materiālu izmaksu.

- **Semi-mainīgās izmaksas** -semi-mainīgās izmaksas ir izmaksas, kas daļēji nemainīgo un daļēji mainīgo. Piemēram, interneta piekļuves maksa ietver standarta mēneša piekļuves maksu un platjoslas lietošanas maksu. Standarta mēneša piekļuves maksa ir fiksēta izmaksa, bet platjoslas lietošanas maksa ir mainīga izmaksa.
