...
Bankas izraksta importēšanas iestatījumi ir dažādi, un tie ir atkarīgi no jūsu elektroniskā bankas izraksta formāta. Microsoft Dynamics 365 operācijām nodrošina trīs bankas paziņojumu formātus no kastē: ISO20022, MT940 un BAI2.

## <a name="sample-files"></a>Parauga faili
Visas trīs formātiem, ir nepieciešams failus, kas pārveido elektroniskos bankas izrakstu no sākotnējā formātā formātā, kas Dynamics 365 operācijām var izmantot. Nepieciešamie resursu faili ir atrodami Microsoft Visual Studio programmu pārlūka zarā **Resursi**. Kad faili ir atrasti, kopējiet tos uz vienu zināmu vietu, lai iestatīšanas procesa laikā tos varētu ērti augšupielādēt.

| Resursa nosaukums                                           | Faila nosaukums                            |
|---------------------------------------------------------|--------------------------------------|
| BankStmtImport\_BAI2CSV\_, lai\_BAI2XML\_xslt              | BAI2CSV-to-BAI2XML.xslt              |
| BankStmtImport\_BAI2XML\_, lai\_saskaņošanas\_xslt       | BAI2XML-to-Reconciliation.xslt       |
| BankStmtImport\_BankReconciliation\_, lai\_Composite\_xslt | BankReconciliation-to-Composite.xslt |
...
| BankStmtImport\_MT940XML\_, lai\_saskaņošanas\_xslt      | MT940XML-to-Reconciliation.xslt      |
...
Zemāk ir piemēri papildu bankas saskaņojuma importa failu tehnisku izkārtojumu definīcijas un trīs saistītos bankas pārskata piemērs failus: https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/how-to-articles/exofbankstfotechlayouts  
...
1.  Dodieties uz **darbvietām**&gt;**datu pārvaldības**.
2.  Click **Import**.
...
10. Kārtas numuram 1 noklikšķiniet uz **Augšupielādēt failu** un atlasiet iepriekš saglabāto failu** ISO20022XML-to-Reconciliation.xslt**. **Piezīme:** Dynamics 365 operācijas transformācijas failus ir paredzētas standarta formātā. Jo bankas bieži vien novirzās no šajā formātā, jums var būt nepieciešams atjaunināt transformācijas failu kartēt uz bankas pārskata formātu. <!-- For details about the expected format for ISO20022, see [Dynamics AX ISO20022 Layout](./media/dynamicsaxiso20022layout1.xlsx).-->
11. Click **New**.
...
1.  Dodieties uz **naudas un bankas vadības**&gt;**Setup**&gt;**bankas saskaņojuma iestatījuma**&gt;**bankas pārskatu formāts**.
2.  Click **New**.
...
1.  Dodieties uz **naudas un bankas vadības**&gt;**bankas kontiem**.
...
12. Kārtas numuram 2 noklikšķiniet uz **Augšupielādēt failu** un atlasiet iepriekš saglabāto failu **MT940XML-to-Reconciliation.xslt**. **Piezīme:** Dynamics 365 operācijas transformācijas failus ir paredzētas standarta formātā. Jo bankas bieži vien novirzās no šajā formātā, jums var būt nepieciešams atjaunināt transformācijas failu kartēt uz bankas pārskata formātu. <!--- For details about the expected format for MT940, see [Dynamics AX MT940 Layout](./media/dynamicsaxmt940layout1.xlsx)-->
13. Click **New**.
...
11. Klikšķiniet **Jauns**.
12. Kārtas numuram 2 noklikšķiniet uz **Augšupielādēt failu** un atlasiet iepriekš saglabāto failu **BAI2XML-to-Reconciliation.xslt**. **Piezīme:** Dynamics 365 operācijas transformācijas failus ir paredzētas standarta formātā. Jo bankas bieži vien novirzās no šo formātu, un jums var būt nepieciešams atjaunināt transformācijas failu kartēt uz bankas pārskata formātu. <!--- For details about the expected format for BAI2, see [Dynamics AX BAI2 Layout](./media/dynamicsaxbai2layout1.xlsx).-->
13. Click **New**.
14. Kārtas numuram 3 noklikšķiniet uz **Augšupielādēt failu** un atlasiet iepriekš saglabāto failu **BankReconciliation-to-Composite.xslt**.
15. Noklikšķiniet uz **Lietot transformācijas**.
