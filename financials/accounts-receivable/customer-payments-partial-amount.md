...
Kad klienti veic daļēju maksājumu, iespējams, tie plāno veikt papildu daļēju maksājumu, lai pilnībā segtu rēķinu. Jāiestata termiņatlaides daļēju samaksu veikt * * aprēķināt termiņatlaides daļējiem maksājumiem * * iespēju **Jā** par **Accounts receivable parameters** lapu. 
...
Piemēram, jūs piedāvājāt maksājuma nosacījumus ar 2 procentu termiņatlaidi, ja rēķins tiek apmaksāts 10 dienu laikā pēc tā izrakstīšanas. Tika iegrāmatots rēķins par summu 100,00, un debitors izmantoja termiņatlaidi. Ja debitors atgriež preces un jūs izsniedzat kredīta notu, varat ievadīt kredīta notu par summu -100,00. Skatot kredīta notu lapā **Nosegt atvērtās darbības**,** 98,00** parādās laukā **Nosedzamā summa**, un **-2,00** parādās laukā **Termiņatlaides summa**. Atlaides summa tiek grāmatota uz termiņatlaides kontu.
...
Klientiem iespējams veikt daļēju maksājumu, ja atlikusī summa netiks samaksāts, bet ir lielāks nekā iztrūkums summa, kas norādīta **konts kreditoru parametrus** lapā. Ja vēlaties atzīmēt kā pilnībā nosegtās rēķina, var izmantot **pilnu norēķinu** opciju uz **nokārtot darījumu** lapā. (Jūs varat iespējot pilnīgas segšanas funkcionalitāti, izmantojot konfigurācijas atslēgu.) Piemēram, rēķins tiek iegrāmatots par summu 1000,00 un klients veic maksājumu 990,00. Esam vienojušies, ka klientam nav jāmaksā atlikušos 10.00. Pēc atzīmēšanas rēķinu apmaksai, varat arī atzīmēt izvēlētos **pilnu norēķinu**. Tad rēķins tiks uzskatīts par pilnībā nosegtu. 10,00 starpība tiek grāmatota uz termiņatlaides kontu kā papildu termiņatlaides summa.
