...
-   **Vienmēr** -var piešķirt darbiniekiem jaunas pozīcijas veidojot pozīcijām. Veidojot pozīcijas, **pieejams piešķiršanai** datumu un laiku, par **vispārējā** cilnē **nostāju** lapa tiek automātiski iestatīti, lai izveides datumu un laiku.
...
[Uzņēmums īpašu HR parametru iestatīšana](set-up-company-specific-hr-parameters.md)
