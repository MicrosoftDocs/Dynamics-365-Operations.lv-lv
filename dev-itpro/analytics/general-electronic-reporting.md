...
-   Tas veido vienu kopīgu rīku elektroniskā pārskata dažādos domēnos un aizvieto vairāk nekā 20 dažādiem dzinējiem, ko darīt kaut kāda veida elektroniskās ziņošanas par Microsoft Dynamics 365 operācijām.
-   Tas padara atskaišu formātā, izolēti no pašreizējā dinamika 365 operāciju īstenošanai. (Citiem vārdiem sakot, formāts ir piemērojamas dažādas versijas Dynamics 365 operācijām.)
...
-   Modelis kartēšanas saites atlasīti Dynamics 365 operācijas datu avotus ar atsevišķiem elementiem datu modelis, kas nosaka izpildlaikā datu plūsmu un noteikumi biznesa datiem iedzīvotāju datu modeļa komponents.
...
-   Uzņēmums -&gt; kreditors -&gt; maksājumu darījumiem AP domēna
-   Debitors -&gt; Company -&gt; maksājumu darījumiem AR domēna
...
-   To var izmantot dažādos Dynamics 365 operācijas datu tipiem kā datu avotiem datu modeli. Piemēram, tā var izmantot tabulas, datu elementus, metodes vai uzskaitījumus.
...
-   Tā atbalsta Dynamics 365 pārveides darbībām datu vajadzīgo grupu, filtrēšanu, kārtošanu un summējot datus un pievienojot arī ar loģisko aprēķinātie lauki, kas ir izstrādātas, izmantojot Microsoft Excel-līdzīgas formulām (sīkāku informāciju, skatiet [formulu dizainers elektroniskās ziņošanas](general-electronic-reporting-formula-designer.md)).

[![Kā Excel formulu redaktors](./media/pic-formula-1024x615.png)](./media/pic-formula.png) datu modeļa komponents ir paredzēts katrā uzņēmējdarbības jomā, kas būtu jāizmanto kā vienotu datu avotu uzrādīšanas izolē, reportāžas no fiziskās īstenošanas dinamiku 365 operācijas datu avotiem, kas pārstāv domēnam specifisku biznesa koncepcijas un funkcijas tādā veidā, ka padara ziņošanas formātu sākotnējā konstrukcija un turpmākai uzturēšanai efektīvāku.
...
-   **Pabeigts** versiju var konvertēt **SHARED** versija. Šī versija tiek publicēta LCS, un to var izmantot ziņošanas pasaules procesos.
-   Versiju **KOPLIETOTS **var pārveidot par versiju **PĀRTRAUKTS**. Pēc tam šo versiju var dzēst.

Versijas, kas ir vai nu * * pabeigts * * vai **SHARED** statuss ir pieejamas citas datu apmaiņai. Komponentam, kam ir šie statusi, var izpildīt tālāk uzskaitītās darbības.

-   Viņi var serializētu XML formātā un izvestas no Dynamics 365 operācijām kā XML formāta fails.
-   Tie var reserialized no XML faila un importēti programmā Dynamics 365 operācijām kā jaunu versiju ER detaļas.

#### <a name="component-date-effectivity"></a>Komponenta spēkā stāšanās datums

ER komponentu versijas ir ar spēkā stāšanās datumu. ER komponentam var definēt datumu** Spēkā no**, lai norādītu datumu, kad šis komponents stājas spēkā atskaišu veidošanas procesiem. Dynamics 365 operācijām sesijas datumu izmanto, lai definētu, vai komponents ir derīgs izpildei. Ja noteiktam datumam ir derīgas vairākas versijas, tad atskaišu veidošanas procesiem tiek izmantota jaunākā versija.

#### <a name="component-access"></a>Komponenta piekļuve

Piekļuve ER formāta komponentiem ir atkarīga no iestatījuma ISO valsts/reģiona kodam. Ja šo iestatījumu tukšu atlasīto versiju formātā konfigurēšanas formāta komponenta var piekļūt no jebkura Dynamics 365 uzņēmuma darbības palaišanas laikā. Kad šis iestatījums ir ISO valstu/reģionu kodus, formāts komponents ir pieejama tikai no Dynamics 365 darbības uzņēmumiem, kas ir primāro adresi, kas ir noteikts viens no formāta komponenta ISO valstu/reģionu kodus. Datu formāta komponenta dažādām versijām var būt dažādi iestatījumi ISO valsts/reģiona kodiem.

#### <a name="configuration"></a>Konfigurācija

ER konfigurācija ir aplika noteiktam ER komponentam — **Datu modelis **vai **Formāts**. Konfigurācija var ietvert noteikta ER komponenta dažādās versijas. Katra konfigurācija tiek atzīmēta kā piederoša noteiktam konfigurācijas nodrošinātājam. **Projektu** konfigurācijas komponentu versiju var labot, atlasot konfigurācijas īpašnieka kā aktīva sniedzējs ER iestatījumos Dynamics 365 operācijām. Katra modeļa konfigurācija satur komponentu **Datu modelis**. Jaunu formāta konfigurāciju var izveidot (atvasināt) no konkrētas datu modeļa konfigurācijas. Izveidotā formāta konfigurācija konfigurāciju kokā tiek rādīta kā sākotnējā datu modeļa konfigurācijas pakārtotais elements. Izveidotā formāta konfigurācija ietver komponentu **Formāts**. Sākotnējā modeļa konfigurācijas komponents **Datu modelis** automātiski tiek ievietots pakārtotā formāta konfigurācijas komponentā **Formāts** kā noklusējuma datu avots. ER konfigurācija tiek koplietots Dynamics 365 darbības uzņēmumiem.

#### <a name="provider"></a>Piegādātājs

ER nodrošinātājs ir puses identifikators, kas tiek izmantots, lai norādītu katras ER konfigurācijas autoru (īpašnieku). ER jums ļauj pārvaldīt konfigurāciju nodrošinātāju sarakstu. Formatēt konfigurācijām, kurās elektroniskos dokumentus, kā daļa no Dynamics 365 darbības risinājumu tiek atzīmētas kā īpašumā tiek nodota **Microsoft** pakalpojumu sniedzēja konfigurācijas.

#### <a name="repository"></a>Repozitorijs

ER repozitorijā glabājas ER konfigurācijas. Šobrīd tiek atbalstīti šāda veida ER krātuvēs: **operācijas resursu** un **LCS projekta**. * * Operācijas resursu * krātuve nodrošina piekļuvi konfigurācijām, kurās ir izdalījies kā Dynamics 365 darbības risinājumu daļa no Microsoft puses kā ER konfigurācijas nodrošinātāju sarakstam. Šie konfigurācijas var ieved pašreizējā dinamika 365 darbības gadījuma un izmantot elektroniskās ziņošanas. Tās var izmantot arī papildu lokalizācijām/pielāgojumiem. Repozitorijs **LCS projekts **nodrošina piekļuvi noteikta LCS projekta (LCS projekta līdzekļu bibliotēkas) konfigurāciju sarakstam, kurš tika atlasīts repozitorija reģistrācijas posmā. ER var augšupielādēt koplietojamu konfigurācijas no pašreizējā dinamika 365 operācijas gadījumā ar konkrētu **LCS projekta** repozitorijā. Konfigurācijas var importēt arī no konkrētā **LCS projekta** krātuvi savā pašreizējā dinamika 365 operācijas gadījumā. Nepieciešama **LCS projekta** krātuvēm var reģistrēt atsevišķi katram konfigurācijas nodrošinātājam pašreizējā dinamika 365 operācijas gadījumā. Katru repozitoriju var piešķirt noteiktam konfigurācijas nodrošinātājam.

## <a name="supported-scenarios"></a>Atbalstītie scenāriji
### <a name="building-a-data-model"></a>Datu modeļa veidošana

ER nodrošina modeļa veidotāju, kuru varat izmantot, lai izveidotu datu modeli noteiktam biznesa domēnam. Visus domēnam raksturīgos biznesa elementus un attiecības starp tiem varat norādīt datu modelī kā hierarhisku struktūru. Nākamajā attēlā ir parādīts šāda tipa datu modeļa piemērs (maksājumu domēna datu modelis). [![Datu modeļa piemērs](./media/pic-data-model-1024x550.png)](./media/pic-data-model.png) iepazīties ar detalizētu informāciju par šo scenāriju, spēlēt **ER dizains domēns specifisku datu modelis** uzdevumu rokasgrāmata (daļa no **7.5.4.3 Iegūstiet/pilnveidot to pakalpojumu/šķīduma komponenti (10677)** biznesa procesu).

### <a name="translating-data-model-content"></a>Datu modeļa satura tulkošana

Datu modeļa saturs (uzlīmes un apraksti) var jābūt tulkotam citās valodās, kas Dynamics 365 operāciju atbalsta. Iespējams, datu modeļa saturu vēlaties tulkot tālāk uzskaitīto iemeslu dēļ.
...
-   Pie izpildes laiku, padarīt saturu vairāk lietotājam draudzīgu, sniedzot norādījumus un palīdzēt izpildes laika parametriem un konfigurēts validēšanas ziņojumi (kļūdu un brīdinājumu), arī valodā, kas šobrīd pieteicies Dynamics 365 darbību lietotājam dod priekšroku

Nākamajā attēlā ir parādīts piemērs tam, kā datu modeļa saturu no angļu valodas var tulkot japāņu valodā. [![Datu modeļa saturs latviešu valodā](./media/pic-translate-en-1024x495.png)](./media/pic-translate-en.png)[![datu modeļa satura pārtulkot japāņu](./media/pic-translate-ja-1024x495.png)](./media/pic-translate-ja.png)

### <a name="configuring-data-model-mappings"></a>Datu modeļa kartējumu konfigurēšana

ER sniedz modelis kartēšanas dizainers, kas ļauj lietotājiem kartes datu modeļus, ko viņi ir izveidojuši īpašu dinamiku 365 operācijas datu avotiem. Nākamajā attēlā ir parādīts šī tipa datu modeļa kartējuma piemērs (maksājumu domēna datu modeļa kartējums **SEPA kredīta pārskaitījums**). [![Datu modelis kartēšanas piemērs ](./media/pic-model-mapping-1024x551.png)](./media/pic-model-mapping.png)iepazīties ar detalizētu informāciju par šo scenāriju, spēlēt **ER definēt modelis kartēšanas un atlasiet datu avotu** un **ER kartes datu modeļa uz izvēlēto datu avotu** uzdevumu ceļveži (daļa no **7.5.4.3 Iegūstiet/pilnveidot to pakalpojumu/šķīduma komponenti (10677)** biznesa procesu).
...
ER var glabāt izstrādāta datu modeli kopā ar saistīto datu kartējumu kā modeļa konfigurācijas pašreizējā dinamika 365 operācijas gadījumā. Nākamajā attēlā ir parādīts šāda tipa datu modeļa konfigurācijas piemērs (maksājumu modeļa konfigurācija). [![Datu modeļa konfigurācijas piemērs ](./media/pic-model-configuration-1024x585.png)](./media/pic-model-configuration.png)iepazīties ar detalizētu informāciju par šo scenāriju, spēlēt **ER kartes datu modeļa uz izvēlēto datu avotu** uzdevumu rokasgrāmata (daļa no **7.5.4.3 Iegūstiet/pilnveidot to pakalpojumu/šķīduma komponenti (10677)** biznesa procesu).

### <a name="building-a-format-that-uses-a-data-model-as-a-base"></a>Tāda formāta veidošana, kas kā pamatu izmanto datu modeli

ER atbalsta formāta veidotāju, ko varat izmantot, lai izveidotu konkrēta elektroniskā dokumenta formātu atlasītajam biznesa domēnam, kā pamatu atlasot modeļa komponentu. Tas pats ER formāta veidotājs jums ļauj izveidoto formātu kartēt uz atlasīto domēna datu modeļa kartēšanu kā datu avotu. Nākamajā attēlā ir parādīts šāda tipa formāta piemērs (formāta konfigurācija, kas nodrošina **BACS** maksājuma formātu Apvienotajai Karalistei). [![Formātā, kas ir par pamatu datu modelis piemērs](./media/pic-format-1024x690.png)](./media/pic-format.png) iepazīties ar detalizētu informāciju par šo scenāriju, spēlēt **ER dizains domēns noteiktā formātā** uzdevumu rokasgrāmata (daļa **7.5.4.3 Iegūstiet/pilnveidot to pakalpojumu/šķīduma komponenti (10677)** biznesa procesu).
...
ER formāta veidotāju var izmantot, lai veidotu īpašu elektronisko dokumentu OPENXML darblapas formātā. Ilustrācijā parādīts piemērs šāda veida formāts (formātu konfigurācija ģenerēt OPENXML darblapa ar informāciju par atlasīto maksājuma žurnāla):[![Pic ER-formātā-Excel](./media/pic-er-format-excel.jpg)](./media/pic-er-format-excel.jpg) iepazīties ar detalizētu informāciju par šo scenāriju, spēlēt **ER izveidot konfigurāciju atskaites formātā OPENXML** uzdevumu rokasgrāmata (daļa **7.5.4.3 Iegūstiet/pilnveidot to pakalpojumu/šķīduma komponenti (10677)** biznesa procesu). Izmantot minēto zem Excel failu kā veidni projektēšana ER formāta pabeigšanai formāta veidnes importēšanas šā uzdevuma ceļveža soli: [maksājumu atskaites veidne (SampleVendPaymWsReport.xlsx)](https://go.microsoft.com/fwlink/?linkid=845202)
...
ER var glabāt izstrādāta formātā kopā ar konfigurēto datu kartējumu kā formātu konfigurācija pašreizējā dinamika 365 operācijas gadījumā. Iepriekšējā attēlā ir parādīts šāda tipa formāta konfigurācijas piemērs (**BACS (UK)**, kas ir konfigurācijas **Maksājumu modelis **pakārtotais elements). Lai iepazītos ar detalizētu informāciju par šo scenāriju, atskaņojiet uzdevuma ceļvedi **ER Izveidot domēnam specifisku formātu** (daļa no biznesa procesa **7.5.4.3. Iegūt/izstrādāt IT pakalpojumu/risinājuma komponentus (10677)**).

### <a name="configuring-dynamics-365-for-operations-to-start-to-use-a-created-format-internally"></a>Dynamics 365 operācijām, ar ko sākt lietot iekšēji izveidotās formāta konfigurēšana

Dinamika 365 operācijām var konfigurēt, lai sāktu lietot izveidots formātā, lai radītu elektronisko ziņojumu. Atsauce uz izveidoto formāta konfigurāciju ir jādefinē noteikta domēna iestatījumos. Piemēram, lai sāktu lietot ER Formatēt konfigurāciju elektronisko kreditoru maksājumiem BACS formātā, formātu konfigurācija būtu atsauce īpašu maksāšanas, kā parādīts nākamajās ilustrācijās: 

[![BACS (UK) formātu konfigurācija](media/ger-bacs-uk-format-configuration.png) 

[![BACS (UK) formāts maksāšanas metodē atsauču](media/ger-bacs-uk-format-method.png) 
...
ER ļauj LCS ER komponenti jāimportē pašreizējā dinamika 365 operācijas gadījumā. Ir nepieciešams repozitorijs ar tipu **LCS projekts**. Kad ER detaļas ir importēts no LCS pašreizējā dinamika 365 darbības gadījumam, gadījuma īpašnieks kļūst patērētājam par pakalpojumu, kas nodrošina īpašnieks (autors) importa komponentes. Piemēram, ja formāta komponents ir izveidotas, lai radītu īpašu elektronisko dokumentu no Dynamics 365 operācijām valsts/reģiona specifiskā formātā (lokalizācija scenārijs), tiek pieņemts, ka pakalpojumu patērētājs varēs iegūt atjauninājumus, kas veiktas šo formātu, lai saglabātu atbilst likumdošanas prasībām. Lai iepazītos ar detalizētu informāciju par šo scenāriju, atskaņojiet uzdevuma ceļvedi **ER Importēt konfigurāciju no Lifecycle Services** (daļa no biznesa procesa **7.5.4.3. Iegūt/izstrādāt IT pakalpojumu/risinājuma komponentus (10677)**).
...
## <a name="list-of-er-configurations-that-are-delivered-in-the-dynamics-365-for-operations-solution"></a>ER sastāvi, kas tiek piegādāti Dynamics 365 darbības risinājumu saraksts
