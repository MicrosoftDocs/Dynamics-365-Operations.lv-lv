...
---
# <a name="select-data-model-definition-while-creating-format-for-electronic-reporting-er"></a>Atlasīt datu modeļa definīciju, veidojot formātu elektronisko pārskatu veidošanai (ER)
