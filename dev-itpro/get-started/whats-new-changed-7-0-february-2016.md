---
title: "Kāda ir jaunā vai mainītā Dynamics AX 7.0 (februārī 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Kāda ir jaunā vai mainītā Dynamics AX 7.0 (februārī 2016)
...
| Automatizējiet būvēšanu, testēšanu un izvietošanu.                                                                            | Daļēji pieejams                                                                                                                                                                                | Izvietojiet izstrādātāja topoloģiju, izmantojot izstrādātāja un būvējuma VM. Automātiski konfigurējiet būvējuma VM, lai atklātu, būvētu moduļus no Visual Studio Online (VSO) un izpildītu testus. C\# un X + + modulis apkopošanu un atsauces tiek atbalstīti. | Šī iespēja palielina izstrādātāju produktivitāti, samazinot izmaksas un testēšanai un pārbaudēm nepieciešamo darbu.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Izmantojiet biznesa savienotāja priekšrocības, lai autorētu biznesa loģiku un atbalstītu integrēšanas scenārijus.         | Biznesa savienotājs ir pieejams no pārvaldītā koda piezvana uz X + + kodā. Mēs iesakām izmantot biznesa savienotājā tikai autors biznesa loģikas c\#, nevis ' ' integrācijas scenārijus. | Biznesa savienotājs vairs netiek atbalstīts. Autorēšanas prasības tiek nodrošinātas ar to, ka X++ kods tiek kompilēts par pārvaldītu kodu. Līdz ar to interop veikšana ir vienkāršāka. Integrēšanas scenāriji tiek izpildīti, izmantojot OData.       | Turpmāk biznesa savienotāju vairs nevarat izmantot.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>Ziņojuma opcijas ir pievienoti, tāpēc, ka dažādus filtrus var piemērot lietotājam ir skatot atskaiti. Jaunu atskaiti pēc tam tiek ģenerēts, pamatojoties uz šiem filtriem.</td>
...
<td>Analizēt finanšu datus, izmantojot Power BI "Uzraudzīt finanšu sniegums" saturu.</td>
<td>Nav pieejams</td>
...
<td>Pašreizējā Dynamics AX versijā palīdzības sistēma rāda uzdevumu ceļvežus, kas tiek glabāti pakalpojumu Microsoft Dynamics Lifecycle Services (LCS) BPM. Palīdzības sistēma rāda arī tēmas no Microsoft vikivietnes. Lai iegūtu papildinformāciju, skatiet [Dynamics AX Help - darba sākšana](help-overview.md) un [jauno uzdevumu rokasgrāmatās, kas pieejamas (februārī 2016)](new-task-guides-available-february-2016.md).</td>
...
<td>Līdzeklis ir ieviesta kā elektronisko atskaišu konfigurācijas. Šī funkcionalitāte ir pieejama Vācijai un Austrijai.</td>
...
<td>Bilances saraksts ar grupu kopsummu kontiem atskaitē tiek īstenota kā SSRS atskaite (LedgerAccountSum\_FR).</td>
...
<td>Atsevišķa Intrastat preču kodu sarakstu tiek apvienoti ar produkta hierarhijas tipa preču kodam.</td>
...
<td>Intrastat preču kodam ir teksta lauku, lai norādītu papildu vienības, un * * produkta * kartei ir lauku, lai norādītu daudzumu papildu vienību kilogramos.</td>
...
<tr class="odd">
<td>Analizēt mazumtirdzniecības pārdošanas kanāla datus, izmantojot "Mazumtirdzniecībā Monitor performance" Power BI saturu.</td>
<td>Nav pieejams</td>
...
<li>Tā piedāvā "gatavus" alternatīvās piegādes pakotnēs, piemēram, kombināciju vietā/noliktavas/variants/transporta veidu, pamatojoties uz visātrāko piegādes (agrākais pieejamu datumu) kritērijs, ko lietotājs var izvēlēties kādu no.</li>
