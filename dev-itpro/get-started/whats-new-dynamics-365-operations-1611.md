...
| Izveidot un uzturēt izdevumus, kas nav pievienoti izdevumu pārskatam.    | Lietotājs tagad var izveidot izdevumus un uzturēt tos (piemēram, pēc ieejas plūsmu pievienošanas vai uzskaitīšanas, vai viesu piešķiršanas) bez nepieciešamības vispirms izveidot izdevumu pārskatu. Vienu vai vairākus izdevumus var atlasīt un pievienot jaunam izdevumu pārskatam, lai tos varētu iesniegt apstiprināšanai. Jaunu lapu uzturēšanas izdevumi ir pieejami **izdevumu pārvaldības**&gt;**savus izdevumus**&gt;**izdevumi**.                                                                                                                                                                                                                                                       |
...
| Piekļūtu piecas jaunas jaudas BI saturu iepakojumā cilvēkresursu                                     | Jauna satura pakotnes ļauj cilvēkresursu organizācijām un cilvēkresursu vadītājiem, lai analizētu šādus: darbaspēka metriku • demogrāfisko sadalījumu pēc vecuma, dzimuma un ģimenes stāvokļa • salīdzināt Novājināšana līmenis gadu gadu un redzēt iemeslus darbinieku ir atstājot uzņēmumā • skatu sarakstu, brīvajām vakancēm, kā arī salīdzinājums ar slēgtām vakancēm kompensāciju un pabalstu • salīdzinātu stundu sarakstu un algoti darbinieki • apskatīt pieejamās priekšrocības • View darbinieki iesaistījušies darbinieku skaits pēc nodarbinātības veida Recruiting • analizēt pretendentiem, pamatojoties uz pieteikuma iesniedzējiem, ja viņi nāk no, un ko pozīcijām, tie esam pieteikšanai organizācijas apmācību • kursu reģistrācija pēc atrašanās vieta • Couse apmeklēšanu ar statusu • darbinieku sarakstu, kas reģistrēti kursi darbinieku kompetences un development • prasmju sarakstu skaits pieder darbiniekiem • prasmju tipus, komandas dalībnieku iedalījums |
...
<td>Misc. Banka LC Saūda Arābija maksas sadalījums formātu</td>
</tr>
<tr class="odd">
...
### <a name="personalized-product-recommendations"></a>Personalizētu produktu ieteikumus

| Ko iespējams izdarīt                                                                                                                                                                                                                                                                        | Kāpēc tas ir svarīgi                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Apskatīt vairākus touchpoints aplēstās pārdošanas (POS), lai noteiktu, kādi klientam varētu interesēt, pamatojoties uz savu pirkumu vēsturi, viņu vēlmju saraksta vienumos un elementus, kas citiem klientiem iegādāties tiešsaistē un ķieģeļu un javas veikalos par personalizētiem produktiem ieteikumiem | Tirgotājiem ar lielu katalogus, personificētas ieteikumus palīdzēt klientam ar produkta atklāšanas un pilnvarot veikals partneri ar inteliģentas clienteling. Demonstrētu produktu mērķauditorija ir klienta intereses un pirkšanas paradumus, produktu ieteikumus var palīdzēt mazumtirgotājiem ar upsell un uzlabo klientu saglabāšana. Programmā Dynamics 365 operācijām - mazumtirdzniecība, produktu ieteikumus powered by izziņas dienestu un Microsoft Azure mašīna mācībām. |
...
| Uzziniet vairāk par sūtījuma atbalstu sistēmā Dynamics 365 for Operations                                                                                                         | Plašāku informāciju par sūtījuma procesus atbalstu, skatiet [sūtījumu](/dynamics365/operations/scm/inventory/consignment), [uzstādīšana kravas](/dynamics365/operations/scm/inventory/set-up-consignment), [izveidotu sūtījumu papildināšanas pasūtījumu (uzdevuma norādījumi)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), un [maina īpašnieku sūtījumu uzskaiti, pamatojoties uz ražošanas pieprasījums (uzdevuma norādījumi)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
<tbody>
<tr class="odd">
<td>Nosaka tieši pārdošanas pasūtījuma rindās, no kurienes jāiegūst pieprasījums, un kā tas tiek iegūts. <strong>Piemērs</strong> izveidojiet pārdošanas pasūtījuma rindu, un norādīt tiešā piegāde, piegādes veidu. Primārais kreditors tiek pievienots pārdošanas pasūtījuma rindai kā resursu avota punkts.</td>
...
<tr class="even">
<td>Izveidot pasūtījuma solījumu tieši no pārdošanas pasūtījuma rindām. <strong>Piemērs</strong> izveidot pārdošanas pasūtījuma rindas, kas tiek iegūts no starpuzņēmuma kreditors. Atstājiet rindu. Piegādes datumi tiek aprēķināti saskaņā ar pieejamību resursu plānošanas uzņēmumā.</td>
...
| Saīsinātas izdošanas atkārtota piešķiršana                                                   | Ir pievienots atbalsts saīsinātas izdošanas procesiem, lai palīdzētu darbiniekam, kurš nevar izdot preces un vēlas izpildīt pasūtījumu, kad nepieciešamais krājums ir pieejams citā atrašanās vietā. Jūs varat izmantot automātisku atkārtota sadalījuma procesu, kurā tiek izmantotas atrašanās vietas direktīvas, lai izgūtu preces, ja tās ir pieejamas citā atrašanās vietā. Alternatīvi, izmantojot manuālu atkārtotu piešķiršanu, mobilā ierīce parāda atrašanās vietu sarakstu kopā ar pieejamo daudzumu. Noliktavas darbinieks pēc tam var atlasīt, kuras atrašanās vietas krājumu izmantot. Šīs divas metodes var iestatīt atsevišķi vai kombinēti vienā komandā, izvēlnē noliktavas darbinieks. Lietojot manuālu atkārtotu piešķiršanu, noliktavas darbinieks var izdot saīsinātu izdotā krājuma daudzumu no vairākām vietām. Lai iegūtu papildinformāciju, skatiet [izveidot īsu izdošanas krājuma pārdali (uzdevuma norādījumi)](http://ax.help.dynamics.com/en/wiki/set-up-short-picking-item-reallocation/).                                                                                                                                                                                          |
