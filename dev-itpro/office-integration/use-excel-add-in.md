...
5.  Nokopējiet pārlūkprogrammas vietrādi URL no savas mērķa Dynamics 365 for Operations instances, ielīmējiet to laukā **Servera URL** un pēc tam izdzēsiet visu pēc resursdatora nosaukuma (piemēram, izdzēsiet **/?cmp=usmf&mi=CustTableListPage**). Iegūtajā vietrādī URL ir jābūt tikai resursdatora nosaukumam (piemēram, **https://xxx.dynamics.com**).
...
11. Kad nepieciešamie lauki ir pievienoti sarakstam **Atlasītie lauki**, pārliecinieties, ka kursors atrodas pareizajā darblapas vietā (piemēram, šūnā A1), un pēc tam noklikšķiniet uz **Gatavs**. Pēc tam noklikšķiniet uz **Gatavs**, lai aizvērtu veidotāju.
...
-   Noklikšķiniet jebkurā darblapas vietā un pēc tam Excel pievienojumprogrammā noklikšķiniet uz **Jauns**.
-   Noklikšķiniet uz pēdējās rindas šajā darblapā un pēc tam spiediet tabulēšanas taustiņu, līdz kursors izkļūst no pēdējas kolonnas šajā rindā un tiek izveidota jauna rinda.
-   Noklikšķiniet uz rindas, kas atrodas tieši zem darblapas, un sāciet šūnā ievadīt datus. Kad fokusu pārslēdzat ārpus šīs šūnas, darblapa izplešas, lai iekļautu jauno rindu.
...
4.  Pēc nepieciešamības pielāgojiet sarakstu **Atlasītie lauki** tālāk aprakstītajā veidā.
    ...
    -   Lai mainītu lauku secību, noklikšķiniet uz lauka sarakstā **Atlasītie lauki** un pēc tam klikšķiniet uz **Uz augšu** vai **Uz leju**.

5.  Veiktās izmaiņas lietojiet datu avotam, noklikšķinot uz **Atjaunināt**. Pēc tam noklikšķiniet uz **Gatavs**, lai aizvērtu veidotāju. Ja pievienojāt kādu lauku (kolonnu), noklikšķiniet uz **Atsvaidzināt**, lai ievilktu atjauninātu datu pogu.
