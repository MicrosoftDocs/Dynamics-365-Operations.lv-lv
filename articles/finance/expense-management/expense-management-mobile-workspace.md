...
Šī mobilā darbvieta ir paredzēta lietošanai kopā ar mobilo programmu Dynamics 365 Unified Operations.
...
- Uzņemiet kvīts fotoattēlu un augšupielādējiet to programmā Dynamics 365 Finance. Šo fotoattēlu vēlāk varat pievienot izdevumu pārskatam.
...
Priekšnosacījumi atšķiras atkarībā no jūsu organizācijai izvietotās versijas.

### <a name="prerequisites-if-you-use-dynamics-365-finance"></a>Priekšnosacījumi, ja izmantojat Dynamics 365 Finance 
Ja jūsu organizācijai ir izvietota programma Finance, sistēmas administratoram ir jāpublicē mobilā darbvieta **Izdevumu pārvaldība**. Norādījumus skatiet tēmā [Mobilās darbvietas publicēšana](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
...
Lejupielādējiet un instalējiet mobilo programmu Dynamics 365 Unified Operations.
