...
description: Šajā tēmā skaidrots, kā iestatīt regulēšanas konfigurācijas pakalpojumu (RCS).
author: dkalyuzh
ms.date: 02/09/2022
ms.topic: article
ms.prod: ''
...
Šajā tēmā skaidrots, kā iestatīt regulēšanas konfigurācijas pakalpojumu (RCS).
