...
description: Šajā rakstā ir sniegta atsauces informācija par dažādām maksājumu darbībām, kurām tiek aprēķināts ieturētais nodoklis avotā (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8906323"
---
# <a name="tds-calculation-on-payments-and-promissory-notes"></a>TDS aprēķins maksājumiem un parādzīmēm

[!include [banner](../includes/banner.md)]

Šajā rakstā ir sniegta atsauces informācija par dažādām maksājumu darbībām, kurām tiek aprēķināts ieturētais nodoklis avotā (TDS).
