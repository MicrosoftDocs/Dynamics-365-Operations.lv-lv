...
description: Šajā rakstā ir izskaidrots, kā iestatīt komisijas maksas, kas tiek iekasētas par ieturēto nodokli avota (TDS) iestādes maksājumiem.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8845224"
---
# <a name="set-up-payment-fees-for-tds-authority-payments"></a>TDS iestāžu maksājumu iestatīšana

[!include [banner](../includes/banner.md)]

Šajā rakstā ir izskaidrots, kā iestatīt komisijas maksas, kas tiek iekasētas par ieturēto nodokli avota (TDS) iestādes maksājumiem.
