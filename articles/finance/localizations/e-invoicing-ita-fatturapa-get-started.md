...
Šī sadaļa papildina sadaļas "Sākt darbu ar elektronisko rēķinu izrakstīšanu" sadaļu Lietojumprogrammas iestatīšana, kas attiecas [uz](e-invoicing-get-started.md#country-specific-configuration-of-application-setup) konkrētu valsti.
...
1. Pabeidziet, publicējiet un izvietojiet šo līdzekli pakalpojumu vidē. Papildinformāciju skatiet sadaļas "Sākt darbu ar elektronisko rēķinu izrakstīšanu" sadaļā "Sākt darbu ar elektronisko rēķinu [izrakstīšanu](e-invoicing-get-started.md#deploy-the-electronic-invoicing-feature-to-service-environment)".
2. Izvietojiet līdzekli pievienotajā programmā. Papildinformāciju skatiet sadaļas "Sākt darbu ar elektronisko rēķinu izrakstīšanu" sadaļā "Sākt darbu ar elektronisko rēķinu [izrakstīšanu](e-invoicing-get-started.md#deploy-the-electronic-invoicing-feature-to-connected-application)".
...
7. Cilnē Elektronisks dokuments pārliecinieties, vai lauki debitoru rēķinu žurnālam un projekta rēķinam ir iestatīti saskaņā **ar** **·** **informāciju**, kas [atrodas Konfigurēt programmas](e-invoicing-get-started.md#configure-the-application-setup) iestatījumus.
...
3. Piesakieties [Azure](https://portal.azure.com) portālā kā administrators.
4. Izveidot programmas reģistrāciju SDI starpniekservera pakalpojumam.
    ...
    4. Pārejiet uz sertifikātiem & noslēpumiem, atlasiet Augšupielādēt sertifikātu **un** **augšupielādējiet .cer sertifikāta failu** S2S autentifikācijai.
    ...
    7. Rēķinu izrakstīšanas pakalpojuma komandai jāpiešķir programmas piekļuve pakalpojumam. Nosūtīt šādu parametru vērtības <D365EInvoiceSupport@microsoft.com> uz:
...
13. Piešķirt VM piekļuvi atslēgai.
    ...
    1. Drošības atslēgas vietā dodieties uz **lomu piešķirēm Piekļuve kontrolei (IAM).** \> **·**
...
14. Azure portālā atveriet publiskās IP adreses un [atlasiet](https://portal.azure.com) IP **adresi**, kas tika izveidota VM.
...
2. Atveriet lokālā datora sertifikāta papildprogrammu. Papildinformāciju skatiet [sadaļā Kā skatīt sertifikātus ar MMC pieķeršanos.](/dotnet/framework/wcf/feature-details/how-to-view-certificates-with-the-mmc-snap-in)
...
4. Vadības panelī atveriet ieslēgtu vai izslēgtu Windows līdzekļus vai dodieties uz servera pārvaldnieka pievienojumprogrammu lomu un līdzekļu sadaļu servera operētājsistēmai (OS), un slēdziet interneta informācijas **pakalpojumu** **·** \> **·** (IIS) līdzekļus:
...
15. Laukā Programmu pūls norādiet vietnes kopu un atzīmējiet tās **nosaukumu** (piemēram, **SdiAppPool).**
...
20. Izveidojiet šādas mapes, kur glabāt žurnālus un failus:
    ...
    - **C: \\ Žurnāli \\** - Glabājiet šeit žurnāla failus. Šos failus var skatīt [MS Service Trace](/dotnet/framework/wcf/service-trace-viewer-tool-svctraceviewer-exe) Viewer.
