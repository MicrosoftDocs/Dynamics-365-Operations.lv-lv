...
description: Šajā rakstā skaidrots, kā nomaksāt periodisko nodokļu summu, kas ieturēta no avota (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8864247"
---
# <a name="run-the-periodic-tds-settlement-process"></a>Periodisko TDS norēķinu procesa palaišana

[!include [banner](../includes/banner.md)]

Šajā rakstā skaidrots, kā nomaksāt periodisko nodokļu summu, kas ieturēta no avota (TDS).
