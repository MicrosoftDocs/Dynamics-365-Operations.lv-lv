---
title: Nodokļu kodu iestatīšana
description: Šajā rakstā ir izskaidrots, kā iestatīt nodokļu kodus nodokļu aprēķinu pakalpojumā.
author: wangchen
ms.date: 11/30/2021
...
ms.locfileid: "8862933"
---
# <a name="set-up-tax-codes"></a>Nodokļu kodu iestatīšana

[!include [banner](../includes/banner.md)]

Šajā rakstā ir izskaidrots, kā iestatīt nodokļu kodus nodokļu aprēķina pakalpojumā. Tajā ir iekļauts vienkārša scenārija iestatījums, lai nodokļu kods darbotos un informācija par daļu no papildu nodokļu koda funkcionalitātes sarežģītiem scenārijiem.

> [!IMPORTANT]
> Nodokļu kodu iestatījums nodokļu aprēķinu pakalpojumā ir juridiska persona – diagnostika. Šo iestatījumu varat pabeigt regulēšanas konfigurācijas pakalpojumā (RCS) tikai vienu reizi. Nodokļu kodi tiek automātiski sinhronizēti Microsoft Dynamics ar 365 finansēm, ja iespējojat nodokļu aprēķināšanas pakalpojumu atlasītai juridiskajai personai finansēs.
...
Ja neto summa ir 10,00, 1. nodokļa summa ir 1.00 (10.00 × 10 procenti), un 2. nodokļa summa ir 2.00 (10.00 × 20 procenti). Šajā gadījumā summas tiek aprēķinātas šādi: 
...
Papildinformāciju skatiet sadaļā " [Aprēķināt nodokļus par cenām", kad cenās ir iekļauti nodokļi](global-exclude-from-tax-base-amount-calculation.md).
