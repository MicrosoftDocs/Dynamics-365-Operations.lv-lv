...
description: Šajā rakstā ir uzskaitīti soļi, lai žurnālos aprēķinātu ieturēto nodokli avotā (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863038"
---
# <a name="calculate-tds-on-invoices-using-journals"></a>Aprēķināt TDS rēķinos, izmantojot žurnālus

[!include [banner](../includes/banner.md)]

Šajā rakstā ir uzskaitīti soļi, lai žurnālos aprēķinātu ieturēto nodokli avotā (TDS).
