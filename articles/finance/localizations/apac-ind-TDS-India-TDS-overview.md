...
description: Šajā rakstā ir sniegta detalizēta informācija par Indijas nodokli, kas ieturēts avotā (TDS). TDS dokumentācija sedz šīs iespējas funkcionalitāti.
author: kailiang
ms.date: 03/19/2021
ms.topic: overview
ms.prod: ''
...
Šajā rakstā ir sniegta detalizēta informācija par Indijas nodokli, kas ieturēts avotā (TDS).
