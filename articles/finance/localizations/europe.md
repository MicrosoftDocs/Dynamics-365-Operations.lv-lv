...
description: Šajā rakstā ir sniegtas saites Microsoft Dynamics uz 365 Finanšu dokumentācijas resursiem Eiropā.
author: kfend
ms.date: 01/15/2022
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8856523"
---
# <a name="europe-overview"></a>Eiropas pārskats

[!include [banner](../includes/banner.md)]

Šajā rakstā ir ietverta informācija un saites uz resursiem, kas var palīdzēt iestatīt juridiskas personas ar primāro adresi Eiropā. 

- [Avansa turētāju pārskats](emea-advance-holders.md)
 - [Avansa turētāju darbības](emea-advance-holders-transactions.md)
 - [Avansa maksājums darbiniekam](tasks/advance-payment-employee.md)
- [Avansa rēķini Austrumeiropas valstīm](emea-advance-invoice.md)
- [Bankas izraksts un maksājuma saskaņošana](emea-bank-reconciliation.md)
- [Korektīvo rēķinu izrakstīšana](emea-corrective-invoice.md)
- [Periodu sadalīšana periodiskajos žurnālos](emea-create-post-periodic-journals.md)
- [Maksājumu izveide debitoram ar tiešā debeta mandātiem](tasks/create-payments-customers-who-have-direct-debit-mandates.md)
...
- [Intrastat pārskats](emea-intrastat.md)
  - [Transakciju pārsūtīšana uz Intrastat](tasks/transfer-transactions-intrastat.md)
  - [Iekšējo darbu iekraušanas adreses norādīšana](tasks/eur-00002-specify-lading-address-intra-community.md)
...
- [Rēķina izsniegšanas termiņš](emea-invoice-issue-deadline.md)
...
- [Mazie kases posteņi Austrumeiropai un Krievijai](emea-petty-cash.md)
- [Pamatlīdzekļa pirmsiegādes grāmatošana](emea-pre-acquisition-acquisition-fixed-asset.md)
- [Pasta indeksi](emea-import-create-postal-codes-manually.md)
- [ES ieraksta sertifikāta saņemšana](tasks/eur-00012-receive-eu-entry-certificate.md)
- [Reģistrācijas ID](emea-registration-ids.md)
- [Apgrieztās maksas PVN](emea-reverse-charge.md)
...
- [Attēlojuma atjaunināšana veidam, kā pārskatos un dokumentos tiek rādītas summas](emea-amount-printing-forms.md)
- Pievienotās vērtības nodoklis (PVN)
  - [PVN ID iestatīšana](tasks/eur-00015-vat-id.md)
  - [Kreditora PVN ID reģistrēšana](tasks/eur-00015-registration-vendor-vat-id.md)
  - [PVN maiņas kursu pārskats](emea-vat-exchange-rate.md)
  - [PVN saskaņošanas pārskats](tasks/eur-00018-vat-reconciliation-report.md)
  - [PVN reģistra transakcijas Austrumeiropai](emea-vat-register-transactions.md)
  - [PVN pārskatu veidošana](emea-vat-reporting.md)
