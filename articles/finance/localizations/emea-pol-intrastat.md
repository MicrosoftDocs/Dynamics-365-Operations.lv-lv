...
8. **Sadaļā Numuru piešķiršana**, laukā **Lielākais ievadiet** **9999**.
...
9. Cilnes Aģents **kopsavilkuma** **·** **·** **cilnes** Aģents sadaļā PVN laukā PVN reģistrācijas numurs ievadiet **420000.**
...
1. Atveriet **Debitori** > **Debitori** > **Visi debitori**.
2. Režģī atlasiet **DE-016**.
3. Kopsavilkuma cilnes **Rēķins un** piegāde sadaļā **PVN** pārbaudiet, **vai PVN reģistrācijas numura** lauks ir iestatīts uz **DE9012**.
...
6. Cilnē Adrese **pārbaudiet**, **·** **vai lauks Adrese ir iestatīts uz Latviju 12, Automātiski, 24103, DEU**, jo klients ir no Vācijas.
7. Atlasiet **Labi**.
...
4. Atlasiet **Filtrēt**.
5. Intrastat filtra **dialoglodziņa** cilnē Diapazons atlasiet **pirmo** rindu un pārbaudiet, **vai lauks Lauks** ir iestatīts uz **Datums**.
...
16. Dokumenta izveides **pilsētas laukā** ievadiet Tom **.**
...
12. Dokumenta izveides **pilsētas laukā** ievadiet Tom **.**
...
16. Atlasiet **Labi**, un pārskatiet ģenerēto pārskatu XML formātā. Nākamajā tabulā ir parādītas vērtības atskaites piemērā.
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informācija par dokumentu</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informācija par uzņēmumu</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informācija par labo</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Kontaktinformācija</strong></p>
    </td>
    </tr>
    <tr>
    <td>
