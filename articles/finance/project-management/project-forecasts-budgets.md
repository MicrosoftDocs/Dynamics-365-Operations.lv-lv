...
description: Microsoft Dynamics 365 Finance nodrošina projektu prognozes un projektu budžetus, lai pārvaldītu un kontrolētu jūsu projektus.
author: KimANelson
manager: AnnBe
ms.date: 10/25/2017
ms.topic: article
...
ms.locfileid: "2185593"
---
# <a name="project-forecasts-and-budgets"></a>Projektu prognozes un budžeti

[!include [banner](../includes/banner.md)]

Projektus var kontrolēt un pārvadīt divos veidos: izmantojot projekta prognozes vai projekta budžetus. 
