...
Programmā Finance varat izveidot sešu tipu projektus. Katram projekta veidam tiek lietoti atšķirīgi izmaksu un ieņēmumu atzīšanas iestatījumi. Projekta tipa izvēle ir atkarīga no šī projekta mērķa. Nākamajā tabulā ir aprakstīts katra projekta tipa tipiskais lietojums.
...
Programmā Finance netiek automātiski samazināts prognozētais budžets. Tādēļ ieteicams saglabāt sākotnējo budžeta modeli fiksētas cenas projektam, lai izveidotu bāzlīniju salīdzināšanai, kad projekts ir pabeigts. 
...
<td>Tiek lietota tā pati novērtējuma metode, kas tika izmantota iepriekšējā periodā. Šai metodes ir nepieciešams budžeta modelis, ja tas bija nepieciešams iepriekšējā periodā.</td>
</tr>
<tr class="odd">
<td>Iestatīt pabeigšanas izmaksas uz nulli</td>
<td>Parasti šī metode tiek izmantota, pirms budžeta projekts tiek likvidēts. Šī metode salīdzina kopējos novērtējumus ar faktiskajām darbībām, kas tika iegrāmatotas, un izdzēš kolonnu <strong>Pabeigšanas izmaksas</strong>. Iegūtā pabeigtības procentuālā vērtība vienmēr ir 100 procenti. Lauks <strong>Budžeta veidošana</strong> netiek atlasīts katrai izveidotajai izmaksu rindai, un kopējais novērtējums tiek kopēts no iepriekšējā izmaksu novērtējuma. Faktiskais budžeta perioda patēriņš tiek atskaitīts no projekta pabeigšanas izmaksām. Šai metodei nav nepieciešams budžeta modelis.</td>
</tr>
<tr class="even">
...
:::row:::
    :::column:::
        #### <a name="cash-flow-page"></a>Lapa Naudas plūsma
        - Kases ieņēmumi 
        - Kases izdevumi
        - Tīrā naudas plūsma
    :::column-end:::
    :::column:::
        #### <a name="project-statements-page"></a>Lapa Projekta pārskati
        - Ieņēmumi
        - Kopējās izmaksas
        - Bruto peļņa
    :::column-end:::
...
Lapā **Izmaksu kontrole**, cilnē **Novirze** var aplūkot starpību starp kopējo budžetu un sākotnējo budžetu, apskatot šādus laukus:
