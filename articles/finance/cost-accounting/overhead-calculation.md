...
description: Šajā rakstā ir aprakstīti tipiski papildu atbalsta izmaksu aprēķināšanas un sašķīršanas procesi.
author: AndersGirke
ms.date: 10/04/2018
ms.topic: article
ms.prod: ''
...
Šajā rakstā ir aprakstīti tipiski papildu atbalsta izmaksu aprēķināšanas un sašķīršanas procesi.
...
> [!NOTE]
> Statistiskos mērus, piemēram, preces patērētās ražošanas stundas, var atvasināt no avota datiem. Sīkāku informāciju skatiet šeit: [Statistikas mēru nodrošinātāja veidne](statistical-measure-provider-template.md#statistical-measure-provider-template). Nākamajā tabulā ir parādīts rezultāts, ja tiek iegūts, ja kopējām izmaksām (fiksētajām izmaksām un mainīgajām izmaksām) kā sadalījuma pamats tiek lietoti HR pakalpojumi.
