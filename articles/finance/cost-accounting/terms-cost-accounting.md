...
description: Šajā rakstā ir noteikti galvenie nosacījumi, kas tiek izmantoti Izmaksu uzskaitē.
author: aprilolson
ms.date: 08/31/2017
ms.topic: article
ms.prod: ''
...
Šajā rakstā ir noteikti galvenie nosacījumi, kas tiek izmantoti Izmaksu uzskaitē.
