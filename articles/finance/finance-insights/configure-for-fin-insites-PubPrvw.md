...
1. Izveidojiet krātuves kontu:
    ...
    3. Dialoglodziņā **Papildu opcijas** opcijā **Data Lake Storage Gen2** atlasiet **Iespējot** līdzeklī **Hierarhiskās nosaukumvietas**. Ja neiespējoat šo līdzekli, nevar patērēt datus, ko finanšu un operāciju programmas rakstīt, izmantojot tādus pakalpojumus kā datu Power BI plūsmas.
