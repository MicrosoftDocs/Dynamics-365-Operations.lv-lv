...
description: Šajā rakstā ir aprakstīta kreditora rēķinu apstrādes automātiskas aktivizēšanas iespēja un automatizēta procesa izmantošanas priekšrocības.
author: abruer
ms.date: 02/12/2021
ms.topic: overview
ms.prod: ''
