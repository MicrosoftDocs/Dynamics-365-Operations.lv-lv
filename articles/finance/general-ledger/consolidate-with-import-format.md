...
description: Šajā rakstā ir sniegta detalizēta informācija par importa formātu, kas tiek izmantots, konsolidējot finanšu datus no vairākām juridiskām personām.
author: jinniew
ms.date: 10/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8871309"
---
# <a name="import-format-for-consolidation"></a>Formāta importēšana konsolidēšanai

[!include [banner](../includes/banner.md)]

Šajā rakstā ir sniegta detalizēta informācija par importa formātu, kas tiek izmantots, konsolidējot finanšu datus no vairākām juridiskām personām. Importa formāts ir jāsaglabā kā teksta (.txt) fails.
