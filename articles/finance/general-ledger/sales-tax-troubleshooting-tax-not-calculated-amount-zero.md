...
description: Šajā rakstā ir sniegta traucējummeklēšanas informācija, kas var palīdzēt, kad nodokļa summa ir 0 (nulle) vai nodoklis nav aprēķināts.
author: shtao
ms.date: 04/01/2021
ms.topic: article
ms.prod: ''
