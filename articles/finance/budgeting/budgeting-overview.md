...
description: Šajā tēmā sniegts pārskats par budžeta veidošanas funkcionalitātes komponentiem, budžeta veidošanas rīkiem un ziņošanas iespējām Microsoft Dynamics 365 Finansēs.
author: panolte
ms.date: 04/29/2021
ms.topic: overview
ms.prod: ''
