...
description: Šajā tēmā ir sniegta informācija par darbvietu Banku vadība. Šajā darbvietā tiek rādīta informācija, kas saistīta ar datu faila bankas kontiem.
author: roschlom
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
