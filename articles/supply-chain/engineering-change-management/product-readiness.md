...
### <a name="enable-or-disable-readiness-checks-on-standard-products"></a>Iespējot vai atspējot standarta preču gatavības pārbaudes

Šai funkcijai ir nepieciešams, *lai sistēmai būtu* *ieslēgtas* gan inženierzinātnes izmaiņu pārvaldības, gan preču gatavības pārbaudes funkcijas. Papildinformāciju par to, kā ieslēgt vai izslēgt šos līdzekļus, skatiet inženierzinātnes [izmaiņu pārvaldības pārskatā](product-engineering-overview.md).
