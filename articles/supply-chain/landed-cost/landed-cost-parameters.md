...
description: Šajā rakstā ir aprakstīts, kā iestatīt vispārējo informāciju un konfigurācijas iestatījumus, kas tiek izmantoti zemgrāmatas izmaksu modulī grāmatošanai, statusa atjauninājumiem, numuru sērijām un uzvedībai.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
