...
description: Šajā rakstā ir sniegta informācija par dažādiem elementiem, kurus var izmantot preču datu importēšanai un eksportēšanai.
author: t-benebo
ms.date: 01/07/2020
ms.topic: article
ms.prod: ''
...
| Izlaistie preču varianti pēc preces numura identifikācijas | `EcoResProductNumberIdentifiedReleasedProductVariantEntity` | Šī entitīja ir līdzīga entītijai **Izlaistie produktu varianti**, taču integrācijas atslēga ir preces numurs, nevis preces šablons ar preces dimensijām. To var paplašināt, pievienojot jaunas preces dimensijas. |
