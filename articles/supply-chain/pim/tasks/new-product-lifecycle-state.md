...
## <a name="create-a-product-lifecycle-state"></a><span data-ttu-id="38759-108">Preces dzīves cikla stāvokļa izveidošana</span><span class="sxs-lookup"><span data-stu-id="38759-108">Create a product lifecycle state</span></span>
1. <span data-ttu-id="38759-109">Pārejiet uz sadaļu Preču informācijas pārvaldība > Iestatīšana > Preces dzīves cikla stāvoklis.</span><span class="sxs-lookup"><span data-stu-id="38759-109">Go to Product information management > Setup > Product lifecycle state.</span></span>
2. <span data-ttu-id="38759-110">Noklikšķiniet uz Jauns.</span><span class="sxs-lookup"><span data-stu-id="38759-110">Click New.</span></span>
3. <span data-ttu-id="38759-111">Laukā Stāvoklis ierakstiet vērtību.</span><span class="sxs-lookup"><span data-stu-id="38759-111">In the State field, type a value.</span></span>
4. <span data-ttu-id="38759-112">Apraksta laukā ierakstiet vērtību.</span><span class="sxs-lookup"><span data-stu-id="38759-112">In the Description field, type a value.</span></span>
