...
2. Sarakstā atzīmējiet atlasīto rindu.
    * Atlasiet kvalitātes pārbaudes pasūtījumu, kas tika izveidots pirms šīs procedūras uzsākšanas.  

## <a name="record-test-results"></a>Testa rezultātu reģistrēšana
1. Noklikšķiniet uz Rezultāti.
2. Noklikšķiniet uz Rediģēt.
3. Ierakstiet skaitli laukā Rezultātu daudzums.
4. Sarakstā atzīmējiet atlasīto rindu.
5. Laukā Iznākums noklikšķiniet uz nolaižamā saraksta pogas, lai atvērtu uzmeklēšanu.
...
2. Laukā Pārbaudīja noklikšķiniet uz nolaižamā saraksta pogas, lai atvērtu uzmeklēšanu.
    * Atlasiet lietotāju, kas veic pārbaudi.  
