...
> [!NOTE]
> *Mainīt krājumu statusu vienumiem, kurus kontrolē izsekošanas dimensijas* funkcija ļauj jums mainīt krājumu statusu vienumiem, kas ir kontrolēti ar izsekošanas dimensijām, ieskaitot spēju atjaunināt tikai atlasītos ierakstus. Izmantojiet [Līdzekļu pārvaldību](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md), lai iespējotu šo līdzekli pēc nepieciešamības. Kad funkcija ir aktivizēta, varēsit veikt šādas darbības:
>
