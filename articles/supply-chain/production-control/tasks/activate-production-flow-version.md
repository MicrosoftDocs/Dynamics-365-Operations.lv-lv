...
## <a name="find-and-activate-a-production-flow-version"></a>Atrast un aktivizēt kādu ražošanas plūsmas versiju
1. Doties uz Ražošanas plūsmas.
2. Sarakstā atrodiet un atlasiet vajadzīgo ierakstu.
    * Atlasiet ražošanas plūsmas versiju, kam laukā Plāna statuss ir vērtība Melnraksts.  
