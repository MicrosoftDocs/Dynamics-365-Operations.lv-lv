---
title: Lean ražošanas procesa darba šūnu definēšana
description: Darba šūna ir specifiska resursu grupu forma, kuru var izmantot lean ražošanas procesa aktivitātēs.
author: cvocph
manager: tfehr
ms.date: 08/29/2018
...
ms.locfileid: "5257271"
---
# <a name="define-lean-manufacturing-work-cells"></a>Lean ražošanas procesa darba šūnu definēšana

[!include [banner](../../includes/banner.md)]

Darba šūna ir specifiska resursu grupu forma, kuru var izmantot lean ražošanas procesa aktivitātēs. Darba šūnām ir ievades un izvades vietas un noslodzes definīcija, pamatojoties uz ražošanas plūsmas modeli. Lai uzzinātu vairāk par lean ražošanas procesa darba šūnu pamatkonceptiem un noslodzes aprēķiniem, skatiet tehniskos dokumentus par Lean ražošanas procesu. Demonstrācijas datu uzņēmums, kas tiek izmantots, lai izveidotu šo procedūru, ir USMF
