...
description: Šajā rakstā ir sniegta informācija par formulām un formulu versijām. Formula procesa ražošanā nosaka konkrētu procesu materiālus, sastāvdaļas un rezultātus. Formulas tiek izmantotas, lai procesa ražošanā plānotu un ražotu preces.
