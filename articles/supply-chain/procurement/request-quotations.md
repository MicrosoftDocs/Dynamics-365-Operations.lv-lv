...
Varat mainīt šīs vērtības noteiktam PP gadījumam. Ir jākonfigurē arī grozījumu process. Šīs konfigurēšanas ietvaros varat ieslēgt lauku bloķēšanu. Ja ir ieslēgta lauku bloķēšana, tad sagādes speciālistam, kas vēlas veikt PP grozījumus, vispirms cilnes **Piedāvājums** sadaļā **Grozījums** ir jānoklikšķina uz **Izveidot**. Kad PP ir atjaunināts ar grozījumu, sagādes speciālistam ir jāpabeidz šis process, noklikšķinot uz **Pabeigt**. Darbība **Pabeigt** ģenerē e-pasta ziņojumu, kas kreditoriem paziņo par grozīto PP. Kreditoriem sūtītā e-pasta paziņojuma veidni varat atlasīt lapā **Sagādes un avotu parametri**. Kad tiek izveidota veidne, tā var saturēt tālāk norādītos aizstāšanas marķierus.
