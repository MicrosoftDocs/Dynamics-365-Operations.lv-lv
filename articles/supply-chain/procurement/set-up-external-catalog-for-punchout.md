...
description: Šajā rakstā ir aprakstīta ārējā kataloga vai perfologu kataloga izmantošana, lai ievāktu kreditora piedāvājuma informāciju un pievienotu to pieprasījumam.
...
4. Konfigurējiet ārējo piegādātāju katalogu, izmantojot piegādātāju prasību ārējo kataloga vietu. Papildinformāciju par šo uzdevumu skatiet sadaļā [Ārējo kreditoru kataloga konfigurēšana](#configure-the-external-vendor-catalog).
...
1. Ievadiet kreditora ārējā kataloga nosaukumu un aprakstu. Nosaukums, ko ievadīsit, parādīsies grozā, kas atspoguļo ārējo katalogu, kas tiek rādīts darbiniekiem, kuri izveido pieprasījumu. Darbinieki var noklikšķināt uz groza, lai atvērtu katalogu no kreditora ārējā kataloga vietnes.
...
Varat jebkurā brīdī pārlādēt sistēmas ģenerēto ziņojuma veidni, noklikšķinot uz vienuma **Atjaunot ziņojuma formātu**. Ņemiet vērā, ka, atjaunojot ziņojuma formātu, pašreizējais ziņojuma formāts tiek aizstāts ar automātiski ģenerētu ziņojumu formātu, kurā ir tukšas etiķetes.
