...
description: Šajā rakstā ir aprakstīts, kā strādāt ar darba pasūtījumu kopām Līdzekļu pārvaldībā.
...
1. Atlasiet **Līdzekļu pārvaldības darba** > **pasūtījumu kopas visas** > **darba pasūtījumu kopas vai** aktīvās **darba pasūtījumu kopas**.
