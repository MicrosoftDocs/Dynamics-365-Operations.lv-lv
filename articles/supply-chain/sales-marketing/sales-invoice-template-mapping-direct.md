...
description: Šajā rakstā ir aprakstītas veidnes un pamatā esošie uzdevumi, kas tiek izmantoti, lai sinhronizētu pārdošanas rēķinu virsrakstus un rindas tieši no Dynamics 365 Supply Chain Management Dynamics 365 pārdošanas.
author: Henrikan
ms.date: 10/26/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9103281"
---
# <a name="synchronize-sales-invoice-headers-and-lines-directly-from-finance-and-operations-to-sales"></a>Sinhronizēt pārdošanas rēķinu virsrakstus un rindas tieši no finansēm un operācijām uz Pārdošanu

[!include [banner](../includes/banner.md)]

Šajā rakstā ir aprakstītas veidnes un pamatā esošie uzdevumi, kas tiek izmantoti, lai sinhronizētu pārdošanas rēķinu virsrakstus un rindas tieši no Dynamics 365 Supply Chain Management Dynamics 365 pārdošanas.
