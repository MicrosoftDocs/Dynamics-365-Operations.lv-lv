...
description: Šajā rakstā ir sniegta informācija par detalizētu kopuma noslodzes veidošanu, kas kopuma izpildes laikā automātiski piešķir sūtījumus esošajiem kopumiem. Tādējādi varat izveidot jēgpilnas kravas, kas atbilst kravas automašīnām, neizmantojot kravu plānošanas rīku.
author: Mirzaab
ms.date: 07/01/2020
ms.topic: article
ms.prod: ''
...
Šajā scenārijā ir parādīts, kā iepriekš aprakstītie iestatījumi šajā rakstā ietekmē noliktavas operācijas pārdošanas pasūtījuma apstrādes laikā. Scenārijā tiek izmantoti **USMF** demonstrācijas dati kopā ar citām demonstrācijas vērtībām, kas sniegtas šo iestatījumu instrukcijās.
