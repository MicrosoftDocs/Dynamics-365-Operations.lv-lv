...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="9f517-123">Iestatiet kopuma veidni</span><span class="sxs-lookup"><span data-stu-id="9f517-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="9f517-139">Kopsavilkuma cilnē **Lietotāji** atlasiet **Jauns** , lai izveidotu mobilās ierīces kontu, un iestatiet tālāk norādītās vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="9f517-140">**Lietotāja ID:** ievadiet unikālu ID.</span><span class="sxs-lookup"><span data-stu-id="9f517-140">**User ID:** Enter a unique ID.</span></span>
...
1. <span data-ttu-id="9f517-158">Doties uz **Noliktavas pārvaldība \> Iestatījumi \> Noliktavas pārvaldības parametri**.</span><span class="sxs-lookup"><span data-stu-id="9f517-158">Go to **Warehouse management \> Setup \> Warehouse management parameters**.</span></span>
...
1. <span data-ttu-id="9f517-174">Dodieties uz **Noliktavas pārvaldība \> Iestatīšana \> Noliktava \> Novietojums**.</span><span class="sxs-lookup"><span data-stu-id="9f517-174">Go to **Warehouse management \> Setup \> Warehouse \> Locations**.</span></span>
...
1. <span data-ttu-id="9f517-192">Kopsavilkuma cilnē **Vispārīgi** iestatiet šādas vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-192">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="9f517-210">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-210">Select **OK**.</span></span>
...
1. <span data-ttu-id="9f517-226">Kopsavilkuma cilnē **Pārskats** iestatiet šādas vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-226">On the **Overview** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="9f517-227">**Noliktava:** *62*</span><span class="sxs-lookup"><span data-stu-id="9f517-227">**Warehouse:** *62*</span></span>
...
<span data-ttu-id="9f517-245">Iestatiet darba klasi, kas tiks izmantota kopā ar kārtošanu.</span><span class="sxs-lookup"><span data-stu-id="9f517-245">Set up a work class that will be used together with sorting.</span></span>
...
1. <span data-ttu-id="9f517-262">Kopsavilkuma cilnē **Vispārīgi** iestatiet šādas vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-262">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="9f517-279">Kopsavilkuma cilnē **Darba klases** atlasiet **Jauns** , un pēc tam iestatiet šādas vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-279">On the **Work classes** FastTab, select **New** , and then set the following values:</span></span>
    ...
    - <span data-ttu-id="9f517-280">**Darba klases ID:** *SORT*</span><span class="sxs-lookup"><span data-stu-id="9f517-280">**Work class ID:** *SORT*</span></span>
...
#### <a name="set-up-a-single-sku-directive"></a><span data-ttu-id="9f517-296">Iestatīt vienu SKU direktīvu</span><span class="sxs-lookup"><span data-stu-id="9f517-296">Set up a single-SKU directive</span></span>
...
1. <span data-ttu-id="9f517-315">Kopsavilkuma cilnē **Novietojuma direktīvu darbības** atlasiet **Jauns** , un pēc tam jaunajā rindā iestatiet šādas vērtības.</span><span class="sxs-lookup"><span data-stu-id="9f517-315">On the **Location Directive Actions** FastTab, select **New** , and then set the following values on the new line.</span></span> <span data-ttu-id="9f517-316">Pieņemiet noklusējuma vērtības visiem pārējiem laukiem.</span><span class="sxs-lookup"><span data-stu-id="9f517-316">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="9f517-317">**Secība:** *1*</span><span class="sxs-lookup"><span data-stu-id="9f517-317">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="9f517-336">Atlasiet **Saglabāt** , lai padarītu pieejamu rīkjoslu kopsavilkuma cilnē **Rindas**.</span><span class="sxs-lookup"><span data-stu-id="9f517-336">Select **Save** to make the toolbar on the **Lines** FastTab available.</span></span>
...
1. <span data-ttu-id="9f517-353">Doties uz **Noliktavas pārvaldība \> Iestatījumi \> Darbs \> Darba veidnes**.</span><span class="sxs-lookup"><span data-stu-id="9f517-353">Go to **Warehouse management \> Setup \> Work \> Work templates**.</span></span>
...
### <a name="create-sales-orders-and-picking-work"></a><span data-ttu-id="9f517-371">Pārdošanas pasūtījuma un izdošanas darba izveide</span><span class="sxs-lookup"><span data-stu-id="9f517-371">Create sales orders and picking work</span></span>
...
1. <span data-ttu-id="9f517-407">Kopsavilkuma cilnē **Rindas informācija** , cilnē **Piegāde** iestatiet lauku **Piegādes režīms** uz *Flowe-STD*.</span><span class="sxs-lookup"><span data-stu-id="9f517-407">On the **Line details** FastTab, on the **Delivery** tab, set the **Mode of delivery** field to *Flowe-STD*.</span></span>
...
#### <a name="get-the-work-ids-from-the-work-details"></a><span data-ttu-id="9f517-423">Darba ID iegūšana no darba informācijas</span><span class="sxs-lookup"><span data-stu-id="9f517-423">Get the work IDs from the work details</span></span>
...
1. <span data-ttu-id="9f517-442">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-442">Select **OK**.</span></span>
...
1. <span data-ttu-id="9f517-462">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-462">Select **OK**.</span></span>

    <span data-ttu-id="9f517-463">Lapā **Skenēt darba ID / noliktavas vienības ID** tiek saņemts ziņojums “Darbs pabeigts”.</span><span class="sxs-lookup"><span data-stu-id="9f517-463">On the **Scan a work ID / license plate ID** page, you receive a "Work Completed" message.</span></span> <span data-ttu-id="9f517-464">Šis ziņojums norāda, ka 2. pārdošanas pasūtījuma 2. rindas darba ID ir pabeigts.</span><span class="sxs-lookup"><span data-stu-id="9f517-464">This message indicates that the work ID from line 2 of sales order 2 has been completed.</span></span>

### <a name="pack-sales-orders-into-containers"></a><span data-ttu-id="9f517-465">Pārdošanas pasūtījumu iepakošana konteineros</span><span class="sxs-lookup"><span data-stu-id="9f517-465">Pack sales orders into containers</span></span>

#### <a name="pack-sales-order-1-into-containers"></a><span data-ttu-id="9f517-466">1. pārdošanas pasūtījuma iepakošana konteineros</span><span class="sxs-lookup"><span data-stu-id="9f517-466">Pack sales order 1 into containers</span></span>

1. <span data-ttu-id="9f517-467">Dodieties uz **Noliktavas pārvaldība \> Iepakošana un konteinerizēšana \> Iepakot**.</span><span class="sxs-lookup"><span data-stu-id="9f517-467">Go to **Warehouse management \> Packing and containerization \> Pack**.</span></span>

    <span data-ttu-id="9f517-468">Tiek parādīts dialoglodziņš **Atlasīt iepakošanas staciju**.</span><span class="sxs-lookup"><span data-stu-id="9f517-468">The **Select packing station** dialog box appears.</span></span> <span data-ttu-id="9f517-469">Pēc noklusējuma lauks **Darbinieks** ir jāiestata uz tā darbinieka vārda, ko iestatījāt iepriekš.</span><span class="sxs-lookup"><span data-stu-id="9f517-469">By default, the **Worker** field should be set to the name of the worker that you set up earlier.</span></span>

1. <span data-ttu-id="9f517-470">Iestatiet šādas vērtības, lai skatītu un strādātu ar sūtījumiem un konteineriem, kas ir paredzēti noteiktai iepakošanas vietai:</span><span class="sxs-lookup"><span data-stu-id="9f517-470">Set the following values to view and work on shipments and containers that are planned at the specific packing location:</span></span>

    - <span data-ttu-id="9f517-471">**Vieta:** *6*</span><span class="sxs-lookup"><span data-stu-id="9f517-471">**Site:** *6*</span></span>
    - <span data-ttu-id="9f517-472">**Noliktava:** *62*</span><span class="sxs-lookup"><span data-stu-id="9f517-472">**Warehouse:** *62*</span></span>
    - <span data-ttu-id="9f517-473">**Atrašanās vieta:** *Pakotne*</span><span class="sxs-lookup"><span data-stu-id="9f517-473">**Location:** *Pack*</span></span>
    - <span data-ttu-id="9f517-474">**Iepakošanas profila ID:** *Sort*</span><span class="sxs-lookup"><span data-stu-id="9f517-474">**Packing profile ID:** *Sort*</span></span>

1. <span data-ttu-id="9f517-475">Atlasiet **Labi** , lai aizvērtu dialoglodziņu.</span><span class="sxs-lookup"><span data-stu-id="9f517-475">Select **OK** to close the dialog box.</span></span>
1. <span data-ttu-id="9f517-476">Lapas **Pakotne** laukā **Noliktavas vienība vai sūtījums** , ievadiet mērķa LP 1. pārdošanas pasūtījumam.</span><span class="sxs-lookup"><span data-stu-id="9f517-476">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for sales order 1.</span></span> <span data-ttu-id="9f517-477">Pēc tam atlasiet klaviatūras taustiņu **Cilne** vai **Ievadīt** , lai izietu no lauka.</span><span class="sxs-lookup"><span data-stu-id="9f517-477">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="9f517-478">Darbību rūtī atlasiet **Jauns konteiners**.</span><span class="sxs-lookup"><span data-stu-id="9f517-478">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="9f517-479">Pieņemiet visus noklusējuma iestatījumus un atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-479">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="9f517-480">Pierakstiet konteinera ID.</span><span class="sxs-lookup"><span data-stu-id="9f517-480">Make a note of the container ID.</span></span>
1. <span data-ttu-id="9f517-481">Kopsavilkuma cilnē **Krājuma iepakošana** iestatiet šādas vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-481">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="9f517-482">**Daudzums:** *1*</span><span class="sxs-lookup"><span data-stu-id="9f517-482">**Quantity:** *1*</span></span>
    - <span data-ttu-id="9f517-483">**Identifikators:** krājums *A0001*</span><span class="sxs-lookup"><span data-stu-id="9f517-483">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="9f517-484">Darbību rūtī atlasiet **Slēgt konteineru**.</span><span class="sxs-lookup"><span data-stu-id="9f517-484">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="9f517-485">Dialoglodziņā **Slēgt konteineru** atlasiet **Iegūt sistēmas svaru** , lai sistēma atjauninātu lauku **Bruto svars**.</span><span class="sxs-lookup"><span data-stu-id="9f517-485">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="9f517-486">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-486">Select **OK**.</span></span> <span data-ttu-id="9f517-487">Konteiners ir pārvietots uz novietni *SORT* un ir gatavs kārtošanai.</span><span class="sxs-lookup"><span data-stu-id="9f517-487">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="9f517-488">Izveidojiet otru konteineru, lai pievienotu otro krājumu, no LP 1. pārdošanas pasūtījuma uz jauno konteineru.</span><span class="sxs-lookup"><span data-stu-id="9f517-488">Create a second container to add the second item from the LP for sales order 1 to a new container.</span></span>
1. <span data-ttu-id="9f517-489">Darbību rūtī atlasiet **Jauns konteiners**.</span><span class="sxs-lookup"><span data-stu-id="9f517-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="9f517-490">Pieņemiet visus noklusējuma iestatījumus un atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="9f517-491">Pierakstiet konteinera ID.</span><span class="sxs-lookup"><span data-stu-id="9f517-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="9f517-492">Kopsavilkuma cilnē **Krājuma iepakošana** iestatiet šādas vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="9f517-493">**Daudzums:** *1*</span><span class="sxs-lookup"><span data-stu-id="9f517-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="9f517-494">**Identifikators:** krājums *A0001*</span><span class="sxs-lookup"><span data-stu-id="9f517-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="9f517-495">Darbību rūtī atlasiet **Slēgt konteineru**.</span><span class="sxs-lookup"><span data-stu-id="9f517-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="9f517-496">Dialoglodziņā **Slēgt konteineru** atlasiet **Iegūt sistēmas svaru** , lai sistēma atjauninātu lauku **Bruto svars**.</span><span class="sxs-lookup"><span data-stu-id="9f517-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="9f517-497">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-497">Select **OK**.</span></span> <span data-ttu-id="9f517-498">Konteiners ir pārvietots uz novietni *SORT* un ir gatavs kārtošanai.</span><span class="sxs-lookup"><span data-stu-id="9f517-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="9f517-499">2. pārdošanas pasūtījuma iepakošana konteineros</span><span class="sxs-lookup"><span data-stu-id="9f517-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="9f517-500">Lapas **Pakotne** laukā **Noliktavas vienība vai sūtījums** , ievadiet mērķa LP 2. pārdošanas pasūtījuma 1. rindai.</span><span class="sxs-lookup"><span data-stu-id="9f517-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="9f517-501">Pēc tam atlasiet klaviatūras taustiņu **Cilne** vai **Ievadīt** , lai izietu no lauka.</span><span class="sxs-lookup"><span data-stu-id="9f517-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="9f517-502">Darbību rūtī atlasiet **Jauns konteiners**.</span><span class="sxs-lookup"><span data-stu-id="9f517-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="9f517-503">Pieņemiet visus noklusējuma iestatījumus un atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="9f517-504">Pierakstiet konteinera ID.</span><span class="sxs-lookup"><span data-stu-id="9f517-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="9f517-505">Kopsavilkuma cilnē **Krājuma iepakošana** iestatiet šādas vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="9f517-506">**Daudzums:** *1*</span><span class="sxs-lookup"><span data-stu-id="9f517-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="9f517-507">**Identifikators:** krājums *A0001*</span><span class="sxs-lookup"><span data-stu-id="9f517-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="9f517-508">Darbību rūtī atlasiet **Slēgt konteineru**.</span><span class="sxs-lookup"><span data-stu-id="9f517-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="9f517-509">Dialoglodziņā **Slēgt konteineru** atlasiet **Iegūt sistēmas svaru** , lai sistēma atjauninātu lauku **Bruto svars**.</span><span class="sxs-lookup"><span data-stu-id="9f517-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="9f517-510">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-510">Select **OK**.</span></span> <span data-ttu-id="9f517-511">Konteiners ir pārvietots uz novietni *SORT* un ir gatavs kārtošanai.</span><span class="sxs-lookup"><span data-stu-id="9f517-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="9f517-512">Laukā **Noliktavas vienība vai sūtījums** , ievadiet mērķa LP 2. pārdošanas pasūtījuma 2. rindai.</span><span class="sxs-lookup"><span data-stu-id="9f517-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="9f517-513">Pēc tam atlasiet klaviatūras taustiņu **Cilne** vai **Ievadīt** , lai izietu no lauka.</span><span class="sxs-lookup"><span data-stu-id="9f517-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="9f517-514">Darbību rūtī atlasiet **Jauns konteiners**.</span><span class="sxs-lookup"><span data-stu-id="9f517-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="9f517-515">Pieņemiet visus noklusējuma iestatījumus un atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="9f517-516">Pierakstiet konteinera ID.</span><span class="sxs-lookup"><span data-stu-id="9f517-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="9f517-517">Kopsavilkuma cilnē **Krājuma iepakošana** iestatiet šādas vērtības:</span><span class="sxs-lookup"><span data-stu-id="9f517-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="9f517-518">**Daudzums:** *1*</span><span class="sxs-lookup"><span data-stu-id="9f517-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="9f517-519">**Identifikatora lauks:** krājums *A0002*</span><span class="sxs-lookup"><span data-stu-id="9f517-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="9f517-520">Darbību rūtī atlasiet **Slēgt konteineru**.</span><span class="sxs-lookup"><span data-stu-id="9f517-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="9f517-521">Dialoglodziņā **Slēgt konteineru** atlasiet **Iegūt sistēmas svaru** , lai sistēma atjauninātu lauku **Bruto svars**.</span><span class="sxs-lookup"><span data-stu-id="9f517-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="9f517-522">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-522">Select **OK**.</span></span> <span data-ttu-id="9f517-523">Konteiners ir pārvietots uz novietni *SORT* un ir gatavs kārtošanai.</span><span class="sxs-lookup"><span data-stu-id="9f517-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="9f517-524">Lai skatītu konteineru informāciju, dodieties uz **Noliktavas pārvaldība \> Iepakošana un konteinerizēšana \> Konteineri** un meklējiet konteineru ID, kas tika izveidoti iepakošanas laikā.</span><span class="sxs-lookup"><span data-stu-id="9f517-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers** , and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="9f517-525">Konteineru kārtošana</span><span class="sxs-lookup"><span data-stu-id="9f517-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="9f517-526">Kad piekļūstat izvēlnes vienumam **Paletes izveide** mobilajā programmā, lai veiktu izejošo kārtošanu, tiks parādīta poga, kas ir apzīmēta kā **Pilns**.</span><span class="sxs-lookup"><span data-stu-id="9f517-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="9f517-527">*Nelietojiet pogu **Pilns** , lai kārtotu vai slēgtu pozīciju.*</span><span class="sxs-lookup"><span data-stu-id="9f517-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="9f517-528">Poga **Pilns** tiek nodrošināta pēc noklusējuma, un to nevar atspējot vai noņemt no lapas.</span><span class="sxs-lookup"><span data-stu-id="9f517-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="9f517-529">To nelieto funkcijai *Izejošā kārtošana*.</span><span class="sxs-lookup"><span data-stu-id="9f517-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="9f517-530">Pirmā konteinera kārtošana</span><span class="sxs-lookup"><span data-stu-id="9f517-530">Sort the first container</span></span>

1. <span data-ttu-id="9f517-531">Mobilajā ierīcē piesakieties noliktavā *62* , izmantojot lietotāja ID, ko izveidojāt šim scenārijam (vai esoša demonstrācijas datu lietotāja ID).</span><span class="sxs-lookup"><span data-stu-id="9f517-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="9f517-532">Galvenajā izvēlnē atlasiet **Izejošs**.</span><span class="sxs-lookup"><span data-stu-id="9f517-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="9f517-533">Izvēlnē **Izejošs** atlasiet **Paletes izveide**.</span><span class="sxs-lookup"><span data-stu-id="9f517-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="9f517-534">Laukā **LP/Con** ievadiet pirmā konteinera ID, kas ir saistīts ar 1. pārdošanas pasūtījumu.</span><span class="sxs-lookup"><span data-stu-id="9f517-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="9f517-535">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-535">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-536">Tā kā pašlaik nav kārtošanas pozīciju, tā ir jānorāda.</span><span class="sxs-lookup"><span data-stu-id="9f517-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="9f517-537">Laukā **Kārtošanas pozīcijas ID** ievadiet *SP01*.</span><span class="sxs-lookup"><span data-stu-id="9f517-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="9f517-538">Tā kā neviena LP pašlaik nav saistīta ar kārtošanas pozīciju *SP01* , tā ir jānorāda.</span><span class="sxs-lookup"><span data-stu-id="9f517-538">Because no LP is currently associated with sort position *SP01* , you must specify one.</span></span> <span data-ttu-id="9f517-539">Laukā **LP** ievadiet *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="9f517-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="9f517-540">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-540">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-541">Tā kā ir ieslēgta kārtošanas pozīcijas pārbaude, jums vēlreiz ir jāievada kārtošanas pozīcijas ID.</span><span class="sxs-lookup"><span data-stu-id="9f517-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="9f517-542">Laukā **Kārtošanas pozīcijas ID** ievadiet *SP01*.</span><span class="sxs-lookup"><span data-stu-id="9f517-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="9f517-543">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-543">Select **OK**.</span></span>

    <span data-ttu-id="9f517-544">Tiek saņemts ziņojums “Darbs pabeigts”.</span><span class="sxs-lookup"><span data-stu-id="9f517-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="9f517-545">Lai skatītu kārtošanas pozīciju un tajā iekļauto LP, dodieties uz **Noliktavas pārvaldība \> Iepakošana un konteinerizēšana \> Izejošās kārtošanas pozīciju piešķires**.</span><span class="sxs-lookup"><span data-stu-id="9f517-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="9f517-546">Lapā **Izejošās kārtošanas pozīciju piešķires** tiek parādītas visas šobrīd aktīvās kārtošanas pozīcijas.</span><span class="sxs-lookup"><span data-stu-id="9f517-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="9f517-547">Lauks **Kārtošanas pozīcijas transakcijas** parāda ar katru kārtošanas pozīciju saistīto LP un konteinerus, kas ir kārtošanas pozīcijā.</span><span class="sxs-lookup"><span data-stu-id="9f517-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="9f517-548">Ievērojiet, ka pašlaik pastāv viena kārtošanas pozīcija un ka kopsavilkuma cilne **Kārtošanas pozīcijas kritēriji** parāda kritērijus **Sūtījums – Pārvadātāja pakalpojums – Gaisa**.</span><span class="sxs-lookup"><span data-stu-id="9f517-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="9f517-549">Atlikušo konteineru kārtošana</span><span class="sxs-lookup"><span data-stu-id="9f517-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="9f517-550">Mobilajā ierīcē piesakieties noliktavā *62* , izmantojot lietotāja ID, ko izveidojāt šim scenārijam (vai esoša demonstrācijas datu lietotāja ID).</span><span class="sxs-lookup"><span data-stu-id="9f517-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="9f517-551">Galvenajā izvēlnē atlasiet **Izejošs**.</span><span class="sxs-lookup"><span data-stu-id="9f517-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="9f517-552">Izvēlnē **Izejošs** atlasiet **Paletes izveide**.</span><span class="sxs-lookup"><span data-stu-id="9f517-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="9f517-553">Laukā **LP/Con** ievadiet otrā konteinera ID, kas ir saistīts ar 1. pārdošanas pasūtījumu.</span><span class="sxs-lookup"><span data-stu-id="9f517-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="9f517-554">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-554">Select **OK**.</span></span> <span data-ttu-id="9f517-555">Tā kā kārtošanas veidne ir iestatīta automātiskai kārtošanai un kārtošanas pozīcija ar atbilstošajiem kritērijiem jau pastāv, jūs automātiski tiekat novirzīts uz pareizo kārtošanas pozīciju.</span><span class="sxs-lookup"><span data-stu-id="9f517-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="9f517-556">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-556">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-557">Apstipriniet kārtošanas pozīcijas ID, norādot, ka krājumi ir pareizajā vietā.</span><span class="sxs-lookup"><span data-stu-id="9f517-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="9f517-558">Laukā **Kārtošanas pozīcijas ID** ievadiet *SP01*.</span><span class="sxs-lookup"><span data-stu-id="9f517-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="9f517-559">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-559">Select **OK**.</span></span>

    <span data-ttu-id="9f517-560">1. pārdošanas pasūtījuma otrā konteinera darbs ir pabeigts.</span><span class="sxs-lookup"><span data-stu-id="9f517-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="9f517-561">Tagad tiks šķiroti atlikušie konteineri no 2. pārdošanas pasūtījuma.</span><span class="sxs-lookup"><span data-stu-id="9f517-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="9f517-562">Laukā **LP/Con** ievadiet konteinera ID no 2. pārdošanas pasūtījuma konteinera, kas satur krājumu *A0001*.</span><span class="sxs-lookup"><span data-stu-id="9f517-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="9f517-563">Tā kā pārvadātāja pakalpojums ir atšķirīgs, tiek parādīta uzvedne ievadīt jaunu kārtošanas pozīciju un piešķirt šai pozīcijai LP.</span><span class="sxs-lookup"><span data-stu-id="9f517-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="9f517-564">Izmantojiet kārtošanas pozīciju *SP02* un LP *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="9f517-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="9f517-565">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-565">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-566">Apstipriniet kārtošanas pozīciju, laukā **Kārtošanas pozīcijas ID** ievadot *SP02*.</span><span class="sxs-lookup"><span data-stu-id="9f517-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="9f517-567">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-567">Select **OK**.</span></span>

    <span data-ttu-id="9f517-568">Konteinera darbs ir pabeigts.</span><span class="sxs-lookup"><span data-stu-id="9f517-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="9f517-569">Laukā **LP/Con** ievadiet konteinera ID 2. pārdošanas pasūtījuma atlikušajam konteineram, kas satur krājumu *A0002*.</span><span class="sxs-lookup"><span data-stu-id="9f517-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="9f517-570">Tā kā pārvadātāja pakalpojums ir tāds pats kā pārvadātāja pakalpojums 1. pārdošanas pasūtījumam, sistēma parāda esošo kārtošanas pozīciju ar atbilstošajiem kritērijiem.</span><span class="sxs-lookup"><span data-stu-id="9f517-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="9f517-571">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-571">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-572">Apstipriniet kārtošanas pozīciju, laukā **Kārtošanas pozīcijas ID** ievadot *SP01*.</span><span class="sxs-lookup"><span data-stu-id="9f517-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="9f517-573">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-573">Select **OK**.</span></span>

    <span data-ttu-id="9f517-574">Konteinera darbs ir pabeigts.</span><span class="sxs-lookup"><span data-stu-id="9f517-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="9f517-575">Slēgt izejošās kārtošanas pozīcijas</span><span class="sxs-lookup"><span data-stu-id="9f517-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="9f517-576">Kad visi krājumi ir sakārtoti, pozīcija ir jāslēdz, lai varētu izveidot darbu.</span><span class="sxs-lookup"><span data-stu-id="9f517-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="9f517-577">Tiks izveidots kārtots krājumu izdošanas darbs, lai veiktu inventarizāciju angāra durvīm.</span><span class="sxs-lookup"><span data-stu-id="9f517-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="9f517-578">Pozīcijas slēgšana no mobilās ierīces</span><span class="sxs-lookup"><span data-stu-id="9f517-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="9f517-579">Mobilajā ierīcē piesakieties noliktavā *62* , izmantojot lietotāja ID, ko izveidojāt šim scenārijam (vai esoša demonstrācijas datu lietotāja ID).</span><span class="sxs-lookup"><span data-stu-id="9f517-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="9f517-580">Galvenajā izvēlnē atlasiet **Izejošs**.</span><span class="sxs-lookup"><span data-stu-id="9f517-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="9f517-581">Izvēlnē **Izejošs** atlasiet **Paletes izveide**.</span><span class="sxs-lookup"><span data-stu-id="9f517-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="9f517-582">Laukā **LP/Con** ievadiet kārtotā konteinera ID kārtošanas pozīciju *SP01*.</span><span class="sxs-lookup"><span data-stu-id="9f517-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="9f517-583">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-583">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-584">Tiek parādīts šāds ziņojums: “Konteiners jau ir sakārtots pēc pozīcijas SP01.</span><span class="sxs-lookup"><span data-stu-id="9f517-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="9f517-585">Vai slēgt pozīciju?”</span><span class="sxs-lookup"><span data-stu-id="9f517-585">Close the position?"</span></span> <span data-ttu-id="9f517-586">Atlasiet **Aizvērt**.</span><span class="sxs-lookup"><span data-stu-id="9f517-586">Select **Close**.</span></span>

    <span data-ttu-id="9f517-587">Darbs ir pabeigts.</span><span class="sxs-lookup"><span data-stu-id="9f517-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="9f517-588">Pozīcijas slēgšana no izejošās kārtošanas pozīcijas piešķirēm</span><span class="sxs-lookup"><span data-stu-id="9f517-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="9f517-589">Dodieties uz **Noliktavas pārvaldība \> Iepakošana un konteinerizēšana \> Izejošās kārtošanas pozīciju piešķires**.</span><span class="sxs-lookup"><span data-stu-id="9f517-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="9f517-590">Kreisajā kolonnā atlasiet **SP02**.</span><span class="sxs-lookup"><span data-stu-id="9f517-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="9f517-591">Šī izejošās kārtošanas pozīcijas rinda ir tā, kuru slēgsit.</span><span class="sxs-lookup"><span data-stu-id="9f517-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="9f517-592">Darbību rūtī atlasiet **Slēgt pozīciju**.</span><span class="sxs-lookup"><span data-stu-id="9f517-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="9f517-593">Kārtošanas pozīcijas ieraksts ir slēgts un vairs netiek rādīts.</span><span class="sxs-lookup"><span data-stu-id="9f517-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="9f517-594">Lai tiktu rādīti visi slēgtie pozīciju ieraksti, atzīmējiet izvēles rūtiņu **Rādīt slēgto**.</span><span class="sxs-lookup"><span data-stu-id="9f517-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="9f517-595">Kārtoto krājumu izdošana</span><span class="sxs-lookup"><span data-stu-id="9f517-595">Sorted inventory picking</span></span>

<span data-ttu-id="9f517-596">Pabeidziet kārtoto krājumu izdošanas darbu.</span><span class="sxs-lookup"><span data-stu-id="9f517-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="9f517-597">Kad tas ir pabeigts, krājumi tiks izdoti pārdošanas pasūtījumam.</span><span class="sxs-lookup"><span data-stu-id="9f517-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="9f517-598">Šajā brīdī tiek lietoti visi pārējie noliktavas procesi.</span><span class="sxs-lookup"><span data-stu-id="9f517-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="9f517-599">Mobilajā ierīcē piesakieties noliktavā *62* , izmantojot lietotāja ID, ko izveidojāt šim scenārijam (vai esoša demonstrācijas datu lietotāja ID).</span><span class="sxs-lookup"><span data-stu-id="9f517-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="9f517-600">Galvenajā izvēlnē atlasiet **Izejošs**.</span><span class="sxs-lookup"><span data-stu-id="9f517-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="9f517-601">Izvēlnē **Izejošs** atlasiet **Ielādēt no kārtošanas**.</span><span class="sxs-lookup"><span data-stu-id="9f517-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="9f517-602">Ievadiet mērķa LP ID no pirmās kārtošanas pozīcijas, *SP01*.</span><span class="sxs-lookup"><span data-stu-id="9f517-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="9f517-603">Iestatiet lauku **ID** uz *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="9f517-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="9f517-604">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-604">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-605">Lapā **Kārtoto krājumu izdošana: Izdot** tiek rādīts veicamais izdošanas darbs.</span><span class="sxs-lookup"><span data-stu-id="9f517-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="9f517-606">Izdot no novietojuma *SORT* un mērķa LP *PLP01* , kam ir vairāki krājumi un daudzums ir *3*.</span><span class="sxs-lookup"><span data-stu-id="9f517-606">Pick from the *SORT* location and target LP *PLP01* , which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="9f517-607">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-607">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-608">Lapā **Kārtoto krājumu izdošana: Izvietot** tiek rādīts veicamais izvietošanas darbs.</span><span class="sxs-lookup"><span data-stu-id="9f517-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="9f517-609">Izvietot novietojumā *Baydoor* un mērķa LP *PLP01* , kam ir vairāki krājumi un daudzums ir *3*.</span><span class="sxs-lookup"><span data-stu-id="9f517-609">Put to the *Baydoor* location and target LP *PLP01* , which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="9f517-610">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-610">Select **OK**.</span></span>

    <span data-ttu-id="9f517-611">Darbs ir pabeigts.</span><span class="sxs-lookup"><span data-stu-id="9f517-611">Work is completed.</span></span>

1. <span data-ttu-id="9f517-612">Ievadiet mērķa noliktavas vienības ID no otrās kārtošanas pozīcijas, *SP02*.</span><span class="sxs-lookup"><span data-stu-id="9f517-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="9f517-613">Iestatiet lauku **ID** uz *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="9f517-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="9f517-614">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-614">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-615">Lapā **Kārtoto krājumu izdošana: Izdot** tiek rādīts veicamais izdošanas darbs.</span><span class="sxs-lookup"><span data-stu-id="9f517-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="9f517-616">Izdot no novietojuma *SORT* un mērķa LP *PLP02* , kam ir vairāki krājumi un daudzums ir *1*.</span><span class="sxs-lookup"><span data-stu-id="9f517-616">Pick from the *SORT* location and target LP *PLP02* , which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="9f517-617">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-617">Select **OK**.</span></span>
1. <span data-ttu-id="9f517-618">Lapā **Kārtoto krājumu izdošana: Izvietot** tiek rādīts veicamais izvietošanas darbs.</span><span class="sxs-lookup"><span data-stu-id="9f517-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="9f517-619">Izvietot novietojumā *Baydoor* un mērķa LP *PLP02* , kam ir vairāki krājumi un daudzums ir *1*.</span><span class="sxs-lookup"><span data-stu-id="9f517-619">Put to the *Baydoor* location and target LP *PLP02* , which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="9f517-620">Atlasiet **Labi**.</span><span class="sxs-lookup"><span data-stu-id="9f517-620">Select **OK**.</span></span>

    <span data-ttu-id="9f517-621">Darbs ir pabeigts.</span><span class="sxs-lookup"><span data-stu-id="9f517-621">Work is completed.</span></span>

<span data-ttu-id="9f517-622">No šī brīža tiek lietoti visi pārējie noliktavas procesi.</span><span class="sxs-lookup"><span data-stu-id="9f517-622">From this point forward, all other warehouse processes apply.</span></span>
