...
description: Šajā rakstā ir aprakstīts, kā iestatīt un pārvaldīt lietotāju kontus, kas darbiniekiem ļauj pieteikties un izmantot noliktavas programmu.
author: Mirzaab
ms.date: 09/15/2021
ms.topic: article
ms.search.form: ''
