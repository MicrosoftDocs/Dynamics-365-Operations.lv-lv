...
description: Šajā rakstā ir sniegts pārskats par funkcionalitāti, kas nodrošina numuru sērijas paplašinājumus numura zīmju IDENTIFIKĀCIJAS, kopuma etiķešu IDENTIFIKĀCIJAS, konteineru IDENTIFIKĀCIJAS numurus un preču transporta pavadzīmes IDENTIFIKĀCIJAS numurus.
author: Mirzaab
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
