...
Informāciju par to, kā instalēt no lietojumprogrammu centra lejupielādētu būvējumu, skatiet [sadaļā Būvējuma instalēšana](/appcenter/distribution/installation).
...
1. Ievadiet sekojošo informāciju:
    ...
    - **Active direktorija resurss** – norādiet Supply Chain Management saknes vietrādi URL.
        ...
        > Pārliecinieties, vai HTTPS (SSL) sertifikāts ir derīgs.
