...
-   Windows (UWP)
     - [Finance and Operations - Uzglabāšana Windows veikalā](https://www.microsoft.com/store/apps/9p1bffd5tstm)
-   Android
    - [Finance and Operations – Uzglabāšana Google Play veikalā](https://play.google.com/store/apps/details?id=com.Microsoft.Dynamics365forOperationsWarehousing)
...
3.  Azure portāla kreisajā navigācijas rūtī noklikšķiniet uz **Azure Active Directory**.

    [![WMA-01-Active-Directory-piemērs](./media/WMA-01-active-directory-example.png )](./media/WMA-01-active-directory-example.png)

4.  Nodrošiniet, ka Active Directory instance atbilst instancei, kas izmantota programmā Supply Chain Management.
5.  Sarakstā noklikšķiniet uz **Programmu reģistrācijas**. 
...
7.  Ievadiet programmas nosaukumu un atlasiet **Konti tikai šajā organizatoriskajā direktorijā**. Noklikšķiniet uz **Reģistrs**.  
...
8.  Tiks atvērta jūsu jaunā programmas reģistrācija. 
...
10. Noklikšķiniet uz **Sertifikāts & noslēpumi** rūtī **Pārvaldība** . Noklikšķiniet uz **Jauns klienta noslēpums**. 
...
11. Izveidojiet atslēgu, sadaļā **Paroles** ievadot atslēgas aprakstu un ilgumu. Noklikšķiniet uz **Pievienot** un nokopējiet atslēgu. Vēlāk atslēga tiks saukta par **klienta noslēpumu**. 
...
1.  Izveidojiet lietotāju, kas atbilst noliktavu programmas lietotāja akreditācijas datiem.
    ...
    3.  Piešķiriet lomu Noliktavas mobilās ierīces lietotājs, kā tas ir redzams tālāk esošajā ekrānuzņēmumā. 
...
2.  Saistiet savu Azure Active Directory lietojumprogrammu ar programmas Warehousing lietotāju.
    ...
    3.  Aizpildiet laiku **Klienta ID** (ievadot pēdējā sadaļā iegūto informāciju), piešķiriet nosaukumu un atlasiet iepriekš izveidoto lietotāju. Ieteicams atzīmēt visas jūsu ierīces, lai to nozaudēšanas gadījumā varētu viegli liegt to piekļuvi programmatūrai Supply Chain Management, izmantojot šo lapu. 
...
2.  Noņemiet atzīmi no lauka **Demonstrācijas režīms**. <br>
...
3.  Ievadiet sekojošo informāciju: 
    ...
    + **Azure Active directory resurss**— Azure AD directory resurss, kas atbilst Supply Chain Management saknes vietrādim URL. 
    
        > [!NOTE]
        > Šī lauka vērtības beigās nedrīkst ievadīt uz priekšu vērstās slīpsvītras rakstzīmi (/). 
    ...
    + **Uzņēmums**— ievadiet to juridisko personu programmatūrā Supply Chain Management, ar programmai ir jāizveido savienojums. <br>
    
    [![wh-12-app-connection-settings](./media/wh-12-app-connection-settings-169x300.png)](./media/wh-12-app-connection-settings.png)

4.  Atlasiet pogu **Atpakaļ** lietojumprogrammas apakšējā kreisajā stūrī. Tagad programmā tiek izveidots savienojums ar Supply Chain Management serveri un parādīts noliktavas darbinieka pieteikšanās ekrāns.

    [![wh-13-log-in-screen](./media/wh-13-log-in-screen-180x300.png)](./media/wh-13-log-in-screen.png)

Informāciju par to, kā iestatīt programmu Warehousing svītrkodu skenēšanai, izmantojot mobilās ierīces kameru, skatiet rakstā [Svītrkodu skenēšana, izmantojot kameru, programmā Dynamics 365 for Finance and Operations– Warehousing app](scan-bar-codes-using-a-camera.md)
