...
description: Šajā rakstā ir sniegta informācija par lapu Detalizēta informācija par darba rindu, kurā ir redzams jūsu sistēmas atsevišķo darba rindu visaptverošs, kārtojams un filtrējams saraksts.
author: Mirzaab
ms.date: 07/01/2020
ms.topic: article
ms.prod: ''
