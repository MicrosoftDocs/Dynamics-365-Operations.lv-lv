...
## <a name="turn-on-the-warehouse-slotting-feature"></a>Līdzekļa Noliktavu slotu veidošana ieslēgšana
...
- **Līdzekļa nosaukums:** *noliktavu slotu veidošanas līdzeklis*
...
#### <a name="set-up-a-slotting-template-header"></a>Slotu veidošanas galvenes iestatīšana
...
1. Veidnes galvenē iestatiet tālāk norādītās vērtības.
    ...
    - **Pieprasījuma veids:** *pārdošanas pasūtījums*
        ...
        Pašlaik vienīgais atbalstītais pieprasījuma veids ir *Pārdošanas pasūtījums*.
...
1. Jaunajā rindā iestatiet šādas vērtības:
    ...
    - **Mērvienības pakāpe:** _EaBoxPl_
        ...
        Šajā laukā ir definēts rindai derīgās pieprasījuma mērvienības. (Papildinformāciju skatiet sadaļā [Mērvienību pakāpju izveide slotu veidošanai](#unit-tiers) iepriekš šajā tēmā)
