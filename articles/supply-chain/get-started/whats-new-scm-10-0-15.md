...
---
# <a name="whats-new-in-the-dynamics-365-supply-chain-management-preview-of-release-10015-december-2020"></a>Jaunumi Dynamics 365 Supply Chain Management 10.0.15 izlaiduma priekšskatījumā (2020. gada decembris)

[!include [banner](../includes/banner.md)]
[!include [preview banner](../includes/preview-banner.md)]

Šajā tēmā uzskaitīti līdzekļi, kas ir vai nu jauni, vai kas ir mainīti Microsoft Dynamics 365 Supply Chain Management versijas 10.0.15 priekšskatījumā. Šai versijai ir būvējuma numurs 10.0.644, un tas ir pieejams šeit:

- **Izlaiduma 10.0.15 priekšskatījums:** 2020. gada oktobris
- **Vispārēja izlaiduma 10.0.15 (manuāls atjauninājums) pieejamība:** 2020. gada novembris
- **Vispārēja izlaiduma 10.0.15 (automātisks atjauninājums) pieejamība:** 2020. gada decembris

## <a name="features-included-in-this-release"></a>Šajā laidienā iekļautie līdzekļi

Šajā laidienā ir iekļauti tālāk minētie līdzekļi. Līdzekļu virsrakstu saite papildu informācijai vietnē [Laidiena plāniem](https://docs.microsoft.com/dynamics365/release-plans/). Papildu saites norāda uz papildu dokumentāciju, kas pašlaik ir pieejams šim līdzeklim. Daži no norādītajiem līdzekļiem joprojām ir pieejami priekšskatījumā, kamēr citi, iespējams, jau ir vispārīgi pieejami. Sekojiet saitēm uz izlaišanas plānu, lai skatītu izlaišanas datumus, vai dodieties uz [Jaunumi un plāni Dynamics 365 Supply Chain Management](https://docs.microsoft.com/dynamics365-release-plan/2020wave2/finance-operations/dynamics365-supply-chain-management/planned-features), lai iegūtu visu to līdzekļu pārskatu, kas ir izlaisti un plānoti pašreizējā izlaiduma kopumam. Vairumam šo līdzekļu ir jābūt iespējotiem, izmantojot [Līdzekļu pārvaldību](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md), pirms varat tos izmantot.

- Mākoņa un Edge mēroga vienības pārvaldība ar ražošanas un noliktavas izpildes slodzēm
...
Microsoft Dynamics 365 Supply Chain Management 10.0.15 ietver platformas atjauninājumus. Lai iegūtu papildinformāciju, skatiet [Platformas atjauninājumi Finance and Operations programmu versijai 10.0.15 (2020. gada oktobris)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-15.md).

### <a name="bug-fixes"></a>Kļūdu labojumi

Lai iegūtu informāciju par kļūdu labojumiem, kas iekļauti katrā no atjauninājumiem, kas ir daļa no 10.0.15, piesakieties Lifecycle Services (LCS) pakalpojumos un aplūkojiet [KB rakstu](https://fix.lcs.dynamics.com/Issue/Details?bugId=514518&dbType=3&qc=8fbe12733a7e1aa197e91fb11530f69fa89b9b39c08d89a19873f755c9430988).
