...
description: Šajā rakstā ir aprakstīti līdzekļi, kas ir jauni vai mainīti programmā Microsoft Dynamics 365 Supply Chain Management 10.0.22.
author: kamaybac
ms.date: 08/09/2021
ms.topic: article
...
Šajā rakstā ir uzskaitīti līdzekļi, kas ir jauni vai mainīti Microsoft Dynamics 365 Supply Chain Management versijā 10.0.22. Šai versijai ir būvējuma numurs 10.0.995, un tas ir pieejams šeit:
...
|---|---|---|---|
| Plānošana | [Plānošanas optimizācijas atbalsts resursu sadalījumam, kas pamatots uz iespējām](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/planning-optimization-support-capability-based-resource-allocation) | [Plānošana ar iespējā balstītu resursa atlasi](../master-planning/planning-optimization/capability-based-scheduling.md) | Līdzekļu pārvaldība (*Bezgalīga noslodzes plānošana plānošanas optimizācijai*) |
...
| Vispārējā plānošana | [Neto prasības un piesaistes informācija](../master-planning/planning-optimization/net-requirements.md) |
...
Microsoft Dynamics 365 Supply Chain Management 10.0.22 ietver platformas atjauninājumus. Papildinformāciju skatiet platformas [atjauninājumos finanšu un operāciju programmu versijā 10.0.22 (2021. gada novembrī)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-22.md).
