...
Dynamics 365 Human Resources izmanto **dzīves notikumu tipus**, lai definētu notikumus, kuros ir atļauts atjaunināt darbinieku pabalstu reģistrāciju, piemēram, precēšanos vai bērna piedzimšanu. Katru dzīves notikuma veida ID var saistīt tikai ar vienu dzīves notikuma veidu. Piemēram, ja izveidojat **life notikuma ID** ar nosaukumu **Adreses maiņa**, kas saistīta ar dzīves notikuma tipu **Darbinieka adreses maiņa**, nevar izveidot citu ID ar nosaukumu **Darbinieka adreses maiņa** un saistīt to ar dzīves notikuma tipu **Darbinieka adreses maiņa**. Ja dzīves notikuma tips nav saistīts ar plāna tipu, dzīves notikuma tips neaktivizē dzīves notikumu. Papildu informāciju skatiet sadaļā [Plānu veidu izveide](hr-benefits-setup-plan-types.md).
...
Varat skatīt to plānu sarakstu, kas pievienoti atlasītajam **life notikuma tipam**. Dzīves notikumi ir pievienoti plāna veidam, un plāna veidi ir saistīti ar plānu.
...
| **Vajadzības izmaiņas (alga)** |<br><ul><li>**Nodarbinātais > Atlīdzība > Fiksētais plāns**</li><li>**Darbinieks > Personīgā informācija > Atvieglojumu gada alga**</li></ul>| Ja **pabalstu pārvaldība > Personāla vadības koplietojamie parametri > Ieguvumi > pabalsti gada alga** nav iespējota, darbinieka > atlīdzības > fiksēta plāna **atjaunināšana** radīs dzīves notikumu. Ja **ir iespējota pabalstu pārvaldība > Cilvēkresursu koplietojamie parametri > Pabalsti > pabalsti**, darba ņēmēja > personiskās informācijas atjaunināšana **> pabalstu gada alga** radīs dzīves notikumu. |
...
| **Ar tiesu piespriests atbalsts** | **Darbinieks > profils > Personiskā informācija > Personīgie kontakti > Atkarīgais > Tiesa pavēlēja atbalstīt** (QMSCO/QDRO) un spēkā stāšanās datumus | Veidojot personisku kontaktpersonu, tiks izveidots dzīves notikums, ja **Tiesas pasūtītais atbalsts** ir **Jā**. Atjauninot **Tiesas pasūtīto atbalstu** vai **Tiesas pasūtīto beigu datumu**, tiks izraisīts arī dzīves notikums. |
