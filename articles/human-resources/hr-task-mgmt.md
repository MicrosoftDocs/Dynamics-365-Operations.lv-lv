...
- Lietojiet kontrolsarakstu darbiniekam.
- Atjaunināt uzdevuma statusu.
- Atkārtoti piešķirt uzdevumu.
- Atjaunināt uzdevuma izpildes datumu.
...
>
> Lapā Personāla vadības parametri varat arī atjaunināt datumu diapazonu iziešanas un izieto darbinieku sarakstiem, kas parādīti cilnē **Ārpus** **darba**.
>
> Šie iestatījumi attiecas arī uz personāla **vadības** darbalauku.
...
Ja uzdevumam laukā Piešķires tips ir iestatīts uz pozīciju, pārvaldnieku vai grupu, taču no piešķires tipa nevar atvasināt nevienu īpašu personu, uzdevums tiks **piešķirts** **·** **·** **kontrolsaraksta** īpašniekam. Šeit sniegti daži piemēri par situācijām, kurās uzdevumi tiks piešķirti kontrolsaraksta īpašniekam:
...
Kad ir izveidota piešķires grupa, tā ir pieejama atlasei uzdevuma izveides laikā. Lai uzdevumam atlasītu noteiktu grupu, piešķires **veidam** jāatlasa **Grupa**. Pēc tam izveidotā grupa būs pieejama atlasei laukā **Piešķirts**.
...
Katram uzdevumam tiek piešķirts izpildes datums, pieskaitot vai atņemot termiņa korespondējošo datumu no darbinieka sākuma datuma. Papildinformāciju skatiet Uzdevuma izpildes [termiņa un Izpildes datuma korespondējošā lauka](#task-due-dates-and-the-due-date-offset-field) sadaļā.
...
Lapā **Darbinieku** pašapkalpošanās darbinieks var skatīt visus tiem piešķirtos uzdevumus. Katram piešķirtam uzdevumam, **Uzdevumam**, **·** **Aprakstam,** Instrukcijām **un Kontaktpersonai tiek** parādītas vērtības. Turklāt katram uzdevumam darbinieks var atvērt saistīto ārējo tīmekļa lapu vai saistīto lapu Dynamics 365 programmā.
