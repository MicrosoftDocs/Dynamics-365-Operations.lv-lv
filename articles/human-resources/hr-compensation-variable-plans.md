...
description: Šajā rakstā ir aprakstīti komponenti, kas ir jāiestata, lai varētu izmantot mainīgo atlīdzību un darbinieku reģistrēt mainīgās atlīdzības plānā.
author: twheeloc
ms.date: 08/24/2021
ms.topic: article
ms.prod: ''
...
Mainīgā atlīdzība veido darbinieka nestandarta algu, piemēram, prēmijas vai samaksu uzņēmuma akcijās. Šajā rakstā skaidrots, kā iestatīt komponentus, kas ir nepieciešami mainīgās atlīdzības kompensāciju un reģistrē darbinieku atlīdzības mainīgās daļas plānā.
...
Parametrs **Ierobežot piekļuvi atlasītajām lomām** ierobežo piekļuvi atlīdzības plānam atlasītajām drošības lomām, kas ir piešķirtas šim plānam personāla vadībai. Piemēram, kad izveidojat atlīdzības plānus, kas ir vadītājam un nedrīkst būt redzami visām HR specifiskajām lomām, varat izmantot šo parametru, lai ierobežotu piekļuvi šiem kompensācijas plāniem. 

Jums jāiestata arī aprēķina metode.
