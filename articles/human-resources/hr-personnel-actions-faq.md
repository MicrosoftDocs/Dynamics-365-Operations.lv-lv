...
> [!NOTE]
> Personāla darbības ir pieejamas tikai tad, ja lauki Iespējot darbinieka darbības un Iespējot pozīciju darbības ir iestatīti uz Jā, cilnes Personāla darbības lapā Cilvēkresursu **·** **·** **·** **·** **kopīgie** parametri. 
...
Ja nav kļūdu, šī personāla darbība kļūst tikai lasāma. (Varat skatīt vēsturi **par Visu darbinieka** darbību saraksta lapa, bet jūs nevarat mainīt personāla darbību.) Kad personāla darbības statuss ir **·** Pabeigts, pozīcija vai darbinieka ieraksts jau ir atjaunināts. Lai skatītu veiktās izmaiņas, atveriet saraksta lapu **Amati** vai **Nodarbinātie**.
