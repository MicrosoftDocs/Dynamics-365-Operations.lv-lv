...
Piemēri uzdevumiem, kuriem var būt nepieciešamas personāla darbības:
 - Veidojot jaunus amatus. 
 - Pārveidot esošās pozīciju vērtības. 
 - Nolīgt jaunus darbiniekus. 
 - Pārsūtiet darbiniekus. 
 - Mainīt darbinieka atlīdzību. 
 - Mainīt pozīciju piešķires. 
 - Pārtraukt darba attiecības ar darbiniekiem;

> [!NOTE]
> Personāla darbības ir pieejamas tikai **tad** **·** **·**, ja lauki Iespējot darbinieka darbības un Iespējot pozīciju darbības ir iestatīti uz Jā, **·** **cilnē Personāla darbības lapā Cilvēkresursu kopīgie parametri.** 
...
- **Pozīcijas** darbība – pozīcijas darbība tiek veikta esošajām pozīcijām vai jaunām pozīcijām. Amata darbība var būt nepieciešama, piemēram, ja maināt pastāvošā amata vērtību vai ja veidojat jaunu sezonālu amatu. 

- **Darbinieka** darbība – darbinieka darbība tiek veikta esošiem darbiniekiem vai jauniem darbiniekiem. Darbinieka darbība var būt nepieciešama, piemēram, kad tiek pieņemts darbā jauns darbinieks vai tiek paaugstināts amatā jau esošais darbinieks. 
...
- **Apstiprināts gaida** – darbplūsma ir pabeigta, bet izmaiņas joprojām tiek veiktas. **Atcelts** – darbplūsma tika atcelta vai personāla darbība tika atsaukta. **Noraidīts** – apstiprinātājs noraidījis darbības pieprasījumu.
- **Darbības apstrāde** – darbības pieprasījums ir apstiprināts, un izmaiņas tiek apstrādātas.
- **Darbplūsma izpildīta**  – darbplūsma ir pabeigta un izmaiņas ir apstrādātas. **Neizdevās** - darbplūsma neizdevās, jo informācija ir nov atrašanās vieta. Noklikšķiniet **uz Atkārtoti aktivizēt,** lai parādītu jaunāko informāciju un turpinātu.
- **Pabeigts** – amats tika sekmīgi izveidots vai modificēts, vai darbinieks tika sekmīgi pieņemts darbā vai pārsūtīts, vai darba attiecības ar šo darbinieku ir sekmīgi izbeigtas, vai ir veiksmīgi mainīta darbinieka atlīdzība. **Kļūda** – radusies problēma, kas radusies, izņemot nov atrašanās vietu novākšanas informācijā. Atveriet personāla **darbību ziņojumu žurnālu,** lai noteiktu kļūdas cēloni.
...
Atveriet jebkuru no personāla **darbību saraksta** lapām un atlasiet personāla darbību.
...
Ja nav kļūdu, šī personāla darbība kļūst tikai lasāma. (Varat skatīt vēsturi **par Visu darbinieka** darbību saraksta lapa, bet jūs nevarat mainīt personāla darbību.) Kad personāla darbības statuss ir **Pabeigts**, pozīcijas vai darbinieka ieraksts jau ir atjaunināts. Lai skatītu veiktās izmaiņas, atveriet saraksta lapu **Amati** vai **Nodarbinātie**.
...
Jūs saņemat šo ziņojumu, **jo darba lapas** līmeņa lauks ir **tukšs darbam, kas saistīts** ar atlasīto amatu.

Lai novērstu šo kļūdu, izpildiet tālāk aprakstītās darbības.

> 1. Lapā Darbinieka **amata piešķires** noklikšķiniet uz lauka **Amats**.  
> 2. Noklikšķiniet uz **lauka** Darbs vērtību, lai atvērtu **darba** lapu.
> 3. Darbības rūtī noklikšķiniet uz **Rediģēt**.
> 4. Noklikšķiniet uz **cilnes** Atlīdzība.
> 5. Laukā **Līmenis** atlasiet līmeni.
> 6. **Aizveriet lapu** Darbs.
> 7. Aizveriet lapu **Pozīcija**.
> 8. Atgriezieties cilnes **Atlīdzība** lapā **Darbinieks**, atlasiet Fiksētā **atlīdzība**.  Atlasiet **Jauns un ievadiet darbinieka amatu** laukā Amats **.**  Ievadiet vērtību **laukā** Plāns un pēc tam ievadiet darbinieka kompensāciju laukā **Algas** likme.

## <a name="why-cant-i-change-the-effective-date-on-the-header-of-the-worker-action-page"></a>Kādēļ es nevaru mainīt darbinieka darbības lapas virsrakstā spēkā stāšanās datumu?
