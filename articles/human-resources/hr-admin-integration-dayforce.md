...
- <span data-ttu-id="a6c2d-111">Personāla vadības dati</span><span class="sxs-lookup"><span data-stu-id="a6c2d-111">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="a6c2d-141">Datu konfigurēšana</span><span class="sxs-lookup"><span data-stu-id="a6c2d-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="a6c2d-158">Atvieglojumi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-158">Benefits</span></span>
...
<span data-ttu-id="a6c2d-187">Papildinformāciju par atvieglojumu programmas definēšanu un pārvaldību skatiet tālāk minētajos rakstos.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-187">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- [<span data-ttu-id="a6c2d-204">Atlīdzības procesa definēšana un rezultātu aprēķināšana</span><span class="sxs-lookup"><span data-stu-id="a6c2d-204">Define compensation process and calculate results</span></span>](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/define-compensation-process-calculate-results)
...
- <span data-ttu-id="a6c2d-226">Apmaksas cikls (obligāti)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-226">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="a6c2d-241">Apmaksas cikli un apmaksas periodi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-241">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="a6c2d-257">Ienākumu veida kodi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-257">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="a6c2d-296">Kontaktinformācija</span><span class="sxs-lookup"><span data-stu-id="a6c2d-296">Contact information</span></span> 
...
<span data-ttu-id="a6c2d-342">Fiksētās atlīdzības plānam ir jābūt saistītam ar katra darbinieka primāro amatu visā nodarbinātības periodā.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-342">A fixed compensation plan must be associated with every employee's primary position throughout an employment period.</span></span> <span data-ttu-id="a6c2d-343">Šis periods sākas ar datumu, kurā darbinieks tika pieņemts darbā (vai nodarbinātības sākuma datumu), un turpinās līdz darba attiecību pārtraukšanai.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-343">This period starts on the date that the employee was hired (or the employment start date) and continues until termination.</span></span>
...
- <span data-ttu-id="a6c2d-358">Primārais (obligāti)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-358">Primary (required)</span></span>
...
- <span data-ttu-id="a6c2d-380">Primārā (obligāti)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-380">Primary (required)</span></span>
...
<span data-ttu-id="a6c2d-421">Ir jānorāda tālāk norādītie iemeslu kodi un apraksti.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-421">The following reason codes and descriptions are required.</span></span>
...
| <span data-ttu-id="a6c2d-458">Atraitnis (-ne)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-458">Widowed</span></span>                | <span data-ttu-id="a6c2d-459">Atraitnis (-ne)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-459">Widowed</span></span>              |
...
|--------------|-----------------|
| <span data-ttu-id="a6c2d-473">Vīrietis</span><span class="sxs-lookup"><span data-stu-id="a6c2d-473">Male</span></span>         | <span data-ttu-id="a6c2d-474">Vīrietis</span><span class="sxs-lookup"><span data-stu-id="a6c2d-474">Male</span></span>            |
| <span data-ttu-id="a6c2d-475">Sieviete</span><span class="sxs-lookup"><span data-stu-id="a6c2d-475">Female</span></span>       | <span data-ttu-id="a6c2d-476">Sieviete</span><span class="sxs-lookup"><span data-stu-id="a6c2d-476">Female</span></span>          |
| <span data-ttu-id="a6c2d-477">Nav specifisks</span><span class="sxs-lookup"><span data-stu-id="a6c2d-477">Non-specific</span></span> | <span data-ttu-id="a6c2d-478">*Netiek atbalstīts*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-478">*Not supported*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="a6c2d-479">Ienākumu veida kodi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-479">Earning codes</span></span>

<span data-ttu-id="a6c2d-480">Ienākumu veidu kodi unikāli identificē katra veida ienākumus, ko saņem nodarbinātie.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-480">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="a6c2d-481">Kodiem ir vairāki ar ienākumiem saistīti parametri, piemēram, uzskaites nosacījumi, nodokļu likumi, pārskatu veidošanas prasības un bruto summas palielināšanas iespēja.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-481">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="a6c2d-482">Ja tiek izmantota neatbalstīta biežuma vērtība, aprēķinā pēc noklusējuma tiek lietota biežuma vērtība **Katra apmaksa**.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-482">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="a6c2d-483">Atbalstītās biežuma vērtības</span><span class="sxs-lookup"><span data-stu-id="a6c2d-483">Supported frequencies</span></span>

- <span data-ttu-id="a6c2d-484">Visus</span><span class="sxs-lookup"><span data-stu-id="a6c2d-484">All</span></span>
- <span data-ttu-id="a6c2d-485">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="a6c2d-485">EVERYPAY</span></span>
- <span data-ttu-id="a6c2d-486">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="a6c2d-486">EACHPAYPERIOD</span></span>
- <span data-ttu-id="a6c2d-487">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="a6c2d-487">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="a6c2d-488">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="a6c2d-488">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="a6c2d-489">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-489">1OFMTH</span></span>
- <span data-ttu-id="a6c2d-490">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-490">LASTOFMTH</span></span>
- <span data-ttu-id="a6c2d-491">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-491">2OFMTH</span></span>
- <span data-ttu-id="a6c2d-492">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-492">3OFMTH</span></span>
- <span data-ttu-id="a6c2d-493">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-493">4OFMTH</span></span>
- <span data-ttu-id="a6c2d-494">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-494">5OFMTH</span></span>
- <span data-ttu-id="a6c2d-495">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-495">1N2OFMTH</span></span>
- <span data-ttu-id="a6c2d-496">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-496">3N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-497">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-497">1N3OFMTH</span></span>
- <span data-ttu-id="a6c2d-498">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-498">1N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-499">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-499">2N3OFMTH</span></span>
- <span data-ttu-id="a6c2d-500">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-500">2N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-501">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-501">1N2N3OFMTH</span></span>
- <span data-ttu-id="a6c2d-502">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-502">1N2N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-503">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-503">1N3N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-504">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-504">2N3N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-505">1N2N3N4OFMTH–1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-505">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-506">2N3N4N5OFMth–2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="a6c2d-506">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="a6c2d-507">1OFQTR–1OFQTR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-507">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="a6c2d-508">LASTOFQTR–LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-508">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="a6c2d-509">LASTMTHOFQTR–LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-509">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="a6c2d-510">1OFYEAR–1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-510">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="a6c2d-511">LASTOFYEAR–LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-511">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="a6c2d-512">NOVNDECOFYEAR–NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="a6c2d-513">Adreses</span><span class="sxs-lookup"><span data-stu-id="a6c2d-513">Addresses</span></span>

<span data-ttu-id="a6c2d-514">Noteiktas valsts vai reģiona, administratīvā apgabala un apgabala (pašvaldības) kodu identifikācijai ir nepieciešami konkrēti formāti, ko var atpazīt pakalpojums Dayforce un valsts/reģiona pakalpojumu sniedzēji.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-514">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="a6c2d-515">Lai gan pilsētu formāts var būt dažāds, katrai pilsētai ir jābūt saistītai ar administratīvo apgabalu.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-515">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="a6c2d-516">Personāla vadība</span><span class="sxs-lookup"><span data-stu-id="a6c2d-516">Human Resources</span></span>          | <span data-ttu-id="a6c2d-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a6c2d-517">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="a6c2d-518">Valsts/reģions</span><span class="sxs-lookup"><span data-stu-id="a6c2d-518">Country/Region</span></span>  | <span data-ttu-id="a6c2d-519">Valsts kods</span><span class="sxs-lookup"><span data-stu-id="a6c2d-519">Country Code</span></span>          |
| <span data-ttu-id="a6c2d-520">Pasta indekss</span><span class="sxs-lookup"><span data-stu-id="a6c2d-520">Zip/Postal Code</span></span> | <span data-ttu-id="a6c2d-521">Pasta indekss</span><span class="sxs-lookup"><span data-stu-id="a6c2d-521">Postal Code</span></span>           |
| <span data-ttu-id="a6c2d-522">Administratīvais apgabals</span><span class="sxs-lookup"><span data-stu-id="a6c2d-522">State</span></span>           | <span data-ttu-id="a6c2d-523">Administratīvā apgabala kods</span><span class="sxs-lookup"><span data-stu-id="a6c2d-523">State Code</span></span>            |
| <span data-ttu-id="a6c2d-524">Pilsēta</span><span class="sxs-lookup"><span data-stu-id="a6c2d-524">City</span></span>            | <span data-ttu-id="a6c2d-525">Pilsēta</span><span class="sxs-lookup"><span data-stu-id="a6c2d-525">City</span></span>                  |
| <span data-ttu-id="a6c2d-526">Apgabals</span><span class="sxs-lookup"><span data-stu-id="a6c2d-526">County</span></span>          | <span data-ttu-id="a6c2d-527">Apgabals (pašvaldība)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-527">County (Municipality)</span></span> |
| <span data-ttu-id="a6c2d-528">Iela</span><span class="sxs-lookup"><span data-stu-id="a6c2d-528">Street</span></span>          | <span data-ttu-id="a6c2d-529">Adreses 1. rinda</span><span class="sxs-lookup"><span data-stu-id="a6c2d-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="a6c2d-530">Nodokļu reģioni</span><span class="sxs-lookup"><span data-stu-id="a6c2d-530">Tax regions</span></span>

<span data-ttu-id="a6c2d-531">Nodokļu reģionus izmanto, lai noteiktu atbilstošos nodokļus, kas jāpiemēro, ģenerējot algu aprēķinus.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="a6c2d-532">Nodokļu reģioni tiek kartēti uz pakalpojumu Dayforce kā vietas adreses.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="a6c2d-533">Noklusējuma nodokļu reģionam ir jābūt saistītam ar nodarbinātā aktīvo amatu.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="a6c2d-534">Nodokļu reģions (obligāti)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-534">Tax region (required)</span></span>
- <span data-ttu-id="a6c2d-535">Valsts/reģions (obligāti)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-535">Country/Region (required)</span></span>
- <span data-ttu-id="a6c2d-536">Administratīvais apgabals (obligāti)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-536">State (required)</span></span>
- <span data-ttu-id="a6c2d-537">Apgabals</span><span class="sxs-lookup"><span data-stu-id="a6c2d-537">County</span></span> 
- <span data-ttu-id="a6c2d-538">Pilsēta (obligāti)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="a6c2d-539">Datu konfigurēšana algu aprēķina ģenerēšanai Meksikā</span><span class="sxs-lookup"><span data-stu-id="a6c2d-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="a6c2d-540">Ja ģenerējat algas darbiniekiem Meksikā, ir jākonfigurē tālāk norādītie elementi.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="a6c2d-541">Amatiem ir jānorāda nodaļas.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-541">Departments are required on positions.</span></span>
- <span data-ttu-id="a6c2d-542">Izmaksu centri ir jāiestata kā finanšu dimensijas, un tiem ir jābūt pirmajiem elementiem noklusējuma finanšu dimensijas virknē.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="a6c2d-543">Darba tipi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-543">Job types</span></span>

<span data-ttu-id="a6c2d-544">Darbu veidi tiek izmantoti, lai līdzīgus darbus grupētu kategorijās.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="a6c2d-545">Lai apstrādātu algas Meksikā, ir nepieciešami darbu veidi.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="a6c2d-546">Daži darbu veidu piemēri ir pilna laika, nepilna laika, algots un stundu apmaksas darbs.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="a6c2d-547">Darbu veidi tiek kartēti uz pakalpojumu Dayforce kā apmaksas tipi, lai norādītu, vai darbinieks saņem stundas samaksu vai algu.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="a6c2d-548">Ir jānorāda tālāk norādītie darbu veidi un apraksti.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="a6c2d-549">Darba veids</span><span class="sxs-lookup"><span data-stu-id="a6c2d-549">Job type</span></span>   | <span data-ttu-id="a6c2d-550">apraksts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="a6c2d-551">Ik stundu</span><span class="sxs-lookup"><span data-stu-id="a6c2d-551">Hourly</span></span>     | <span data-ttu-id="a6c2d-552">Stundu (MX)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-552">MX Hourly</span></span>   |
| <span data-ttu-id="a6c2d-553">Algots</span><span class="sxs-lookup"><span data-stu-id="a6c2d-553">Salaried</span></span>   | <span data-ttu-id="a6c2d-554">Algots (MX)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="a6c2d-555">Amatu veidi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-555">Position types</span></span> 

<span data-ttu-id="a6c2d-556">Amatu veidus izmanto, lai norādītu, vai amats ir pilna laika, nepilna laika vai cita veida darbs.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="a6c2d-557">Amatu veidi tiek kartēti uz pakalpojumu Dayforce kā apmaksas klases, lai norādītu, vai darbinieks ir pilna laika vai nepilna laika darbinieks.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="a6c2d-558">Ir jānorāda tālāk norādītie amatu veidi un apraksti.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="a6c2d-559">Amata tips</span><span class="sxs-lookup"><span data-stu-id="a6c2d-559">Position type</span></span>   | <span data-ttu-id="a6c2d-560">apraksts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="a6c2d-561">Pilna laika</span><span class="sxs-lookup"><span data-stu-id="a6c2d-561">Full-time</span></span>       | <span data-ttu-id="a6c2d-562">Pilna laika darbinieks</span><span class="sxs-lookup"><span data-stu-id="a6c2d-562">Full time employee</span></span> |
| <span data-ttu-id="a6c2d-563">Nepilna laika</span><span class="sxs-lookup"><span data-stu-id="a6c2d-563">Part-time</span></span>       | <span data-ttu-id="a6c2d-564">Nepilna laika darbinieks</span><span class="sxs-lookup"><span data-stu-id="a6c2d-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="a6c2d-565">Iemeslu kodi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-565">Reason codes</span></span>

<span data-ttu-id="a6c2d-566">Iemeslu kodi sniedz informāciju par darbinieka statusu.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="a6c2d-567">Iemeslu kodu tiek kartēti uz pakalpojumu Dayforce kā statusa iemesli, kas norāda darbinieka amata vai nodarbinātības statusa izmaiņu iemeslu.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="a6c2d-568">Ir jānorāda tālāk norādītie iemeslu kodi un apraksti.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="a6c2d-569">Iemeslu kodi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-569">Reason code</span></span>            | <span data-ttu-id="a6c2d-570">apraksts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-570">Description</span></span>                    | <span data-ttu-id="a6c2d-571">Piemērojamie scenāriji</span><span class="sxs-lookup"><span data-stu-id="a6c2d-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="a6c2d-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="a6c2d-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="a6c2d-573">Aiziešana no amata pirms pirmās algas</span><span class="sxs-lookup"><span data-stu-id="a6c2d-573">Departure before first payroll</span></span> | <span data-ttu-id="a6c2d-574">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-574">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-575">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="a6c2d-575">RESIGNATION</span></span>            | <span data-ttu-id="a6c2d-576">Atlūgums</span><span class="sxs-lookup"><span data-stu-id="a6c2d-576">Resignation</span></span>                    | <span data-ttu-id="a6c2d-577">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-577">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-578">PENSION</span><span class="sxs-lookup"><span data-stu-id="a6c2d-578">PENSION</span></span>                | <span data-ttu-id="a6c2d-579">Pensija</span><span class="sxs-lookup"><span data-stu-id="a6c2d-579">Pension</span></span>                        | <span data-ttu-id="a6c2d-580">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-580">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-581">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="a6c2d-581">TERMINATION</span></span>            | <span data-ttu-id="a6c2d-582">Izbeigšana</span><span class="sxs-lookup"><span data-stu-id="a6c2d-582">Termination</span></span>                    | <span data-ttu-id="a6c2d-583">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-583">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-584">RETIREMENT</span><span class="sxs-lookup"><span data-stu-id="a6c2d-584">RETIREMENT</span></span>             | <span data-ttu-id="a6c2d-585">Aiziešana pensijā</span><span class="sxs-lookup"><span data-stu-id="a6c2d-585">Retirement</span></span>                     | <span data-ttu-id="a6c2d-586">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-586">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-587">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="a6c2d-587">ABSENTEE</span></span>               | <span data-ttu-id="a6c2d-588">Darba kavētājs</span><span class="sxs-lookup"><span data-stu-id="a6c2d-588">Absentee</span></span>                       | <span data-ttu-id="a6c2d-589">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-589">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-590">CITI</span><span class="sxs-lookup"><span data-stu-id="a6c2d-590">OTHER</span></span>                  | <span data-ttu-id="a6c2d-591">Citi iemesli</span><span class="sxs-lookup"><span data-stu-id="a6c2d-591">Other Reasons</span></span>                  | <span data-ttu-id="a6c2d-592">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-592">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-593">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="a6c2d-593">CLOSURE</span></span>                | <span data-ttu-id="a6c2d-594">Uzņēmuma slēgšana</span><span class="sxs-lookup"><span data-stu-id="a6c2d-594">Business Closure</span></span>               | <span data-ttu-id="a6c2d-595">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-595">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-596">DEATH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-596">DEATH</span></span>                  | <span data-ttu-id="a6c2d-597">Nāve</span><span class="sxs-lookup"><span data-stu-id="a6c2d-597">Death</span></span>                          | <span data-ttu-id="a6c2d-598">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-598">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="a6c2d-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="a6c2d-600">Atvaļinājums</span><span class="sxs-lookup"><span data-stu-id="a6c2d-600">Leave of Absence</span></span>               | <span data-ttu-id="a6c2d-601">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-601">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="a6c2d-602">CONTRACTEND</span></span>            | <span data-ttu-id="a6c2d-603">Līguma beigas</span><span class="sxs-lookup"><span data-stu-id="a6c2d-603">End of Contract</span></span>                | <span data-ttu-id="a6c2d-604">Pārtraukt darba attiecības ar nodarbināto</span><span class="sxs-lookup"><span data-stu-id="a6c2d-604">Terminate worker</span></span>     |
| <span data-ttu-id="a6c2d-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="a6c2d-605">SALARYCHANGE</span></span>           | <span data-ttu-id="a6c2d-606">Algas izmaiņas</span><span class="sxs-lookup"><span data-stu-id="a6c2d-606">Change of Salary</span></span>               | <span data-ttu-id="a6c2d-607">Atlīdzība</span><span class="sxs-lookup"><span data-stu-id="a6c2d-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="a6c2d-608">Nodarbinātības noteikumi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-608">Terms of employment</span></span>

<span data-ttu-id="a6c2d-609">Nodarbinātības noteikumus izmanto, lai izveidotu nodarbinātības noteikumu kategorijas.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="a6c2d-610">Noteikumi tiek kartēti uz pakalpojumu Dayforce kā nodarbinātības rādītāju vērtības.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="a6c2d-611">Ir nepieciešami tālāk norādītie nodarbinātības noteikumi un apraksti.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="a6c2d-612">Nodarbinātības noteikumi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-612">Terms of employment</span></span>   | <span data-ttu-id="a6c2d-613">apraksts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="a6c2d-614">Regulārs</span><span class="sxs-lookup"><span data-stu-id="a6c2d-614">Regular</span></span>               | <span data-ttu-id="a6c2d-615">Regulārs</span><span class="sxs-lookup"><span data-stu-id="a6c2d-615">Regular</span></span>     |
| <span data-ttu-id="a6c2d-616">Tieši</span><span class="sxs-lookup"><span data-stu-id="a6c2d-616">Direct</span></span>                | <span data-ttu-id="a6c2d-617">Tieši</span><span class="sxs-lookup"><span data-stu-id="a6c2d-617">Direct</span></span>      |
| <span data-ttu-id="a6c2d-618">Štažēšanās</span><span class="sxs-lookup"><span data-stu-id="a6c2d-618">Internship</span></span>            | <span data-ttu-id="a6c2d-619">Štažēšanās</span><span class="sxs-lookup"><span data-stu-id="a6c2d-619">Internship</span></span>  |
| <span data-ttu-id="a6c2d-620">Pastāvīga</span><span class="sxs-lookup"><span data-stu-id="a6c2d-620">Permanent</span></span>             | <span data-ttu-id="a6c2d-621">Pastāvīga</span><span class="sxs-lookup"><span data-stu-id="a6c2d-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="a6c2d-622">Ģimenes stāvoklis</span><span class="sxs-lookup"><span data-stu-id="a6c2d-622">Marital status</span></span>

<span data-ttu-id="a6c2d-623">Ģimenes statusa vērtības tiek kartētas uz pakalpojumu Dayforce un integrācijas laikā atbilstoši tulkotas uz apstiprinātajām vērtībām.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a6c2d-624">Tālāk esošajā tabulā ir parādīts, kā ģimenes statusa vērtības tiek kartētas uz pakalpojumu Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="a6c2d-625">Personāla vadība</span><span class="sxs-lookup"><span data-stu-id="a6c2d-625">Human Resources</span></span>                 | <span data-ttu-id="a6c2d-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a6c2d-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="a6c2d-627">Precējies (-usies)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-627">Married</span></span>                | <span data-ttu-id="a6c2d-628">Precējies (-usies)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-628">Married</span></span>                   |
| <span data-ttu-id="a6c2d-629">Atsevišķs</span><span class="sxs-lookup"><span data-stu-id="a6c2d-629">Single</span></span>                 | <span data-ttu-id="a6c2d-630">Atsevišķs</span><span class="sxs-lookup"><span data-stu-id="a6c2d-630">Single</span></span>                    |
| <span data-ttu-id="a6c2d-631">Atraitnis (-ne)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-631">Widowed</span></span>                | <span data-ttu-id="a6c2d-632">Atraitnis (-ne)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-632">Widowed</span></span>                   |
| <span data-ttu-id="a6c2d-633">Šķīries (-usies)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-633">Divorced</span></span>               | <span data-ttu-id="a6c2d-634">Šķīries (-usies)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-634">Divorced</span></span>                  |
| <span data-ttu-id="a6c2d-635">Reģistrētas attiecības</span><span class="sxs-lookup"><span data-stu-id="a6c2d-635">Registered Partnership</span></span> | <span data-ttu-id="a6c2d-636">Dzīvesbiedrs</span><span class="sxs-lookup"><span data-stu-id="a6c2d-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="a6c2d-637">Neviens</span><span class="sxs-lookup"><span data-stu-id="a6c2d-637">None</span></span>                   | <span data-ttu-id="a6c2d-638">*Netiek atbalstīts Meksikā*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a6c2d-639">Kopdzīve</span><span class="sxs-lookup"><span data-stu-id="a6c2d-639">Cohabiting</span></span>             | <span data-ttu-id="a6c2d-640">*Netiek atbalstīts Meksikā*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="a6c2d-641">Dzimums</span><span class="sxs-lookup"><span data-stu-id="a6c2d-641">Gender</span></span>

<span data-ttu-id="a6c2d-642">Dzimuma apzīmējumi tiek kartēti uz pakalpojumu Dayforce un integrācijas laikā atbilstoši tulkoti uz apstiprinātajām vērtībām.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a6c2d-643">Tālāk esošajā tabulā ir parādīts, kā dzimuma apzīmējumi tiek kartēti uz pakalpojumu Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="a6c2d-644">Personāla vadība</span><span class="sxs-lookup"><span data-stu-id="a6c2d-644">Human Resources</span></span>       | <span data-ttu-id="a6c2d-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a6c2d-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="a6c2d-646">Vīrietis</span><span class="sxs-lookup"><span data-stu-id="a6c2d-646">Male</span></span>         | <span data-ttu-id="a6c2d-647">Vīrietis</span><span class="sxs-lookup"><span data-stu-id="a6c2d-647">Male</span></span>                      |
| <span data-ttu-id="a6c2d-648">Sieviete</span><span class="sxs-lookup"><span data-stu-id="a6c2d-648">Female</span></span>       | <span data-ttu-id="a6c2d-649">Sieviete</span><span class="sxs-lookup"><span data-stu-id="a6c2d-649">Female</span></span>                    |
| <span data-ttu-id="a6c2d-650">Nav specifisks</span><span class="sxs-lookup"><span data-stu-id="a6c2d-650">Non-specific</span></span> | <span data-ttu-id="a6c2d-651">*Netiek atbalstīts Meksikā*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="a6c2d-652">Maksājumu metode</span><span class="sxs-lookup"><span data-stu-id="a6c2d-652">Payment method</span></span>

<span data-ttu-id="a6c2d-653">Maksāšanas metodes darbiniekam un uzņēmumam ļauj aprakstīt, kā darbinieki saņems samaksu.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="a6c2d-654">Maksāšanas metodes tiek kartētas uz pakalpojumu Dayforce un integrācijas laikā atbilstoši tulkotas uz apstiprinātajām vērtībām.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a6c2d-655">Tālāk esošajā tabulā ir parādīts, kā maksāšanas metodes tiek kartētas uz pakalpojumu Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="a6c2d-656">Personāla vadība</span><span class="sxs-lookup"><span data-stu-id="a6c2d-656">Human Resources</span></span>             | <span data-ttu-id="a6c2d-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a6c2d-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="a6c2d-658">Kase</span><span class="sxs-lookup"><span data-stu-id="a6c2d-658">Cash</span></span>               | <span data-ttu-id="a6c2d-659">Kase</span><span class="sxs-lookup"><span data-stu-id="a6c2d-659">Cash</span></span>                      |
| <span data-ttu-id="a6c2d-660">Elektronisks maksājums</span><span class="sxs-lookup"><span data-stu-id="a6c2d-660">Electronic Payment</span></span> | <span data-ttu-id="a6c2d-661">Pārsūtījums</span><span class="sxs-lookup"><span data-stu-id="a6c2d-661">Transfer</span></span>                  |
| <span data-ttu-id="a6c2d-662">Pārbaudīt</span><span class="sxs-lookup"><span data-stu-id="a6c2d-662">Check</span></span>              | <span data-ttu-id="a6c2d-663">Čeks</span><span class="sxs-lookup"><span data-stu-id="a6c2d-663">Cheque</span></span>                    |
| <span data-ttu-id="a6c2d-664">Bankas vekselis</span><span class="sxs-lookup"><span data-stu-id="a6c2d-664">Bank Draft</span></span>         | <span data-ttu-id="a6c2d-665">*Netiek atbalstīts Meksikā*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a6c2d-666">Citi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-666">Other</span></span>              | <span data-ttu-id="a6c2d-667">*Netiek atbalstīts Meksikā*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="a6c2d-668">Bankas konta tips</span><span class="sxs-lookup"><span data-stu-id="a6c2d-668">Bank account type</span></span>

<span data-ttu-id="a6c2d-669">Bankas kontu tipus izmanto darbiniekiem sūtāmajiem elektroniskajiem maksājumiem.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="a6c2d-670">Bankas kontu tipi tiek kartēti uz pakalpojumu Dayforce kā pārsūtīšanas konta informācija.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="a6c2d-671">Bankas kontu tipi integrācijas laikā tiek atbilstoši tulkoti uz apstiprinātajām vērtībām.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="a6c2d-672">Personāla vadība</span><span class="sxs-lookup"><span data-stu-id="a6c2d-672">Human Resources</span></span>            | <span data-ttu-id="a6c2d-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a6c2d-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="a6c2d-674">Kontroles konts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-674">Checking Account</span></span>  | <span data-ttu-id="a6c2d-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="a6c2d-675">CheckingAccount</span></span>           |
| <span data-ttu-id="a6c2d-676">Algu konts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-676">Payroll Account</span></span>   | <span data-ttu-id="a6c2d-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="a6c2d-677">PayrollAccount</span></span>            |
| <span data-ttu-id="a6c2d-678">Uzkrājumu konts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-678">Savings Account</span></span>   | <span data-ttu-id="a6c2d-679">*Netiek atbalstīts Meksikā*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a6c2d-680">BankGirot konts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-680">BankGirot account</span></span> | <span data-ttu-id="a6c2d-681">*Netiek atbalstīts Meksikā*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a6c2d-682">PlusGirot konts</span><span class="sxs-lookup"><span data-stu-id="a6c2d-682">PlusGirot account</span></span> | <span data-ttu-id="a6c2d-683">*Netiek atbalstīts Meksikā*</span><span class="sxs-lookup"><span data-stu-id="a6c2d-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="a6c2d-684">Ienākumu veida kodi</span><span class="sxs-lookup"><span data-stu-id="a6c2d-684">Earning codes</span></span>

<span data-ttu-id="a6c2d-685">Ienākumu veidu kodi unikāli identificē katra veida ienākumus, ko saņem nodarbinātie.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="a6c2d-686">Kodiem ir vairāki ar ienākumiem saistīti parametri, piemēram, uzskaites nosacījumi, nodokļu likumi, pārskatu veidošanas prasības un bruto summas palielināšanas iespēja.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="a6c2d-687">Ja tiek izmantota neatbalstīta biežuma vērtība, aprēķinā pēc noklusējuma tiek lietota biežuma vērtība **Katra apmaksa**.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="a6c2d-688">Atbalstītās biežuma vērtības</span><span class="sxs-lookup"><span data-stu-id="a6c2d-688">Supported frequencies</span></span>

- <span data-ttu-id="a6c2d-689">Visus</span><span class="sxs-lookup"><span data-stu-id="a6c2d-689">All</span></span>
- <span data-ttu-id="a6c2d-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="a6c2d-690">EVERYPAY</span></span>
- <span data-ttu-id="a6c2d-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="a6c2d-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="a6c2d-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="a6c2d-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="a6c2d-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="a6c2d-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="a6c2d-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-694">1OFMTH</span></span>
- <span data-ttu-id="a6c2d-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-695">LASTOFMTH</span></span>
- <span data-ttu-id="a6c2d-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-696">2OFMTH</span></span>
- <span data-ttu-id="a6c2d-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-697">3OFMTH</span></span>
- <span data-ttu-id="a6c2d-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-698">4OFMTH</span></span>
- <span data-ttu-id="a6c2d-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-699">5OFMTH</span></span>
- <span data-ttu-id="a6c2d-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-700">1N2OFMTH</span></span>
- <span data-ttu-id="a6c2d-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-701">3N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-702">1N3OFMTH</span></span>
- <span data-ttu-id="a6c2d-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-703">1N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-704">2N3OFMTH</span></span>
- <span data-ttu-id="a6c2d-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-705">2N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="a6c2d-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-710">1N2N3N4OFMTH–1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a6c2d-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="a6c2d-711">2N3N4N5OFMth–2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="a6c2d-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="a6c2d-712">1OFQTR–1OFQTR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="a6c2d-713">LASTOFQTR–LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="a6c2d-714">LASTMTHOFQTR–LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="a6c2d-715">1OFYEAR–1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="a6c2d-716">LASTOFYEAR–LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="a6c2d-717">NOVNDECOFYEAR–NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a6c2d-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="a6c2d-718">Adreses</span><span class="sxs-lookup"><span data-stu-id="a6c2d-718">Addresses</span></span>

<span data-ttu-id="a6c2d-719">Noteiktas valsts vai reģiona, administratīvā apgabala un apgabala (pašvaldības) kodu identifikācijai ir nepieciešami konkrēti formāti, ko var atpazīt pakalpojums Dayforce un valsts/reģiona pakalpojumu sniedzēji.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="a6c2d-720">Lai gan pilsētu formāts var būt dažāds, katrai pilsētai ir jābūt saistītai ar administratīvo apgabalu.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="a6c2d-721">Personāla vadība</span><span class="sxs-lookup"><span data-stu-id="a6c2d-721">Human Resources</span></span>              | <span data-ttu-id="a6c2d-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a6c2d-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="a6c2d-723">Valsts/reģions</span><span class="sxs-lookup"><span data-stu-id="a6c2d-723">Country/Region</span></span>      | <span data-ttu-id="a6c2d-724">Valsts kods</span><span class="sxs-lookup"><span data-stu-id="a6c2d-724">Country Code</span></span>          |
| <span data-ttu-id="a6c2d-725">Pasta indekss</span><span class="sxs-lookup"><span data-stu-id="a6c2d-725">Zip/Postal Code</span></span>     | <span data-ttu-id="a6c2d-726">Pasta indekss</span><span class="sxs-lookup"><span data-stu-id="a6c2d-726">Postal Code</span></span>           |
| <span data-ttu-id="a6c2d-727">Administratīvais apgabals</span><span class="sxs-lookup"><span data-stu-id="a6c2d-727">State</span></span>               | <span data-ttu-id="a6c2d-728">Administratīvā apgabala kods</span><span class="sxs-lookup"><span data-stu-id="a6c2d-728">State Code</span></span>            |
| <span data-ttu-id="a6c2d-729">Pilsēta</span><span class="sxs-lookup"><span data-stu-id="a6c2d-729">City</span></span>                | <span data-ttu-id="a6c2d-730">Pilsēta</span><span class="sxs-lookup"><span data-stu-id="a6c2d-730">City</span></span>                  |
| <span data-ttu-id="a6c2d-731">Apgabals</span><span class="sxs-lookup"><span data-stu-id="a6c2d-731">County</span></span>              | <span data-ttu-id="a6c2d-732">Apgabals (pašvaldība)</span><span class="sxs-lookup"><span data-stu-id="a6c2d-732">County (Municipality)</span></span> |
| <span data-ttu-id="a6c2d-733">Iela</span><span class="sxs-lookup"><span data-stu-id="a6c2d-733">Street</span></span>              | <span data-ttu-id="a6c2d-734">Adreses 1. rinda</span><span class="sxs-lookup"><span data-stu-id="a6c2d-734">Address Line 1</span></span>        |
| <span data-ttu-id="a6c2d-735">Ielas numurs</span><span class="sxs-lookup"><span data-stu-id="a6c2d-735">Street Number</span></span>       | <span data-ttu-id="a6c2d-736">Adreses 2. rinda</span><span class="sxs-lookup"><span data-stu-id="a6c2d-736">Address Line 2</span></span>        |
| <span data-ttu-id="a6c2d-737">Mājas numurs/nosaukums</span><span class="sxs-lookup"><span data-stu-id="a6c2d-737">Building Complement</span></span> | <span data-ttu-id="a6c2d-738">Adreses 5. rinda</span><span class="sxs-lookup"><span data-stu-id="a6c2d-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="a6c2d-739">Pases numurs</span><span class="sxs-lookup"><span data-stu-id="a6c2d-739">Passport number</span></span>

<span data-ttu-id="a6c2d-740">Darbinieki var sniegt pases informāciju.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-740">Employees can declare passport information.</span></span> <span data-ttu-id="a6c2d-741">Šīs informācijas identifikācijas tips ir **Pase**, un tā tiek integrēta pakalpojumā Dayforce kā daļa no darbinieka Meksikai specifiskās informācijas.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="a6c2d-742">Identifikācijas tips = Pase</span><span class="sxs-lookup"><span data-stu-id="a6c2d-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="a6c2d-743">Izdošanas datums</span><span class="sxs-lookup"><span data-stu-id="a6c2d-743">Issued Date</span></span>
- <span data-ttu-id="a6c2d-744">Beigu datums</span><span class="sxs-lookup"><span data-stu-id="a6c2d-744">Expiration Date</span></span>

<span data-ttu-id="a6c2d-745">Darbinieki var sniegt vairākus identifikācijas numurus, kuru identifikācijas tips ir **Pase**.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="a6c2d-746">Taču pakalpojumā Dayforce tiek integrēts tikai pašreizējais aktīvais pases ieraksts.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="a6c2d-747">Ja visiem pases ierakstiem ir beidzies derīgiem, pakalpojumā Dayforce tiek integrēta pēdējā izdotā pase.</span><span class="sxs-lookup"><span data-stu-id="a6c2d-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
