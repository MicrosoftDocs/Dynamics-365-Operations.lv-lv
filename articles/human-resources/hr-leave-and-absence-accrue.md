...
5. Ja vēlaties palaist uzkrāšanas procesu fonā, atlasiet **Palaist fonā** un veiciet šādus uzdevumus:
    ...
    2. Lai iestatītu periodisku darbu, atlasiet **Periodiskums**, ievadiet periodiskuma informāciju un tad atlasiet **Labi**.
...
2. Atlasiet **Skatīt prombūtni** un pēc tam atlasiet cilni **Bilances**.

Lai skatītu ar noteiktu atvaļinājuma tipu saistītās uzkrājumu darbības, atlasiet skaitlisko vērtību kolonnā **Pašreizējā bilance**.

Lai skatītu darbības detaļas noteiktai uzkrāšanas summai, atlasiet uzkrāšanas rindu, atveriet **Saistīto informācijas** paneli labajā pusē un pēc tam atveriet sadaļu **Detalizēta informācija par darbību**. Darbību detalizētas informācijas sadaļā tiek rādīts:

- Darbinieka atvaļinājuma tipa bilances izmaiņas
- Nodarbinātības papildinformācija par šo norādīto uzkrāšanas periodu
