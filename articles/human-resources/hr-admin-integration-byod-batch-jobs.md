...
description: Šajā rakstā ir skaidrots, kā optimizēt veiktspēju, kad izmantojat savam datu bāzes (BYOD) līdzeklim Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/17/2020
ms.topic: article
ms.prod: ''
...
Šajā rakstā skaidrots, kā optimizēt veiktspēju, ja izmantojat savu datu bāzes (BYOD) funkciju. Plašāku informāciju par BYOD skatiet [Lietot savu datu bāzi (BYOD)](../fin-ops-core/dev-itpro/analytics/export-entities-to-your-own-database.md?toc=%2fdynamics365%2fhuman-resources%2ftoc.json).
