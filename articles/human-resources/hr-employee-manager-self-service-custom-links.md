...
description: Šajā rakstā ir aprakstīts, kā izveidot pielāgotas saites pārvaldnieka pašapkalpošanās sadaļā Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/26/2021
ms.topic: article
ms.prod: ''
...
2. Sadaļā **Iestatīt saites vadītājiem** varat pievienot, rediģēt vai noņemt saiti. Varat arī grupēt saites tā, lai tās tiktu rādītas pārvaldnieka pašapkalpošanās **grupā**.
...
3. Lai skatītu saites, atveriet cilni **Mana grupa** darbinieku **pašapkalpošanās sadaļā**.
