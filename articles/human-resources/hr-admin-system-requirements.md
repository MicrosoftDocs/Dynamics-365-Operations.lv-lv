...
description: Šajā rakstā ir uzskaitītas sistēmas prasības, kas darbojas korporācijai Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/11/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8879342"
---
# <a name="system-requirements"></a>Sistēmas prasības

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

Šajā rakstā ir uzskaitītas sistēmas prasības, kas darbojas korporācijai Microsoft Dynamics 365 Human Resources. Tajā ir arī norādītas valstis un reģioni, kur ir pieejama Human Resources, un informācija par valodām un lokalizāciju, kas jāizmanto Human Resources datiem.
