...
Ja noklikšķināt ar peles labo pogu uz rediģējama lauka (vai ja ir atlasīts teksts), tiek parādīta pārlūkprogrammas īsinājumizvēlne. Šī izvēlne sniedz pieeju komandām **Izgriezt**, **Kopēt** un **Ielīmēt**. Šīs komandas nevar iegult Finance and Operations īsinājumizvēlnēs, jo drošības apsvērumu dēļ pārlūkprogrammas liedz programmisku piekļuvi sistēmas starpliktuvei.
