...
## <a name="configure-azure-devops"></a><span data-ttu-id="8cb91-123">Konfigurēt Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="8cb91-123">Configure Azure DevOps</span></span>
...
<span data-ttu-id="8cb91-173">Savam LCS projektam varat izmantot esošu debitoru ieviešanu vai partnera projektu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-173">For your LCS project, you can use an existing customer implementation or partner project.</span></span>
...
9. <span data-ttu-id="8cb91-205">Tiek parādīts ziņojuma lodziņš ar tekstu “Jūs tiksit novirzīts uz ārēju vietni, lai autorizētu pakalpojumus LCS, lai tie jūsu vārdā varētu izveidot savienojumu ar Visual Studio Team Services.</span><span class="sxs-lookup"><span data-stu-id="8cb91-205">A message box appears that states, "You are about to be redirected to an eternal site to authorize LCS to connect to Visual Studio Team Services on your behalf.</span></span> <span data-ttu-id="8cb91-206">Vai turpināt?”.</span><span class="sxs-lookup"><span data-stu-id="8cb91-206">Proceed?"</span></span> <span data-ttu-id="8cb91-207">Atlasiet **Jā**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-207">Select **Yes**.</span></span>
...
4. <span data-ttu-id="8cb91-255">Aizpildiet laukus **Ieraksta nosaukums** un **Ieraksta apraksts** un pēc tam atlasiet **Sākt**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-255">Fill in the **Recording name** and **Recording description** fields, and then select **Start**.</span></span>
...
## <a name="get-started-with-rsat"></a><span data-ttu-id="8cb91-352">Darba sākšana ar RSAT</span><span class="sxs-lookup"><span data-stu-id="8cb91-352">Get started with RSAT</span></span>
...
### <a name="load-and-run-test-cases"></a><span data-ttu-id="8cb91-418">Testa gadījumu ielāde un izpilde</span><span class="sxs-lookup"><span data-stu-id="8cb91-418">Load and run test cases</span></span>
...
4. <span data-ttu-id="8cb91-431">Lai pārbaudītu, vai automatizācijas faili un parametru faili tiek saglabāti Azure DevOps, dodieties uz Azure DevOps projektu, atlasiet **Paneļi \> Darba vienumi** un atlasiet testa gadījumu **Jaunas preces izveide**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-431">To verify that the automation files and parameter files are saved to Azure DevOps, go to the Azure DevOps project, select **Boards \> Work Items**, and select the **Create a new product** test case.</span></span> <span data-ttu-id="8cb91-432">Cilnē **Pielikumi** ir jābūt redzamiem četriem failiem:</span><span class="sxs-lookup"><span data-stu-id="8cb91-432">On the **Attachments** tab, you should see four files:</span></span>
    ...
    - <span data-ttu-id="8cb91-433">**.cs** — C\# automatizācijas fails</span><span class="sxs-lookup"><span data-stu-id="8cb91-433">**.cs** – C\# automation file</span></span>
...
3. <span data-ttu-id="8cb91-461">Lai skatītu detalizētu kļūdas ziņojuma versiju pakalpojumā Azure DevOps, atlasiet **Atvērt pakalpojumā Azure DevOps**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-461">To view a detailed version of the error message in Azure DevOps, select **Open in Azure DevOps**.</span></span> <span data-ttu-id="8cb91-462">Pakalpojumā Azure DevOps var skatīt testa gadījuma statusu un detalizētu kļūdas ziņojumu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-462">In Azure DevOps, you can view the status of the test case and the detailed error message.</span></span>

    ![Detalizēts kļūdas ziņojums pakalpojumā Azure DevOps](./media/setup_rsa_tool_75.png)

4. <span data-ttu-id="8cb91-464">Lai skatītu testa rezultātus tieši Azure DevOps projektā, dodieties uz **Testēšanas plāni \> Testēšanas plāni \> Izpildes**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-464">To view the test results directly in the Azure DevOps project, go to **Test Plans \> Test Plans \> Runs**.</span></span> <span data-ttu-id="8cb91-465">Veiciet dubultklikšķi uz testa izpildes, par kuru vēlaties skatīt detalizētu informāciju.</span><span class="sxs-lookup"><span data-stu-id="8cb91-465">Double-click the test run that you want to see more details for.</span></span>

    ![Testa izpilžu saraksts pakalpojumā Azure DevOps](./media/setup_rsa_tool_76.png)

5. <span data-ttu-id="8cb91-467">Cilnē **Izpildes kopsavilkums** ir norādīts, ka testa gadījums ir nesekmīgs, bet nav sniegts faktiskais kļūdas ziņojums.</span><span class="sxs-lookup"><span data-stu-id="8cb91-467">The **Run summary** tab indicates that the test case failed, but it doesn't provide the actual error message.</span></span> <span data-ttu-id="8cb91-468">Lai skatītu detalizētu kļūdas ziņojumu, atlasiet cilni **Testa rezultāti**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-468">To view the detailed error message, select the **Test results** tab.</span></span>

    ![Cilne Izpildes kopsavilkums](./media/setup_rsa_tool_77.png)

    <span data-ttu-id="8cb91-470">Cilnē **Testa rezultāti** ir sniegta informācija par testa gadījumu, iznākums un kļūdas ziņojums.</span><span class="sxs-lookup"><span data-stu-id="8cb91-470">The **Test results** tab provides the test case information, together with the outcome and the error message.</span></span>

    ![Cilne Testa rezultāti](./media/setup_rsa_tool_78.png)

6. <span data-ttu-id="8cb91-472">Veiciet dubultklikšķi uz atbilstošā ieraksta, lai skatītu detalizētu kļūdas ziņojumu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-472">Double-click the relevant record to view the detailed error message.</span></span>

    ![Detalizēts kļūdas ziņojums](./media/setup_rsa_tool_79.png)

    > [!NOTE]
    > <span data-ttu-id="8cb91-474">Visi kļūdu ziņojumi ir pieejami arī lokāli direktorijā **C:\\Users\\\$YourUserName\\AppData\\Roaming\\regressionTool\\errormsg-.txt**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-474">All error messages are also available locally in **C:\\Users\\\$YourUserName\\AppData\\Roaming\\regressionTool\\errormsg-.txt**.</span></span>

7. <span data-ttu-id="8cb91-475">Varat arī eksportēt testa izpildes rezultātus no testēšanas plāna līmeņa, atlasot **Eksportēt**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-475">You can also export the test run results from the test plan level by selecting **Export**.</span></span>

    ![Testēšanas plāna eksportēšana](./media/setup_rsa_tool_80.png)

### <a name="modify-the-excel-parameter-file"></a><span data-ttu-id="8cb91-477">Excel parametru faila modificēšana</span><span class="sxs-lookup"><span data-stu-id="8cb91-477">Modify the Excel parameter file</span></span>

1. <span data-ttu-id="8cb91-478">Atveriet RSAT.</span><span class="sxs-lookup"><span data-stu-id="8cb91-478">Open RSAT.</span></span>
2. <span data-ttu-id="8cb91-479">Atlasiet testa gadījumu un pēc tam atlasiet **Rediģēt**, lai atvērtu Excel parametru failu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-479">Select the test case, and then select **Edit** to open the Excel parameter file.</span></span>

    <span data-ttu-id="8cb91-480">Lapā **EcoResProductCreate** ievērojiet, ka lauka **Preces numurs** vērtība ir stingri kodēta.</span><span class="sxs-lookup"><span data-stu-id="8cb91-480">On the **EcoResProductCreate** sheet, notice that the value of the **Product number** field is hard-coded.</span></span> <span data-ttu-id="8cb91-481">Pirms atkārtotas testa gadījuma palaišanas preces numurs šajā laukā ir jāatjaunina uz jaunās preces numuru.</span><span class="sxs-lookup"><span data-stu-id="8cb91-481">You must update this field to a new product number before you run the test case again.</span></span>

3. <span data-ttu-id="8cb91-482">Lai ģenerētu unikālu preces numuru katrai izpildei bez vajadzības atkārtoti atvērt Excel parametru failu un manuāli atjaunināt preces numuru katru reizi, izmantojiet šādu Excel formulu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-482">To generate a unique product number for each run without having to reopen the Excel parameter file and manually update the product number every time, use the following Excel formula.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="8cb91-483">Papildus cilnei **Vispārīgi** Excel parametru failā ir ietverta datu cilne katrai Finance and Operations veidlapas lapai, kura tiek pārskatīta testa gadījuma izpildes laikā.</span><span class="sxs-lookup"><span data-stu-id="8cb91-483">In addition to the **General** tab, the Excel parameter file contains a data tab for every Finance and Operations form page the test case visits.</span></span>

    ![Lauks Preces numurs](./media/setup_rsa_tool_81.png)

4. <span data-ttu-id="8cb91-485">Atlasiet **Saglabāt** un pēc tam aizveriet Excel darbgrāmatu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-485">Select **Save**, and then close the Excel workbook.</span></span>
5. <span data-ttu-id="8cb91-486">Atlasiet **Augšupielādēt**, lai saglabātu Excel parametru failu pakalpojumā Azure DevOps.</span><span class="sxs-lookup"><span data-stu-id="8cb91-486">Select **Upload** to save the Excel parameter file to Azure DevOps.</span></span>

    ![Ziņojums par sekmīgu augšupielādēšanu](./media/setup_rsa_tool_82.png)

    > [!NOTE]
    > <span data-ttu-id="8cb91-488">Lai palaistu testa gadījumus noteikta lietotāja kontekstā, ievadiet lietotāja e-pasta ID Excel parametru faila laukā **Testēt lietotāju**, kas atrodas cilnē **Vispārīgi**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-488">To run test cases in a specific user context, enter the user's email ID in the **Test User** field on the **General** tab of the Excel parameter file.</span></span> <span data-ttu-id="8cb91-489">Jaunākajā RSAT versijā Excel parametru faila lauku izkārtojums ir atjaunināts, bet koncepcija paliek tāda pati.</span><span class="sxs-lookup"><span data-stu-id="8cb91-489">In the latest version of RSAT, the layout of the fields in the Excel parameter file has been updated, but the concept remains the same.</span></span>
    >
    > ![Lauks Testēt lietotāju](./media/setup_rsa_tool_83.png)

### <a name="validate-the-results"></a><span data-ttu-id="8cb91-491">Rezultātu pārbaude</span><span class="sxs-lookup"><span data-stu-id="8cb91-491">Validate the results</span></span>

- <span data-ttu-id="8cb91-492">Atlasiet **Palaist**, lai palaistu testa gadījumu, un pārbaudiet, vai testa gadījums ir sekmīgs.</span><span class="sxs-lookup"><span data-stu-id="8cb91-492">Select **Run** to rerun the test case, and verify that the test case has passed.</span></span> <span data-ttu-id="8cb91-493">Varat skatīt testa rezultātus, kā aprakstīts sadaļā [Testa rezultātu skatīšana](#view-the-test-results).</span><span class="sxs-lookup"><span data-stu-id="8cb91-493">You can view the test results as described in the [View the test results](#view-the-test-results) section.</span></span>

    ![Lauks Rezultāts ir iestatīts kā Sekmīgs](./media/setup_rsa_tool_84.png)

### <a name="chaining-of-test-cases"></a><span data-ttu-id="8cb91-495">Testa gadījumu ķēde</span><span class="sxs-lookup"><span data-stu-id="8cb91-495">Chaining of test cases</span></span>

<span data-ttu-id="8cb91-496">Viens no RSAT svarīgākajiem līdzekļiem ir testa gadījumu savienošana ķēdē (jeb iespēja nodot testa vērtības citiem testiem).</span><span class="sxs-lookup"><span data-stu-id="8cb91-496">One key feature of RSAT is the chaining of test cases (that is, the capability of a test to pass values to other tests).</span></span> <span data-ttu-id="8cb91-497">Testa gadījumi tiek palaisti atbilstoši secībai, kas noteikta Azure DevOps testēšanas plānā.</span><span class="sxs-lookup"><span data-stu-id="8cb91-497">Test cases are run according to their defined order in the Azure DevOps test plan.</span></span> <span data-ttu-id="8cb91-498">(Šo secību var atjaunināt pašā testēšanas rīkā.) Tādēļ, ja vēlaties pārnest mainīgos no viena testa gadījuma uz citu, ir ļoti svarīgi, lai testi būtu pareizā secībā.</span><span class="sxs-lookup"><span data-stu-id="8cb91-498">(This order can also be updated in the test tool itself.) Therefore, if you want to pass variables from one test case to another, it's very important that the tests be in the correct order.</span></span>

<span data-ttu-id="8cb91-499">Šajā sadaļā parādīts, kā izveidot saglabātu mainīgo pirmajā testa gadījumā, izveidot otru testa gadījumu un pārnest saglabāto mainīgo no pirmā testa gadījuma uz otro testa gadījumu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-499">In this section, you will create a saved variable in the first test case, create a second test case, and pass the saved variable from the first test case to the second test case.</span></span> <span data-ttu-id="8cb91-500">Pēc tam testa gadījumi tiek izpildīti kā testa gadījumu ķēde rīkā RSAT.</span><span class="sxs-lookup"><span data-stu-id="8cb91-500">You will then run the test cases as a chained test case in RSAT.</span></span>

#### <a name="modify-an-existing-task-recording-to-create-a-saved-variable"></a><span data-ttu-id="8cb91-501">Esoša uzdevuma ieraksta modificēšana saglabāta mainīgā izveidei</span><span class="sxs-lookup"><span data-stu-id="8cb91-501">Modify an existing task recording to create a saved variable</span></span>

1. <span data-ttu-id="8cb91-502">Atveriet Finance and Operations klientu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-502">Open the Finance and Operations client.</span></span>
2. <span data-ttu-id="8cb91-503">Atlasiet pogu **Iestatījumi** (zobrata simbols) un pēc tam atlasiet **Uzdevuma reģistrētājs**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-503">Select the **Settings** button (the gear symbol), and then select **Task recorder**.</span></span>
3. <span data-ttu-id="8cb91-504">Atlasiet **Rediģēt ierakstu**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-504">Select **Edit Recording**.</span></span>

    ![Poga Rediģēt ierakstu](./media/setup_rsa_tool_85.png)

4. <span data-ttu-id="8cb91-506">Atlasiet **Atvērt no Lifecycle Services**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-506">Select **Open from Lifecycle Services**.</span></span>

    ![Poga Atvērt no Lifecycle Services](./media/setup_rsa_tool_86.png)

5. <span data-ttu-id="8cb91-508">Atlasiet **Atlasīt Lifecycle Services bibliotēku**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-508">Select **Select the Lifecycle Services library**.</span></span>

    ![Poga Atlasīt Lifecycle Services bibliotēku](./media/setup_rsa_tool_87.png)

    <span data-ttu-id="8cb91-510">BPM bibliotēkas tiek ielādētas no LCS.</span><span class="sxs-lookup"><span data-stu-id="8cb91-510">BPM libraries are loaded from LCS.</span></span>

    ![Norises indikators](./media/setup_rsa_tool_88.png)

6. <span data-ttu-id="8cb91-512">Pēc BPM bibliotēku ielādēšanas no LCS atlasiet BPM bibliotēku **RSAT** un biznesa procesu **Jaunas preces izveide**, ar kuru bija saistīts uzdevuma ieraksts.</span><span class="sxs-lookup"><span data-stu-id="8cb91-512">After the BPM libraries are loaded from LCS, select the **RSAT** BPM library and the **Create a new product** business process that the task recording was associated with.</span></span> <span data-ttu-id="8cb91-513">Tad atl. **Labi**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-513">Then select **OK**.</span></span>

    ![BPM bibliotēkas un biznesa procesa atlase](./media/setup_rsa_tool_89.png)

7. <span data-ttu-id="8cb91-515">Atbilstošā uzdevuma ieraksta nosaukums tiek ievadīts laukā **Ieraksta nosaukums**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-515">The name of the appropriate task recording is entered in the **Recording name** field.</span></span> <span data-ttu-id="8cb91-516">Atlasiet **Sākt**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-516">Select **Start**.</span></span>

    ![Uzdevuma ieraksta nosaukums laukā Ieraksta nosaukums](./media/setup_rsa_tool_90.png)

8. <span data-ttu-id="8cb91-518">Dodieties uz **Preču informācijas pārvaldība \> Preces** un atlasiet **Jauns**, lai atvērtu lapu, kurā tika reģistrēts sākotnējais uzdevuma ieraksts **Preces izveide**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-518">Go to **Product information management \> Products**, and select **New** to open the page where the original task recording, **Create a product**, was recorded.</span></span>
9. <span data-ttu-id="8cb91-519">Atlasiet **Ievietot darbību**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-519">Select **Insert step**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="8cb91-520">Jaunā darbība tiek ievietota **pēc** darbības, kuru atlasījāt rūtī.</span><span class="sxs-lookup"><span data-stu-id="8cb91-520">The new step is inserted **after** the step that you selected in the pane.</span></span>

    ![Poga Ievietot darbību](./media/setup_rsa_tool_91.png)

10. <span data-ttu-id="8cb91-522">Ar peles labo pogu noklikšķiniet uz lauka **Preces numurs** un pēc tam atlasiet **Uzdevuma reģistrētājs \> Kopēt**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-522">Right-click the **Product number** field, and then select **Task recorder \> Copy**.</span></span>

    ![Komanda Kopēt](./media/setup_rsa_tool_92.png)

11. <span data-ttu-id="8cb91-524">Rūtī tiek pievienota jauna darbība.</span><span class="sxs-lookup"><span data-stu-id="8cb91-524">A new step is added in the pane.</span></span> <span data-ttu-id="8cb91-525">Pierakstiet laukā **Preces numurs** redzamo vērtību, jo tā būs nepieciešama vēlāk.</span><span class="sxs-lookup"><span data-stu-id="8cb91-525">Make a note of the value in the **Product number** field, because you will need it later.</span></span>

    ![Pievienota jauna darbība](./media/setup_rsa_tool_93.png)

12. <span data-ttu-id="8cb91-527">Atlasiet **Rediģēšana pabeigta**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-527">Select **Done editing**.</span></span>
13. <span data-ttu-id="8cb91-528">Atlasiet **Saglabāt pakalpojumos Lifecycle Services** un saistiet jauno uzdevuma ierakstu ar to pašu BPM bibliotēku un biznesa procesu, ar kuru tika saistīts sākotnējais uzdevuma ieraksts.</span><span class="sxs-lookup"><span data-stu-id="8cb91-528">Select **Save to Lifecycle Services**, and associate the new task recording with the same BPM library and business process that the original task recording was associated with.</span></span> <span data-ttu-id="8cb91-529">Papildinformāciju skatiet sadaļā [Uzdevuma ieraksta izveide un saglabāšana BPM bibliotēkā](#create-a-task-recording-and-save-it-to-the-bpm-library).</span><span class="sxs-lookup"><span data-stu-id="8cb91-529">For more information, see the [Create a task recording and save it to the BPM library](#create-a-task-recording-and-save-it-to-the-bpm-library) section.</span></span>
14. <span data-ttu-id="8cb91-530">Dodieties uz BPM bibliotēku un atlasiet **Sinhronizēt testa piemērus**, lai pārrakstītu uzdevuma ierakstu, kas ir pievienots testa gadījumam pakalpojumā Azure DevOps, kā aprakstīts sadaļā [Sinhronizācijas testēšana no BPM ar Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops).</span><span class="sxs-lookup"><span data-stu-id="8cb91-530">Go to the BPM library, and select **Sync testcases** to overwrite the task recording that is attached to the test case in Azure DevOps, as described in the [Test the synchronization from BPM to Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops) section.</span></span>
15. <span data-ttu-id="8cb91-531">Atveriet RSAT un atlasiet **Ielādēt**, lai atkārtoti ielādētu visus testa gadījumus testu komplektā.</span><span class="sxs-lookup"><span data-stu-id="8cb91-531">Open RSAT, and select **Load** to reload all the test cases in the test suite.</span></span> <span data-ttu-id="8cb91-532">Ir nepieciešams atkārtoti ģenerēt atbilstošā testa gadījuma automatizācijas un parametru failus, atlasot testa gadījumu un pēc tam atlasot **Jauns \> Ģenerēt testa izpildes un parametru failus**, kā aprakstīts sadaļā [Testa gadījumu ielāde un izpilde](#load-and-run-test-cases).</span><span class="sxs-lookup"><span data-stu-id="8cb91-532">You must regenerate the automation and parameter files for the appropriate test case by selecting the test case and then selecting **New \> Generate Test Execution and Parameter files**, as described in the [Load and run test cases](#load-and-run-test-cases) section.</span></span>

    > [!NOTE]
    > <span data-ttu-id="8cb91-533">Ja Excel parametru fails ir atstāts atvērts, atkārtota ģenerēšana ir nesekmīga.</span><span class="sxs-lookup"><span data-stu-id="8cb91-533">If the Excel parameter file was left open, regeneration will fail.</span></span> <span data-ttu-id="8cb91-534">Tāpēc pirms jaunā Excel parametru faila ģenerēšanas pārliecinieties, ka testa gadījuma Excel parametru fails ir aizvērts.</span><span class="sxs-lookup"><span data-stu-id="8cb91-534">Therefore, make sure that the Excel parameter file for the test case is closed before you generate the new Excel parameter file.</span></span>

16. <span data-ttu-id="8cb91-535">Atlasiet **Rediģēt**, lai atvērtu jauno Excel parametru failu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-535">Select **Edit** to open the new Excel parameter file.</span></span> <span data-ttu-id="8cb91-536">9. rindā ir redzams jauns ieraksts **Saglabāts mainīgais**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-536">You will see a new **Saved variable** entry on line 9.</span></span> <span data-ttu-id="8cb91-537">Šis mainīgais **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}** tiek saglabāts uzdevuma ieraksta XML failā, un to var izmantot nākamajos testos.</span><span class="sxs-lookup"><span data-stu-id="8cb91-537">This variable, **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}**, is saved in the task recording's XML file and can be used in subsequent tests.</span></span>

    ![Ieraksts Saglabāts mainīgais](./media/setup_rsa_tool_94.png)

#### <a name="create-a-new-test-case"></a><span data-ttu-id="8cb91-539">Jauna testa gadījuma izveide</span><span class="sxs-lookup"><span data-stu-id="8cb91-539">Create a new test case</span></span>

1. <span data-ttu-id="8cb91-540">Dodieties uz BPM bibliotēku **RSAT**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-540">Go to the **RSAT** BPM library.</span></span>
2. <span data-ttu-id="8cb91-541">Atlasiet procesu **Atbalsta biznesa procesa paraugs** un pēc tam labajā pusē atlasiet **Rediģēšanas režīms**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-541">Select the **Sample Support Business Process** process, and then, on the right, select **Edit mode**.</span></span>
3. <span data-ttu-id="8cb91-542">Nomainiet lauka **Nosaukums** un lauka **Apraksts** vērtību uz **Preces izlaišana**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-542">Change the value of both the **Name** field and the **Description** field to **Release a product**.</span></span> <span data-ttu-id="8cb91-543">Pēc tam atlasiet **Saglabāt**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-543">Then select **Save**.</span></span>

    ![Nosaukums un apraksts ir mainīts uz Preces izlaišana](./media/setup_rsa_tool_95.png)

#### <a name="create-a-new-task-recording-that-has-a-validate-function"></a><span data-ttu-id="8cb91-545">Jauna uzdevuma ieraksta izveide, kam ir funkcija Validēt</span><span class="sxs-lookup"><span data-stu-id="8cb91-545">Create a new task recording that has a Validate function</span></span>

- <span data-ttu-id="8cb91-546">Izveidojiet uzdevuma ierakstu, lai izlaistu preci, kas iepriekš tika izveidota USRT juridiskajai personai.</span><span class="sxs-lookup"><span data-stu-id="8cb91-546">Create a task recording to release the product that was created earlier to the USRT legal entity.</span></span> <span data-ttu-id="8cb91-547">Papildinformāciju skatiet sadaļā [Uzdevuma ieraksta izveide un saglabāšana BPM bibliotēkā](#create-a-task-recording-and-save-it-to-the-bpm-library).</span><span class="sxs-lookup"><span data-stu-id="8cb91-547">For more information, see the [Create a task recording and save it to the BPM library](#create-a-task-recording-and-save-it-to-the-bpm-library) section.</span></span>

    > [!NOTE]
    > <span data-ttu-id="8cb91-548">Ķēdē savienotiem testa gadījumiem vienmēr ieteicams atrast vai filtrēt nepieciešamo ierakstu, *ierakstot lauka vērtību manuāli*.</span><span class="sxs-lookup"><span data-stu-id="8cb91-548">For chained test cases, we always recommend that you find or filter for the record that you require by *manually typing the value of the field*.</span></span> <span data-ttu-id="8cb91-549">Šādā veidā rīks var noteikt ierakstu, ar kuru ir jāveic darbība attiecībā pret nākamo testa gadījumu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-549">In that way, the tool can determine the record that the action must be taken against in the subsequent test case.</span></span>

    ![Jauns uzdevuma ieraksts, kam ir funkcija Validēt](./media/setup_rsa_tool_96.png)

    <span data-ttu-id="8cb91-551">Kā redzams iepriekšējā attēlā, pēc produkta atrašanas, izmantojot ātro filtru, bet pirms vienuma **Izlaist preces** atlasīšanas ir jāvalidē lauka **Preces numurs** vērtība, lai pārliecinātos, ka preces ID ir iepriekš izveidotais preces ID.</span><span class="sxs-lookup"><span data-stu-id="8cb91-551">As the preceding illustration shows, after the product is found by using the Quick Filter, but before you select **Release products**, you validate the value of the **Product number** field to make sure that the product ID is the product ID that was created earlier.</span></span> <span data-ttu-id="8cb91-552">Lai validētu vērtību, ar peles labo pogu noklikšķiniet uz lauka **Preces numurs** un pēc tam atlasiet **Uzdevuma reģistrētājs \> Validēt \> Pašreizējā vērtība**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-552">To validate the value, right-click the **Product number** field, and then select **Task recorder \> Validate \> Current Value**.</span></span>

    ![Pašreizējās vērtības validēšana](./media/setup_rsa_tool_97.png)

#### <a name="save-the-task-recording-to-bpm"></a><span data-ttu-id="8cb91-554">Uzdevuma ieraksta saglabāšana BPM</span><span class="sxs-lookup"><span data-stu-id="8cb91-554">Save the task recording to BPM</span></span>

1. <span data-ttu-id="8cb91-555">Kad uzdevuma ieraksts ir pabeigts, atlasiet **Saglabāt pakalpojumos Lifecycle Services**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-555">After the task recording is completed, select **Save to Lifecycle Services**.</span></span>

    ![Saglabāšanas opcijas](./media/setup_rsa_tool_98.png)

2. <span data-ttu-id="8cb91-557">Bibliotēkas informācija tiek ielādēta no LCS.</span><span class="sxs-lookup"><span data-stu-id="8cb91-557">Library information is loaded from LCS.</span></span>

    ![Norises indikators](./media/setup_rsa_tool_99.png)

3. <span data-ttu-id="8cb91-559">Atlasiet BPM bibliotēku, kuru saistīt ar uzdevuma ierakstu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-559">Select the BPM library to associate the task recording with.</span></span> <span data-ttu-id="8cb91-560">Šajā apmācībā atlasiet BPM bibliotēku **RSAT**, kas tika izveidota iepriekš, un biznesa procesu **Preces izlaišana** zem tās.</span><span class="sxs-lookup"><span data-stu-id="8cb91-560">For this tutorial, select the **RSAT** BPM library that was created earlier and the **Release a product** business process under it.</span></span> <span data-ttu-id="8cb91-561">Tad atl. **Labi**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-561">Then select **OK**.</span></span>

#### <a name="sync-bpm-to-azure-devops"></a><span data-ttu-id="8cb91-562">BPM sinhronizēšana ar Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="8cb91-562">Sync BPM to Azure DevOps</span></span>

1. <span data-ttu-id="8cb91-563">Dodieties uz BPM bibliotēku un atveriet bibliotēku **RSAT**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-563">Go to the BPM library, and open the **RSAT** library.</span></span>
2. <span data-ttu-id="8cb91-564">Atlasiet **VSTS sinhronizācija** un pēc tam atlasiet **Sinhronizēt testa gadījumus**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-564">Select **VSTS sync** and then **Sync test cases**.</span></span> <span data-ttu-id="8cb91-565">Papildinformāciju skatiet sadaļā [Sinhronizācijas testēšana no BPM ar Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops).</span><span class="sxs-lookup"><span data-stu-id="8cb91-565">For more information, see the [Test the synchronization from BPM to Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops) section.</span></span>

    <span data-ttu-id="8cb91-566">Kad sinhronizācija ir pabeigta, jaunais darba vienums un atbilstošais testa gadījums biznesa procesam **Preces izlaišana** tiek parādīts pakalpojumā Azure DevOps šeit: **Paneļi \> Darba vienumi**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-566">After the synchronization is completed, the new work item and the corresponding test case for the **Release a product** business process appear in Azure DevOps at **Boards \> Work Items**.</span></span>

#### <a name="add-the-new-test-case-to-the-existing-test-suite"></a><span data-ttu-id="8cb91-567">Jauna testa gadījuma pievienošana esošajam testu komplektam</span><span class="sxs-lookup"><span data-stu-id="8cb91-567">Add the new test case to the existing test suite</span></span>

1. <span data-ttu-id="8cb91-568">Dodieties uz **Testēšanas plāni \> Testēšanas plāni** un atlasiet plānu **RSAT testēšanas plāns**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-568">Go to **Test plans \> Test plans**, and select the **RSAT Test Plan** plan.</span></span>
2. <span data-ttu-id="8cb91-569">Atlasiet **Pievienot esošu**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-569">Select **Add existing**.</span></span>
3. <span data-ttu-id="8cb91-570">Lapā **Pievienot testa gadījumus komplektam** atlasiet **Izpildīt vaicājumu**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-570">On the **Add test cases to suite** page, select **Run query**.</span></span>
4. <span data-ttu-id="8cb91-571">Atlasiet jauno testa gadījumu, kas tika izveidots procesam **Preces izlaišana**, un pēc tam atlasiet **Pievienot testa gadījumus** lapas apakšējā labajā stūrī (šī poga nākamajā attēlā nav redzama).</span><span class="sxs-lookup"><span data-stu-id="8cb91-571">Select the new test case that was created for **Release a product**, and then select **Add test cases** in the lower-right corner of the page (this button isn't shown in the following illustration).</span></span>

    ![Lapa Pievienot testa gadījumus komplektam](./media/setup_rsa_tool_100.png)

    <span data-ttu-id="8cb91-573">Tagad testu komplektā ir divi testa gadījumi.</span><span class="sxs-lookup"><span data-stu-id="8cb91-573">The test suite now has two test cases.</span></span>

    ![Divi testa gadījumi testu komplektā](./media/setup_rsa_tool_101.png)

#### <a name="load-test-cases-into-rsat"></a><span data-ttu-id="8cb91-575">Testa gadījumu ielādēšana rīkā RSAT</span><span class="sxs-lookup"><span data-stu-id="8cb91-575">Load test cases into RSAT</span></span>

1. <span data-ttu-id="8cb91-576">Atveriet RSAT un atlasiet **Ielādēt**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-576">Open RSAT, and select **Load**.</span></span>
2. <span data-ttu-id="8cb91-577">Testa gadījumi tiek ielādēti, un tiek parādīts brīdinājums ar tekstu “Veicot šo darbību, tiks pārrakstīti Excel testa datu faili, un lokālās izmaiņas tiks zaudētas.</span><span class="sxs-lookup"><span data-stu-id="8cb91-577">The test cases are loaded, and you receive a warning that states, "This action will overwrite Excel test data files, local changes will be lost.</span></span> <span data-ttu-id="8cb91-578">Vai vēlaties turpināt?”.</span><span class="sxs-lookup"><span data-stu-id="8cb91-578">Do you want to proceed?"</span></span> <span data-ttu-id="8cb91-579">Atlasiet **Jā**, lai atjauninātu Excel parametru failus lokālajā sistēmā, bet ne tos Excel parametru failus, kas tika augšupielādēti pakalpojumā Azure DevOps.</span><span class="sxs-lookup"><span data-stu-id="8cb91-579">Select **Yes** to update the Excel parameter files in the local system but not the Excel parameter files that were uploaded to Azure DevOps.</span></span>

    ![Brīdinājuma ziņojums](./media/setup_rsa_tool_102.png)

    <span data-ttu-id="8cb91-581">Abi testa gadījumi tiek ielādēti kopā ar pirmā testa gadījuma Excel parametru failu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-581">Both the test cases are loaded, together with the Excel parameter file for the first test case.</span></span> <span data-ttu-id="8cb91-582">Pēdējā izpildē jūs atlasījāt **Augšupielādēt**, tādēļ parametru faili tiek ņemti no Azure DevOps.</span><span class="sxs-lookup"><span data-stu-id="8cb91-582">Because you selected **Upload** in the last run, the parameter files are pulled from Azure DevOps.</span></span>

    ![Ielādētie testa gadījumi](./media/setup_rsa_tool_103.png)

3. <span data-ttu-id="8cb91-584">Atlasiet tikai otro testa gadījumu un pēc tam atlasiet **Jauns \> Ģenerēt testa izpildes un parametru failus**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-584">Select only the second test case, and then select **New \> Generate test execution and parameter files**.</span></span>

#### <a name="edit-the-excel-parameter-file"></a><span data-ttu-id="8cb91-585">Excel parametru faila rediģēšana</span><span class="sxs-lookup"><span data-stu-id="8cb91-585">Edit the Excel parameter file</span></span>

1. <span data-ttu-id="8cb91-586">Atlasiet tikai otro testa gadījumu un pēc tam atlasiet **Rediģēt**, lai atvērtu atbilstošo Excel parametru failu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-586">Select only the second test case, and then select **Edit** to open the corresponding Excel parameter file.</span></span>
2. <span data-ttu-id="8cb91-587">Kopējiet saglabāto mainīgo **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}** (skatiet sadaļu [Esoša uzdevuma ieraksta modificēšana, lai izveidotu saglabātu mainīgo](#modify-an-existing-task-recording-to-create-a-saved-variable)) no pirmā testa gadījuma visos laukos, kur tiek izmantots preces numurs.</span><span class="sxs-lookup"><span data-stu-id="8cb91-587">Copy the **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}** saved variable (see the [Modify an existing task recording to create a saved variable](#modify-an-existing-task-recording-to-create-a-saved-variable) section) from the first test case into all the fields where the product number is used.</span></span> <span data-ttu-id="8cb91-588">Šajā gadījumā mainīgais ir jākopē laukos **Preces numurs** un **Validēt preces numuru** lapā **EcoResProductListPage**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-588">In this case, you copy the variable into the **Product number** and **Validate Product number** fields on the **EcoResProductListPage** sheet.</span></span>

    ![Lauki Preces numurs un Validēt preces numuru](./media/setup_rsa_tool_104.png)

    > [!NOTE]
    > <span data-ttu-id="8cb91-590">Mainīgie var tikt nodoti starp testiem tikai tās pašas testa izpildes laikā.</span><span class="sxs-lookup"><span data-stu-id="8cb91-590">Variables can be passed between tests only during the same test run.</span></span> <span data-ttu-id="8cb91-591">Mainīgo nosaukumiem ir precīzi jāsakrīt.</span><span class="sxs-lookup"><span data-stu-id="8cb91-591">The names of the variables must match exactly.</span></span>

3. <span data-ttu-id="8cb91-592">Atlasiet **Saglabāt** un pēc tam aizveriet Excel darbgrāmatu.</span><span class="sxs-lookup"><span data-stu-id="8cb91-592">Select **Save**, and then close the Excel workbook.</span></span>
4. <span data-ttu-id="8cb91-593">Atlasiet **Augšupielādēt**, lai saglabātu izmaiņas, kuras veicāt Excel parametru failā.</span><span class="sxs-lookup"><span data-stu-id="8cb91-593">Select **Upload** to save the changes that you made to the Excel parameter file.</span></span>

#### <a name="run-the-chained-test-cases"></a><span data-ttu-id="8cb91-594">Ķēdē savienoto testa gadījumu palaišana</span><span class="sxs-lookup"><span data-stu-id="8cb91-594">Run the chained test cases</span></span>

1. <span data-ttu-id="8cb91-595">Atlasiet abus testa gadījumus un pēc tam atlasiet **Palaist**.</span><span class="sxs-lookup"><span data-stu-id="8cb91-595">Select both the test cases, and then select **Run**.</span></span>
2. <span data-ttu-id="8cb91-596">Pārbaudiet, vai abi testa gadījumi ir sekmīgi.</span><span class="sxs-lookup"><span data-stu-id="8cb91-596">Verify that both test cases have passed.</span></span>
