...
##### [Dokumenta vai apmācības izveide](../dev-itpro/user-interface/task-recorder-training-docs.md)
...
### [Standarta izmaksas](../supply-chain/cost-management/prerequisites-standard-costs.md)
...
### [Iepriekš noteiktās izmaksas](../supply-chain/cost-management/costing-versions.md)
...
### [Krājumu uzskaite](../supply-chain/cost-management/fifo-physical-value-marking.md)
...
#### [Fiziskās vērtības iekļaušana](../supply-chain/cost-management/include-physical-value.md)
...
### [Ražošanas uzskaite](../supply-chain/cost-management/production-order-cost-analysis.md)
...
##### [Negatīvu debetu/kredītu iestatīšana](../financials/localizations/apac-chn-negative-debits-credits.md)
...
##### [Uzskaites un summēšanas aprēķinu konfigurēšana elektronisko pārskatu veidošanai](../dev-itpro/analytics/tasks/er-format-counting-summing-2.md)
...
#### [Elektronisko dokumentu ģenerēšana un programmu datu atjaunināšana, izmantojot elektronisko pārskatu veidošanas rīku](../dev-itpro/analytics/generate-electronic-documents-update-application-data.md)
...
##### [Operāciju resursa izveide (uzdevuma ceļvedis)](../supply-chain/production-control/tasks/create-operations-resource.md)
...
###### [Ziņošana par ražošanas pasūtījuma pabeigšanu (uzdevuma ceļvedis)](../supply-chain/production-control/tasks/report-production-order-finished.md)
...
##### [Ziņošana par pabeigšanu vietā, kas atkarīga no noliktavas vienības (uzdevuma ceļvedis)](../supply-chain/production-control/tasks/report-finished-non-license-plate-controlled-location-2016-11.md)
...
##### [LEAN plānošanas grupu definēšana (uzdevuma ceļvedis)](../supply-chain/production-control/tasks/define-lean-schedule-groups.md)
...
##### [Ieturēšanas Kanban nosacījumu izveide (uzdevuma ceļvedis)](../supply-chain/production-control/tasks/create-withdrawal-kanban-rule.md)
...
##### [Partijas pasūtījuma dzīves cikls no izveides līdz sākšanai (uzdevuma ceļvedis)](../supply-chain/production-control/tasks/batch-order-lifecycle-start.md)
...
#### [Izlaistas preces izveide vienam uzņēmumam (uzdevuma ceļvedis)](../supply-chain/pim/tasks/create-released-product-single-company.md)
#### [Preces dzīves cikla stāvoklis](../supply-chain/pim/product-lifecycle.md)
##### [Jauna preces dzīves cikla stāvokļa izveide (uzdevuma ceļvedis)](../supply-chain/pim/tasks/new-product-lifecycle-state.md)
##### [Noklusējuma preces dzīves cikla stāvokļa izveide (uzdevuma ceļvedis)](../supply-chain/pim/tasks/default-product-lifecycle-state.md)
##### [Preces dzīves cikla stāvokļa piešķiršana izlaistas preces šablonam (uzdevuma ceļvedis)](../supply-chain/pim/tasks/product-lifecycle-state-released-product-master.md)
##### [Preces dzīves cikla stāvokļa piešķiršana izlaistai precei (uzdevuma ceļvedis)](../supply-chain/pim/tasks/product-lifecycle-state-released-product.md)
##### [Novecojušo preces variantu atrašana (uzdevuma ceļvedis)](../supply-chain/pim/tasks/obsolete-product-variants.md)
##### [Preču izslēgšana no vispārējās plānošanas (uzdevuma ceļvedis)](../supply-chain/pim/tasks/exclude-products-master-planning.md)
