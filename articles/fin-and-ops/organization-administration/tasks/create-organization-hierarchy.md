...
## <a name="create-a-hierarchy"></a>Izveidot hierarhiju
...
5. Sarakstā atrodiet un atlasiet vajadzīgo ierakstu.
    * Atlasiet nolūku, kas tiks piešķirts jūsu organizācijas hierarhijai.  
6. Noklikšķiniet uz Pievienot.
7. Sarakstā atzīmējiet atlasīto rindu.
    * Atrodiet tikko izveidoto hierarhiju.  
8. Noklikšķiniet uz OK.

## <a name="add-organizations-to-the-hierarchy"></a>Pievienot organizācijas hierarhijai
1. Sarakstā atrodiet un atlasiet vajadzīgo ierakstu.
    * Atlasiet hierarhiju.  
2. Noklikšķiniet uz Skatīt hierarhiju.
    * Nepieciešamības gadījumā pievienojiet papildu organizācijas.  
    * Lai pievienotu organizāciju, noklikšķiniet uz Rediģēt un pēc tam Ievietot, lai pievienotu organizāciju.     Kad esat pabeidzis izmaiņu veikšanu, varat saglabāt melnrakstu un/vai publicēt izmaiņas.  
