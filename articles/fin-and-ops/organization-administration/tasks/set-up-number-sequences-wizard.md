...
3. Atlasiet **Nākamais**.
   ...
   - Šajā lapā varat mainīt identifikācijas kodu, mazāko vērtību un lielāko vērtību. Turklāt varat norādīt, vai numuru secībai jābūt nepārtrauktai.   
   - Neatlasiet opciju **Nepārtraukts**, ja numuri šai numuru sērijai ir jārezervē. Lai pievienotu sfēras segmentu numuru sērijas formātam, sarakstā atlasiet vajadzīgo formātu un pēc tam atlasiet **Iekļaut formātā tvērumu**. Lai noņemtu sfēras segmentu no numuru sērijas formāta, sarakstā atlasiet vajadzīgo formātu un pēc tam atlasiet **Noņemt no formāta tvērumu**. Lai numuru sēriju izslēgtu no automātiskas ģenerēšanas, sarakstā atlasiet numuru sēriju un pēc tam atlasiet **Dzēst**.  
