...
1. <span data-ttu-id="00759-107">Dodieties uz Vispārīgi > Vispārīgi > Sesijas datums un laiks.</span><span class="sxs-lookup"><span data-stu-id="00759-107">Go to Common > Common > Session date and time.</span></span>
2. <span data-ttu-id="00759-108">Laukā Datums ievadiet kādu datumu.</span><span class="sxs-lookup"><span data-stu-id="00759-108">In the Date field, enter a date.</span></span>
3. <span data-ttu-id="00759-109">Noklikšķiniet uz OK.</span><span class="sxs-lookup"><span data-stu-id="00759-109">Click OK.</span></span>
