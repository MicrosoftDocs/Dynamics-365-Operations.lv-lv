...
---
# <a name="deliver-an-employee-benefits-program"></a>Darbinieku atvieglojumu programmas nodrošināšana

[!include [task guide banner](../../includes/task-guide-banner.md)]

Šajā uzdevumā jums tiek parādīts, kā izveidot atvieglojumu elementus, kas tiks izmantoti, veidojot jaunus atvieglojumus. Demonstrācijas datu uzņēmums, kas tiek izmantots, lai izveidotu šo uzdevumu, ir USMF. Šis uzdevums ir paredzēts lietotājiem ar lomu Atlīdzību un atvieglojumu vadītājs.


## <a name="create-benefit-elements"></a>Izveidot atvieglojumu elementus
1. Šis uzdevums sākas no lapas Atvieglojumu saraksts. Sāciet uzdevumu, atverot šo lapu vai meklējot lapu Atvieglojumu saraksts.
2. Klikšķiniet Jauns.
...
11. Laukā Tips noklikšķiniet uz nolaižamā saraksta pogas, lai atvērtu uzmeklēšanu.
12. Sarakstā atrodiet un atlasiet vajadzīgo ierakstu.
13. Sarakstā noklikšķiniet uz saites atlasītajā rindā.
14. Laukā Algas ietekme atlasiet kādu opciju.
15. Noklikšķiniet uz cilnes Opcijas.
16. Klikšķiniet Jauns.
17. Laukā Opcija ierakstiet kādu vērtību.
...
7. Laukā Opcija noklikšķiniet uz nolaižamā saraksta pogas, lai atvērtu uzmeklēšanu.
8. Sarakstā atrodiet un atlasiet vajadzīgo ierakstu.
9. Sarakstā noklikšķiniet uz saites atlasītajā rindā.
10. Laukā Stājas spēkā ievadiet kādu datumu un laiku.
11. Noklikšķiniet Izveidot atvieglojumu.
12. Pārslēdziet sadaļas Algas detalizēta informācija paplašinājumu.
13. Laukā Biežums noklikšķiniet uz nolaižamā saraksta pogas, lai atvērtu uzmeklēšanu.
