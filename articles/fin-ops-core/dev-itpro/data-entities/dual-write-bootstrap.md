...
ms.locfileid: "2769710"
---
# <a name="bootstrap-with-company-data-faq"></a><span data-ttu-id="e72a3-103">Sāknēšana ar uzņēmuma datu BUJ</span><span class="sxs-lookup"><span data-stu-id="e72a3-103">Bootstrap with company data FAQ</span></span>
 
[!include [banner](../includes/banner.md)]

## <a name="why-do-i-need-bootstrapping"></a><span data-ttu-id="e72a3-104">Kāpēc man ir nepieciešama sāknēšana?</span><span class="sxs-lookup"><span data-stu-id="e72a3-104">Why do I need bootstrapping?</span></span> 
<span data-ttu-id="e72a3-105">Iespējams, ka jums ir pašreizēja Common Data Service vai cita Dynamics 365 programmas instance ar uzņēmuma datiem, un jūs vēlaties iespējot duālas rakstīšanas savienojumu attiecībā uz tiem.</span><span class="sxs-lookup"><span data-stu-id="e72a3-105">You might have an existing Common Data Service or other Dynamics 365 app instance with business data, and you want to enable dual-write connection against it.</span></span> <span data-ttu-id="e72a3-106">šajā gadījumā jums jāsāknē Common Data Service vai citi Dynamics 365 programmas dati ar uzņēmuma informāciju, pirms iespējojat duālā ieraksta savienojumu.</span><span class="sxs-lookup"><span data-stu-id="e72a3-106">In this case, you need to bootstrap Common Data Service or other Dynamics 365 app data with company information before enabling dual-write connection.</span></span>  
 
## <a name="when-should-i-use-bootstrapping"></a><span data-ttu-id="e72a3-107">Kad izmantot sāknēšanu?</span><span class="sxs-lookup"><span data-stu-id="e72a3-107">When should I use bootstrapping?</span></span> 
<span data-ttu-id="e72a3-108">Sāknēšana jāizmanto pirms duālās rakstīšanas elementa karšu iespējošanas (5. darbības laikā).</span><span class="sxs-lookup"><span data-stu-id="e72a3-108">You should use bootstrapping before enabling dual-write entity maps (during step #5).</span></span>  
1. <span data-ttu-id="e72a3-109">Lai iestatītu duālās rakstīšanas savienojumu starp jūsu programmas Finance and Operations instancēm un Common Data Service vai citu programmu Dynamics 365, piesakieties programmā Finance and Operations kā administrators.</span><span class="sxs-lookup"><span data-stu-id="e72a3-109">To setup the dual-write connection between instances of your Finance and Operations app and the Common Data Service or other Dynamics 365 app, log in to the Finance and Operations app as an administrator.</span></span> 
2. <span data-ttu-id="e72a3-110">Dodieties uz moduli **Datu pārvaldība** un noklikšķiniet uz pogas **Duālais ieraksts**.</span><span class="sxs-lookup"><span data-stu-id="e72a3-110">Go to the **Data Management** module and click the **Dual-Write** button.</span></span> <span data-ttu-id="e72a3-111">Tas palaiž **Datu integrētāju**.</span><span class="sxs-lookup"><span data-stu-id="e72a3-111">This launches the **Data Integrator**.</span></span> 
3. <span data-ttu-id="e72a3-112">Izveidojiet duālā ieraksta savienojumu vienam vai vairākiem uzņēmumiem.</span><span class="sxs-lookup"><span data-stu-id="e72a3-112">Create the dual-write connection for one or more companies.</span></span>  
    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="e72a3-113">![Izveidot duālā ieraksta savienojumu](media/dual-write-boot-1.png)</span><span class="sxs-lookup"><span data-stu-id="e72a3-113">![Create dual-write connection](media/dual-write-boot-1.png)</span></span>
4. <span data-ttu-id="e72a3-114">Iespējojiet **Cdm_companies** elementa karti.</span><span class="sxs-lookup"><span data-stu-id="e72a3-114">Enable the **Cdm_companies** entity map.</span></span> <span data-ttu-id="e72a3-115">Tas sinhronizē uzņēmumus no programmas Finance and Operations ar Common Data Service.</span><span class="sxs-lookup"><span data-stu-id="e72a3-115">This synchronizes companies from the Finance and Operations app to Common Data Service.</span></span>  
    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="e72a3-116">![Iespējot elementa karti](media/dual-write-boot-2.png)</span><span class="sxs-lookup"><span data-stu-id="e72a3-116">![Enable the entity map](media/dual-write-boot-2.png)</span></span>
5. <span data-ttu-id="e72a3-117">Palaidiet parauga sāknēšanas kodu Common Data Service vai citā Dynamics 365 programmas instancē.</span><span class="sxs-lookup"><span data-stu-id="e72a3-117">Run the sample bootstrapping code on the Common Data Service or other Dynamics 365 app instance.</span></span>  
6. <span data-ttu-id="e72a3-118">Kad sāknēšana ir paveikta un sistēma ir gatava tiešsaistes sinhronizācijai, iespējojiet elementa kartes.</span><span class="sxs-lookup"><span data-stu-id="e72a3-118">When the bootstrapping is done and the system is ready for the live sync, enable the entity maps.</span></span>  

    <span data-ttu-id="e72a3-119">Elementa karšu iespējošana aktivizē sākotnējo datu sinhronizāciju iespējotajām elementa kartēm.</span><span class="sxs-lookup"><span data-stu-id="e72a3-119">Enabling the entity maps triggers the initial data sync for the enabled entity maps.</span></span> <span data-ttu-id="e72a3-120">Dati, kas atbilst uzņēmumiem, kuri izvēlēti duālā ieraksta savienojumā, tiek sinhronizēti starp programmu Finance and Operations un Common Data Service.</span><span class="sxs-lookup"><span data-stu-id="e72a3-120">The data corresponding to the companies chosen on the dual-write connection is synchronized between the Finance and Operations app and Common Data Service.</span></span> 
 
## <a name="how-to-i-use-the-code-sample"></a><span data-ttu-id="e72a3-121">Kā izmantot koda paraugu?</span><span class="sxs-lookup"><span data-stu-id="e72a3-121">How to I use the code sample?</span></span>
<span data-ttu-id="e72a3-122">Parauga kods ir C# programma, ko var ielādēt Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="e72a3-122">The sample code is a C# application that you can load in Visual Studio.</span></span> <span data-ttu-id="e72a3-123">Tas paņem NuGet pakotnes atkarības no Common Data Service SDK, ko varat atjaunot, izmantojot standarta Visual Studio rīkus.</span><span class="sxs-lookup"><span data-stu-id="e72a3-123">It takes NuGet package dependencies on the Common Data Service SDK, that you can refresh through standard Visual Studio tooling.</span></span> 

<span data-ttu-id="e72a3-124">Pēc atspiešanas un risinājuma atvēršanas programmā Visual Studio un NuGet pakotņu atjaunošanas, meklējiet kodā **TODO**.</span><span class="sxs-lookup"><span data-stu-id="e72a3-124">After unzipping and opening the solution in Visual Studio and restoring the NuGet packages, search for **TODO** in the code.</span></span> <span data-ttu-id="e72a3-125">Katrs lēmumu, kas jums ir jāpieņem par to, kā vēlaties sāknēt uzņēmuma informāciju, atzīmē **TODO** ar parauga kodu kanoniskai ieviešanai.</span><span class="sxs-lookup"><span data-stu-id="e72a3-125">Each decision you need to make about how you want to bootstrap company information is noted by a **TODO**, with sample code for a canonical implementation.</span></span> 

<span data-ttu-id="e72a3-126">Parauga kods parāda tikai vienu no daudzajiem veidiem, kā var kategorizēt elementa ierakstus pēc uzņēmuma.</span><span class="sxs-lookup"><span data-stu-id="e72a3-126">The sample code shows only one of many ways you might categorize entity records by company.</span></span> <span data-ttu-id="e72a3-127">Mainot loģiku **TODO** sadaļās, varat izveidot pielāgotu kategorizēšanu.</span><span class="sxs-lookup"><span data-stu-id="e72a3-127">By changing the logic in the **TODO** sections, you can create your custom categorization.</span></span> 
 
## <a name="what-should-i-expect"></a><span data-ttu-id="e72a3-128">Ko sagaidīt?</span><span class="sxs-lookup"><span data-stu-id="e72a3-128">What should I expect?</span></span>
<span data-ttu-id="e72a3-129">Pēc noklusējuma parauga programma ļauj norādīt biznesa vienības un uzņēmuma koda kartējumu vārdnīcu.</span><span class="sxs-lookup"><span data-stu-id="e72a3-129">By default, the sample application lets you provide a dictionary of business unit-to-company code mappings.</span></span> <span data-ttu-id="e72a3-130">Jebkurš elements, ko sāknējat ar lauku **OwningBusinessUnit**, tiek automātiski iestatīts, lai izmantotu norādīto uzņēmumu.</span><span class="sxs-lookup"><span data-stu-id="e72a3-130">Any entity you bootstrap with an **OwningBusinessUnit** field is automatically set to use the specified company.</span></span> <span data-ttu-id="e72a3-131">Jebkurš elements bez lauka **OwningBusinessUnit**, piemēram, prece, tiks iestatīts uzņēmumam, pamatojoties uz kartēšanu ar tukšu biznesa vienības vērtību.</span><span class="sxs-lookup"><span data-stu-id="e72a3-131">Any entity without an **OwningBusinessUnit** field, such as product, will set the company based on the mapping with an empty business unit value.</span></span>

<span data-ttu-id="e72a3-132">Konsoles programmai ir paredzēts viens parametrs — **–simulēt** vai **– lietot**.</span><span class="sxs-lookup"><span data-stu-id="e72a3-132">The console application expects one parameter, either **–simulate** or **–apply**.</span></span> <span data-ttu-id="e72a3-133">Ja izmantojat komandrindas parametru **-simulēt**, tad dati netiek atjaunināti.</span><span class="sxs-lookup"><span data-stu-id="e72a3-133">If you use the **–simulate** command line parameter, then no data is updated.</span></span> <span data-ttu-id="e72a3-134">Tiek ģenerēti tikai **simulation_<entityname>.csv** faili tajā pašā direktorijā kur rīks — viens katram elementam, kas būtu ticis atjaunināts.</span><span class="sxs-lookup"><span data-stu-id="e72a3-134">Only **simulation_<entityname>.csv** files are generated in the same directory as the tool, one for each entity that would have been updated.</span></span> <span data-ttu-id="e72a3-135">Strādājot varat iteratīvi pārskatīt šos failus, lai nodrošinātu, ka kods atjaunina uzņēmuma vērtības, kā paredzēts.</span><span class="sxs-lookup"><span data-stu-id="e72a3-135">You can iteratively review these files while working to ensure the code updates company values as expected.</span></span> 

<span data-ttu-id="e72a3-136">Kad pabeidzat darbu ar simulētajiem atjauninājumiem, pēc tam izmantojiet parametru **–lietot**.</span><span class="sxs-lookup"><span data-stu-id="e72a3-136">When you finish with the simulated updates, then use the **–apply** parameter.</span></span> <span data-ttu-id="e72a3-137">Tas atjaunina visus ierakstus, kuriem pašlaik ir nepareiza uzņēmuma vērtība, vienlaikus 1000 ierakstu partijās (pēc noklusējuma).</span><span class="sxs-lookup"><span data-stu-id="e72a3-137">This updates all records that currently have an incorrect company value, in batches of 1000 records at a time (by default).</span></span> <span data-ttu-id="e72a3-138">Kods ir idempotents kā norādīts, un tas nozīmē, ka to var atkārtoti palaist, un tiks atjaunināti tikai nepareizi piešķirtie uzņēmumi.</span><span class="sxs-lookup"><span data-stu-id="e72a3-138">The code is idempotent as provided, meaning you can re-run it and only the incorrectly assigned companies will be updated.</span></span> <span data-ttu-id="e72a3-139">Palaižot ar **–lietot**, koda izvade ir veikto izmaiņu CSV faili, kuru nosaukums ir **applied_<entityname>.csv**.</span><span class="sxs-lookup"><span data-stu-id="e72a3-139">When running with **–apply**, the code outputs CSV files of the changes made, which are named **applied_<entityname>.csv**.</span></span> 
