...
Šajā tēmā ir aprakstīta vietas un noliktavas datu integrācija starp programmām Finance and Operations un Common Data Service. Darbības vietas un noliktavas ir bieži lietotie jēdzieni Supply Chain Management programmā. Tie ir izmantoti, lai izveidotu jūsu uzņēmuma piegādes ķēdes modeli.

## <a name="templates"></a>Veidnes

Pateicoties integrācijai ar programmu Common Data Service šie jēdzieni un ar tiem saistītā informācija ir pieejami programmā Common Data Service, izmantojot vietu un noliktavas datu elementus tālāk redzamajā tabulā.

Finance and Operations programmas | Citas Dynamics 365 programmas
--------------------------|---------------------------------
Atrašanās vietas                     | msdyn_operationalsites
Noliktavas                | noliktavas

[!include [banner](../includes/dual-write-symbols.md)]

## <a name="operational-sites"></a>Darbības vietas

Darbības vietas ir pieejamas programmā Common Data Service, izmantojot šādus kartējumus.
...
## <a name="warehouses"></a>Noliktavas

Noliktavas ir pieejamas, izmantojot šādus kartējumus.
