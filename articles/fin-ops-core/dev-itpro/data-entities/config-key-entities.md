...
description: Šajā rakstā ir aprakstītas attiecības starp konfigurācijas atslēgām un datu elementiem.
author: peakerbl
ms.date: 05/10/2019
ms.topic: article
ms.prod: ''
...
Lai uzzinātu vairāk par konfigurācijas atslēgām, skatiet rakstu [Pārskats par licenču kodiem un konfigurācijas atslēgām](../sysadmin/license-codes-configuration-keys-report.md).
