...
## <a name="why-do-i-need-bootstrapping"></a>Kāpēc man ir nepieciešama sāknēšana? 
Iespējams, ka jums ir pašreizēja Dataverse vai cita Dynamics 365 programmas instance ar uzņēmuma datiem, un jūs vēlaties iespējot duālas rakstīšanas savienojumu attiecībā uz tiem. šajā gadījumā jums jāsāknē Dataverse vai citi Dynamics 365 programmas dati ar uzņēmuma informāciju, pirms iespējojat duālā ieraksta savienojumu.  
 
## <a name="when-should-i-use-bootstrapping"></a>Kad izmantot sāknēšanu? 
Sāknēšana jāizmanto pirms duālās rakstīšanas tabulas karšu iespējošanas (5. darbības laikā).  
1. Lai iestatītu duālās rakstīšanas savienojumu starp jūsu programmas Finance and Operations instancēm un Dataverse vai citu programmu Dynamics 365, piesakieties programmā Finance and Operations kā administrators. 
2. Dodieties uz moduli **Datu pārvaldība** un noklikšķiniet uz pogas **Duālais ieraksts**. Tas palaiž **Datu integrētāju**. 
3. Izveidojiet duālā ieraksta savienojumu vienam vai vairākiem uzņēmumiem.  
    > [!div class="mx-imgBorder"]
    > ![Izveidot duālā ieraksta savienojumu](media/dual-write-boot-1.png)
4. Iespējojiet **Cdm_companies** tabulas karti. Tas sinhronizē uzņēmumus no Finance and Operations lietojumprogrammas uz Dataverse.  
    > [!div class="mx-imgBorder"]
    > ![Tabulas kartes iespējošanai](media/dual-write-boot-2.png)
5. Palaidiet parauga sāknēšanas kodu Dataverse vai citā Dynamics 365 programmas instancē.  
6. Kad sāknēšana ir paveikta un sistēma ir gatava tiešsaistes sinhronizācijai, iespējojiet tabulas kartes.  

    Tabulas karšu iespējošana aktivizē sākotnējo datu sinhronizāciju iespējotajām tabulas kartēm. Dati, kas atbilst uzņēmumiem, kuri izvēlēti duālā ieraksta savienojumā, tiek sinhronizēti starp programmu Finance and Operations un Dataverse. 
 
## <a name="how-to-i-use-the-code-sample"></a>Kā izmantot koda paraugu?
Parauga kods ir C# programma, ko var ielādēt Visual Studio. Tas paņem NuGet pakotnes atkarības no Dataverse SDK, ko varat atjaunot, izmantojot standarta Visual Studio rīkus. 

Pēc atspiešanas un risinājuma atvēršanas programmā Visual Studio un NuGet pakotņu atjaunošanas, meklējiet kodā **TODO**. Katrs lēmumu, kas jums ir jāpieņem par to, kā vēlaties sāknēt uzņēmuma informāciju, atzīmē **TODO** ar parauga kodu kanoniskai ieviešanai. 

Parauga kods parāda tikai vienu no daudzajiem veidiem, kā var kategorizēt elementa rindā pēc uzņēmuma. Mainot loģiku **TODO** sadaļās, varat izveidot pielāgotu kategorizēšanu. 
...
Kad pabeidzat darbu ar simulētajiem atjauninājumiem, pēc tam izmantojiet parametru **–lietot**. Tas atjaunina visas rindas, kam pašlaik ir nepareiza uzņēmuma vērtība, vienlaikus 1000 rindu partijās (pēc noklusējuma). Kods ir idempotents kā norādīts, un tas nozīmē, ka to var atkārtoti palaist, un tiks atjaunināti tikai nepareizi piešķirtie uzņēmumi. Palaižot ar **–lietot**, koda izvade ir veikto izmaiņu CSV faili, kuru nosaukums ir **applied_<entityname>.csv**. 
