...
Iespējams, ka jums ir pašreizēja Common Data Service vai cita Dynamics 365 programmas instance ar uzņēmuma datiem, un jūs vēlaties iespējot duālas rakstīšanas savienojumu attiecībā uz tiem. šajā gadījumā jums jāsāknē Common Data Service vai citi Dynamics 365 programmas dati ar uzņēmuma informāciju, pirms iespējojat duālā ieraksta savienojumu.  
 
## <a name="when-should-i-use-bootstrapping"></a>Kad izmantot sāknēšanu? 
Sāknēšana jāizmanto pirms duālās rakstīšanas elementa karšu iespējošanas (5. darbības laikā).  
1. Lai iestatītu duālās rakstīšanas savienojumu starp jūsu programmas Finance and Operations instancēm un Common Data Service vai citu programmu Dynamics 365, piesakieties programmā Finance and Operations kā administrators. 
...
4. Iespējojiet **Cdm_companies** elementa karti. Tas sinhronizē uzņēmumus no Finance and Operations lietojumprogrammas uz Common Data Service.  
    > [!div class="mx-imgBorder"]
    > ![Iespējot elementa karti](media/dual-write-boot-2.png)
5. Palaidiet parauga sāknēšanas kodu Common Data Service vai citā Dynamics 365 programmas instancē.  
6. Kad sāknēšana ir paveikta un sistēma ir gatava tiešsaistes sinhronizācijai, iespējojiet elementa kartes.  

    Elementa karšu iespējošana aktivizē sākotnējo datu sinhronizāciju iespējotajām elementa kartēm. Dati, kas atbilst uzņēmumiem, kuri izvēlēti duālā ieraksta savienojumā, tiek sinhronizēti starp programmu Finance and Operations un Common Data Service. 
 
## <a name="how-to-i-use-the-code-sample"></a>Kā izmantot koda paraugu?
Parauga kods ir C# programma, ko var ielādēt Visual Studio. Tas paņem NuGet pakotnes atkarības no Common Data Service SDK, ko varat atjaunot, izmantojot standarta Visual Studio rīkus. 
