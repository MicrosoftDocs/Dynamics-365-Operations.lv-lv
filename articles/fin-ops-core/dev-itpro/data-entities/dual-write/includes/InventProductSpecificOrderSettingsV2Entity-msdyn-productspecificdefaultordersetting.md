## <a name="product-default-order-settings-v2-to-msdyn_productspecificdefaultordersettings"></a>Preču noklusējuma pasūtījuma iestatījumi V2 uz msdyn_productspecificdefaultordersettings
