...
Šajā tēmā ir aprakstīti līdzekļi, kas ir novecojuši vai noņemti no Microsoft Dynamics Lifecycle Services (LCS).

- *Noņemts* līdzeklis pakalpojumā vairs nav pieejams.
- *Novecojis* līdzeklis netiek aktīvi attīstīts un var tikt noņemts turpmākos atjauninājumos.

Šis saraksts ir izveidots tā, lai jūs, veicot savu plānošanu, varētu ņemt vērā noņemtos un novecojušos līdzekļus.

## <a name="october-2019-announcements"></a>2019. gada oktobra paziņojumi
