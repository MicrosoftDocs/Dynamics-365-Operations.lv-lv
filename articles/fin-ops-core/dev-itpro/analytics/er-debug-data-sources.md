...
Kad jūs [konfigurējat](tasks/er-format-configuration-2016-11.md) Elektronisko pārskatu veidošanas (ER) risinājumu, lai izveidotu izejošos dokumentus, jūs nosakat metodes, kas tiek izmantotas, lai iegūtu datus no programmas un ievadītu tos ģenerētajā izvadē. Lai ER risinājuma dzīves cikla atbalsts būtu efektīvāks, jūsu risinājumam vajadzētu ietvert ER datu modeli un tā kartēšanas komponentus, kā arī ER formātu un tā kartēšanas komponentus, tādējādi modeļa kartēšana ir programmai raksturīga, bet citi komponenti joprojām ir programmas diagnostikā. Tāpēc vairāki ER komponenti var ietekmēt datu ievades procesu ģenerētajā izvadē.
