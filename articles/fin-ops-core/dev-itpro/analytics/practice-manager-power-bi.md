...
description: Šajā rakstā ir aprakstīts, kas ir iekļauts Prakses pārvaldnieka Power BI saturā.
author: kfend
ms.date: 12/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8898992"
---
# <a name="practice-manager-power-bi-content"></a>Power BI satura pakotne Prakses pārvaldnieks

[!include [banner](../includes/banner.md)]

Šajā rakstā ir aprakstīts, kas ir iekļauts Prakses **pārvaldnieka** Microsoft Power BI saturā. Tajā ir paskaidrots, kā piekļūt Power BI pārskatiem, kā arī ir sniegta informācija par satura izstrādei izmantoto datu modeli un elementiem.
