...
description: Šajā rakstā skaidrots, kā izmantot Elektronisko pārskatu rīku, lai ģenerētu biznesa dokumentus, kam ir iegulti attēli un formas.
author: kfend
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
