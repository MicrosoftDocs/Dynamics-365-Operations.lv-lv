...
description: Šajā rakstā ir sniegta informācija par to, kā tiek izmantota funkcija FORMAT Electronic Reporting (ER).
author: kfend
ms.date: 12/12/2019
ms.prod: ''
ms.technology: ''
...
>
> - **Etiķetēm no Microsoft Dynamics 365. finanšu programmas resursiem:** **\@ X**, **kur X** ir iezīmes ID programmas objektu kokā (AOT)
