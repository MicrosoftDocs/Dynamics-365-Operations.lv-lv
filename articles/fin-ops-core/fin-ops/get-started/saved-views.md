...
Ja līdzeklis **Uzlabots juridiskās personas atbalsts saglabātajiem** skatiem ir ieslēgts, skatījuma atlasītājs rāda pieejamos skatus divās sadaļās. Pirmā sadaļa parāda skatījumus, kas ir raksturīgi pašreizējai juridiskajai personai, un otrais parāda skatījumus, kas ir pieejami visām juridiskajām personām. Pirmā sadaļa ir redzama tikai tad, ja ir juridiskās personas specifiskie lapas skati.
...
3. Lai izveidotu jaunu skatu:
    ...
    4. Ja līdzeklis **Uzlabots juridiskās** personas atbalsts saglabātajiem skatiem ir ieslēgts, varat atlasīt, vai vēlaties, lai šis skats būtu pieejams visām juridiskajām personām vai tikai to apakškopai.
    5. Atlasiet **Saglabāt**.
...
> - Ja ir **ieslēgta uzlaboto juridisko personu atbalsta** funkcija saglabātajiem skatiem, katrai juridiskajai personai katrā lapā var būt savs noklusējuma skats.
...
Ja ir **ieslēgta funkcija Uzlabotās** juridiskās personas atbalsts saglabātajiem skatiem, **·**  **dialoglodziņa** Pārvaldīt manus skatus sadaļās pieejamie skati ir redzami sadaļās pieejamie skati. Visi pašreizējai juridiskajai personai specifiskie skatījumi tiek rādīti viņu pašu sadaļā. Vienmēr tiek parādīta sadaļa **Globālie skati**, tādējādi varat pārvaldīt skatījumus, kas ir pieejami lapai visās juridiskajās personām. 
...
3. Atlasiet pogu **Vairāk** un pēc tam atlasiet **Publicēt**.  **Tiks** atvērts publicēšanas dialoglodziņš.
...
5. Ja organizācijas **skatījumu** tulkošanas atbalsta funkcija ir ieslēgta, varat pievienot **tulkojumus**  **jūsu skatījuma nosaukumam tik daudzās valodās, cik nepieciešams jūsu uzņēmumam, atlasot pogu Tulkojumi blakus laukam** Nosaukums. Skatījuma nosaukums tiks parādīts lietotājiem viņu pašreizējā valodā. Varat iestatīt arī noklusēto valodu, lai norādītu tulkojumu, kas tiks rādīts lietotājiem, kuri darbojas valodās, kurām nav definēts neviens tulkojums.
...
6. Nosakiet, vai skats ir jāpublicē atlasītajiem lietotājiem kā noklusējuma skats. Kad skats ir pārveidots par noklusējuma skatu, lietotāji to redzēs nākamreiz, kad tiks atvērta mērķa lapa. Tiks mainīts katra mērķa lietotāja globālais noklusējuma skats. Tomēr lietotāji joprojām var mainīt savu noklusējuma skatu pēc publicēšanas.
    ...
    >    -  ** Ja uzlabotās **juridiskās personas atbalsts saglabātajiem skatiem ir ieslēgts** un jūs publicēsiet šo skatu juridisko personu apakškopai, noklusējuma skats šīm juridiskajām personām tiks mainīts katram mērķētam lietotājam.
    >
    ...
    > - Publicēšana nestrādās lomu piešķirēm, kas veiktas, izmantojot AAD grupas. 
...
10. Pievienojiet juridiskās personas, kurām šis skats ir pieejams. 
    ...
    > - Ja ir **ieslēgta funkcija** Uzlabotās juridiskās personas atbalsts saglabātajiem skatiem, skatījuma atlasītājs būs redzams tikai norādīto juridisko personu skatu.
...
- Ja ir **ieslēgta funkcija** Uzlabotās juridiskās personas atbalsts saglabātajiem skatiem, skatījuma atlasītājs būs redzams tikai norādīto juridisko personu skatu. Šī darbība notiek tāpēc, ka līdzeklis iespējo skatu (tostarp personiskus skatus) saistīt ar noteiktām juridiskām personām.
