...
| Atvērt kontekstizvēlni    | Ctrl+F10                         |
...
| Izvēlēties šodienas datumu                     | T                                         |
| Dzēst atlasīto datumu               | C                                         |
...
| Pārslēgties uz galvenes skatu                               | Ctrl+Shift+H                                 |
...
| Pāriet uz teksta apgabalu/ieziet no tā HTML redaktora vadīklā                          | Alt+bultiņa uz leju/Alt+bultiņa uz augšu |
...
| Pārslēgt pašreizējās vadīklas ietveršanu ciļņu secībā (lietojat izlaišanas rīku)                                   | Atstarpes taustiņš vai Enter                      |
| Izmantot rediģēšanas rīku (atrodoties personalizēšanas režīmā)                                                                       | E                                   |
| Pārslēgt, vai pašreizējā vadīkla ir rediģējama, vai tikai lasāma (lietojat rediģēšanas rīku)                                 | Atstarpes taustiņš vai Enter                      |
| Izmantot kopsavilkuma rīku (atrodoties personalizēšanas režīmā)                                                                    | U                                   |
| Pārslēgt, vai pašreizējā vadīkla pašreizējā kopsavilkuma cilnē ir kopsavilkuma lauks (lietojot kopsavilkuma rīku)            | Atstarpes taustiņš vai Enter                      |
| Izmantot pievienošanas rīku (atrodoties personalizēšanas režīmā)                                                                        | A                                   |
| Atlasīt vadīklu, kuras konteiners tiks izmantots, lai ievietotu jaunus laukus (lietojot pievienošanas rīku)                     | Atstarpes taustiņš vai Enter                      |
| Importēt personalizāciju (atrodoties personalizēšanas režīmā)                                                                | I                                   |
| Eksportēt personalizāciju (atrodoties personalizēšanas režīmā)                                                                | X                                   |
| Notīrīt šīs lapas personalizācijas (atrodoties personalizēšanas režīmā)                                                      | Ctrl+C                              |
| Pārvietot fokusu starp personalizēšanas rīkjoslu un lapu (atrodoties personalizēšanas režīmā)                             | T                                   |
...
- [Pārskatu veidotājā pieejamie īsinājumtaustiņi](../../../finance/general-ledger/financial-reporting-keyboard-shortcuts.md)
