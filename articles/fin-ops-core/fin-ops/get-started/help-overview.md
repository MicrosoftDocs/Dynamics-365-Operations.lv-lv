...
Lai abonētu VISU atjauninājumu, kas veikti Microsoft tehniskās dokumentācijas saturam finanšu un operāciju programmās, izmantojiet šādu saiti:

[RSS plūsma](/api/search/rss?$filter=scopes%2fany(t%3A%20t%20eq%20%27dynamics365-finops%27)&locale=en-us)

> [!NOTE]
> RSS plūsma atgriež 100 jaunāko tēmu sarakstu. Saraksts ir sakārtots pēc datuma, bet to var paiet līdz nedēļai, pirms vis pēdējos atjauninātos rakstus padara tos sarakstā.  
...
Lai varētu piekļūt uzdevumu ceļvežiem no rūts **Palīdzība**, sistēmas administratoram jākonfigurē daži iestatījumi lapā **Sistēmas parametri** Finance, Supply Chain Management vai Commerce. Papildinformāciju skatiet [Uzdevumu ceļvežu pievienošana](help-connect.md#adding-task-guides).
