...
description: Šajā tēmā ir paskaidrots, kā varat lietot elektronisko pārskatu (Electronic reporting — ER) struktūras pamata funkciju, lai automatizētu funkcionalitātes testēšanu programmā Microsoft Dynamics 365 for Finance and Operations, ko darbina ER.
author: NickSelin
manager: AnnBe
ms.date: 07/02/2019
ms.topic: article
...
ms.locfileid: "1726731"
---
# <a name="automate-testing-with-electronic-reporting"></a>Testēšanas ar elektroniskajiem pārskatiem automatizēšana

[!include[banner](../includes/banner.md)]

Šajā tēmā ir paskaidrots, kā varat lietot elektronisko pārskatu (Electronic reporting — ER) struktūru, lai automatizētu dažu funkciju testēšanu programmā Microsoft Dynamics 365 for Finance and Operations. Šīs tēmas piemērā ir parādīts, kā automatizēt kreditoru maksājumu apstrādes testēšanu.

Finance and Operations izmanto ER struktūru, lai izveidotu maksājumu failus un atbilstošos dokumentus kreditoru maksājumu apstrādes laikā. ER struktūra sastāv no datu modeļa, modeļa kartēšanas un formāta komponentiem, kas atbalsta maksājumu apstrādi dažādiem maksājumu veidiem un dokumentu izveidi dažādos formātos. Šos komponentus var lejupielādēt no Microsoft Dynamics Lifecycle Services (LCS) un importēt Finance and Operations instancē.
...
- Izvietojiet Finance and Operations topoloģiju, kas atbalsta testu automatizāciju. Jums ir jābūt piekļuvei šīs topoloģijas Finance and Operations instancei ar lomu **Sistēmas administrators**. Šajā topoloģijā ir jābūt ietvertiem Finance and Operations demonstrācijas datiem, kas tiks izmantoti šajā piemērā. Papildinformāciju skatiet tēmā [Tādu topoloģiju izvietošana, kuras atbalsta pastāvīgu būvēšanu un testu automatizēšanu](../perf-test/continuous-build-test-automation.md).
- Lai automātiski izpildītu piemērotības lietotājam un integrācijas testus, topoloģijā, kuru izmantojat, ir jāinstalē RSAT un atbilstoši jākonfigurē. Informāciju par to, kā instalēt RSAT un konfigurēt to darbam ar Finance and Operations un Azure DevOps, skatiet tēmā [Dynamics 365 for Finance and Operations, Regression Suite Automation Tool](https://www.microsoft.com/download/details.aspx?id=57357). Pievērsiet uzmanību rīka izmantošanas priekšnosacījumiem. Nākamajā attēlā ir parādīts RSAT iestatījumu piemērs. Zilajā taisnstūrī ir redzami parametri, kas norāda piekļuvi Azure DevOps. Zaļajā taisnstūrī ir redzami parametri, kas norāda piekļuvi Finance and Operations instancei.

    ![RSAT iestatījumi](media/GER-Configure.png "RSAT iestatījumu dialoglodziņa ekrānuzņēmums")

- Lai kārtotu testa gadījumus komplektos veiksmīgai pareizas izpildes secības nodrošināšanai un lai varētu apkopot testu izpildes žurnālus turpmākai pārskatu sniegšanai un izmeklēšanai, jums ir nepieciešama piekļuve pakalpojumam Azure DevOps no izvietotās Finance and Operations topoloģijas.
...
1. Atveriet Finance and Operations noklusējuma informācijas paneli.
...
Ievērojiet, ka testa gadījumi tiek automātiski izpildīti programmā Finance and Operations, izmantojot tīmekļa pārlūkprogrammu.
...
1. Atveriet Finance and Operations tīmekļa pārlūkprogrammā.
2. Dodieties uz **Kreditori \> Maksājumi \> Maksājumu žurnāls**.
3. Atlasiet **Rindas**.
4. Atlasiet maksājuma rindu un pēc tam atlasiet **Maksājuma statuss \> Nav**.
5. Laukā **Debets** mainiet vērtību no **1000,00** uz **2000,00**.
6. Atlasiet **Saglabāt**, lai saglabātu izmaiņas.
