...
Lai izmantotu Biznesa dokumentu pārvaldību veidņu rediģēšanai Excel vai Word formātos, izmantojot Microsoft Office datora lietojumprogrammas, jums ir jābūt instalētai programmai Microsoft Office 2010 vai jaunākajai versijai. Tas ir atbalstīts programmas Finance and Operations mākoņa vai lokālajā izvietojumā.
...
# <a name="example-enable-configure-and-use-business-document-management"></a>Piemērs: Biznesa dokumentu pārvaldības iespējošana, konfigurēšana un izmantošana
...
Tā kā Biznesa dokumentu pārvaldība ir izveidota, balstoties uz ER struktūru, jums ir jākonfigurē ER parametri, lai sāktu darbu ar Biznesa dokumentu pārvaldību. Lai to paveiktu, ir nepieciešams iestatīt ER parametrus, kā aprakstīts rakstā [ER struktūras konfigurēšana](electronic-reporting-er-configure-parameters.md). Ir nepieciešams pievienot jaunu konfigurācijas sniedzēju, kā aprakstīts rakstā [Konfigurācijas sniedzēju izveide un to atzīmēšana par aktīviem](tasks/er-configuration-provider-mark-it-active-2016-11.md).

![ER darbvieta](./media/BDM-Overview-ERSetting.png)

## <a name="import-er-solutions"></a>ER risinājumu importēšana

Ir nepieciešams importēt ER konfigurācijas, kas ietver biznesa dokumentu veidnes, uz programmas Finance and Operations pašreizējo instanci. Lejupielādējiet un lokāli saglabājiet tālāk norādītos failus šīs procedūras pabeigšanai.
...
1. Pierakstieties programmā Finance and Operations kā lietotājs ar piekļuvi lapai **Biznesa dokumentu parametri**.
...
Pēc noklusējuma, ja Biznesa dokumentu pārvaldības atļaujas nav iespējotas, katrs lietotājs, kuram ir piekļuve Biznesa dokumentu pārvaldības darbvietai, redzēs visas ER risinājuma veidnes, kas pieejamas programmā Finance and Operations. Biznesa dokumentu pārvaldības darbvietā būs parādīti tikai tās veidnes, kuras atrodamas ER formāta konfigurācijās un kuras atzīmētas kā **Biznesa dokumentu tips**.
...
1. Pierakstieties programmā Finance and Operations kā lietotājs ar piekļuvi Biznesa dokumentu pārvaldības darbvietai.
...
1. Biznesa dokumentu pārvaldības darbvietā no saraksta atlasiet veidni **Klientu FTI pārskats (GER)**.
2. Atlasiet cilni **Detalizēti**.

![Biznesa dokumentu pārvaldības darbvietas lapa](./media/BDM-Overview-EditingTemplate3.png)

Atlasītajai veidnei ir pieejama opcija **Jauns dokuments**. Šī opcija vienmēr ir pieejama veidnei ER formāta konfigurācijā, kas pieder citam nodrošinātājam (šajā piemērā **“Microsoft”**). Atlasot opciju **Jauns dokuments**, rediģēšanai būs pieejama jauna veidne. Rediģētā veidne būs saglabāta jaunā ER formāta konfigurācijā, kas ģenerēta automātiski.

### <a name="start-editing-a-template"></a>Sāciet veidnes rediģēšanu

1. Atlasītajā veidnē atlasiet **Jauns dokuments**.
...
4. Laukā **Komentārs** nomainiet piezīmi nosaukumu rediģējamās veidnes automātiski izveidotajai pārskatīšanai.
...
Tiks atvērta lapa **BDM veidņu redaktors** programmā Finance and Operations. Atlasītā veidne būs pieejama rediģēšanai tiešsaistē, izmantojot programmu Office 365.
...
1. Programmā Finance and Operations izmainiet uz uzņēmumu **“USMF”**.
...
2. Izvēloties **Labi** publicēšanas apstiprināšanai, atvasinātā ER formāta **Customer FTI report (GER) Copy** melnraksta versija, kas satur modificēto veidni, tiks atzīmēta kā pabeigta. Modificētā veidne kļūst pieejama citiem programmas Finance and Operations lietotājiem. ER formāta pabeigtās versijas saglabās tikai jūsu veidnes pēdējo aktīvo pārskatīšanu. Citas pārskatīšanas tiks dzēstas. Atlasiet **Atcelt** citu opciju izpētei.

## <a name="frequently-asked-questions"></a>Bieži uzdotie jautājumi

#### <a name="i-selected-new-document-but-instead-of-opening-the-bdm-template-editor-page-in-finance-and-operations-i-have-been-sent-to-the-office-365-web-page"></a>Esmu izvēlējies **Jauns dokuments**, bet lapa**BDM veidnes redaktors** programmā Finance and Operations netika atvērta un tiku novirzīts uz Office 365 tīmekļa lapu.
Problēma par Office 365 novirzīšanu atpakaļ uz programmu Finance and Operations ir zināma. Tā notiek, pirmo reizi pierakstoties programmā Office 365. Lai atrisinātu šo problēmu, savā pārlūkprogrammā atlasiet pogu **Atpakaļ**, lai atgrieztos atpakaļ pie programmas Finance and Operations.
...
Visticamāk esat pierakstījies Azure AD domēna programmas Finance and Operations pašreizējā instancē, kas atšķiras no Azure AD domēna, kas ticis izmantots šīs programmas Finance and Operations instances izvietošanai. Tā kā pakalpojums SharePoint, kas tiek izmantots veidņu glabāšanai, lai padarītu tās pieejamas rediģēšanai, izmantojot datora lietojumprogrammas Office, pieder pie tā paša domēna kā programma Finance and Operations, mums nav atļauju piekļūt pakalpojumam SharePoint. Lai atrisinātu šo problēmu, pierakstieties programmas Finance and Operations pašreizējai instancei, izmantojot lietotāja ar pareizu Azure AD domēnu akreditācijas datus.
...
[Elektronisko atskaišu konfigurēšana, lai nogādātu datus uz Power BI](general-electronic-reporting-report-configuration-get-data-powerbi.md)
