...
---
# <a name="create-format-to-use-document-management-files-in-format-outputs"></a>Formāta izveide, lai dokumentu pārvaldības failus lietotu formāta izvades datos
