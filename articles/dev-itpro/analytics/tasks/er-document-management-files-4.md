...
---
# <a name="run-format-to-use-document-management-files-in-format-outputs"></a>Formāta darbināšana, lai dokumentu pārvaldības failus lietotu formāta izvades datos 
