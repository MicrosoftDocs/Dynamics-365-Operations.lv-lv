...
---
# <a name="run-electronic-reporting-er-formats-to-do-counting-and-summing"></a>Elektronisko pārskatu veidošanas (ER) formātu izpilde uzskaites un summēšanas darbībām
