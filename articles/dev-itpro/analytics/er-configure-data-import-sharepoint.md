...
- Piekļūstiet Microsoft SharePoint Server instancei, kas ir konfigurēta lietošanai kopā ar programmu Finance and Operations.
...
Noskatieties uzdevumu ceļvežus **ER: datu importēšana no Microsoft Excel faila**, kas ir ietverti biznesa procesā **7.5.4.3. IT pakalpojumu/risinājumu komponentu iegāde/izstrāde (10677)**. Šajos uzdevumu ceļvežos ir detalizēti aprakstīta ER konfigurāciju izstrāde un izmantošana, lai interaktīvā veidā importētu kreditoru transakcijas no Microsoft Excel failiem. Papildinformāciju skatiet rakstā [Ienākošo dokumentu parsēšana programmā Microsoft Excel](parse-incoming-documents-excel.md). Pēc tam, kad būsiet noskatījies uzdevumu ceļvežus, jums būs tālāk norādītie iestatījumi.
...
2. Programmas Finance and Operations lapā **Failu stāvokļi avotiem** atlasiet **Atsvaidzināt**, lai šo lapu atsvaidzinātu. Ņemiet vērā, ka pakalpojumā SharePoint augšupielādētajam Excel failam šajā lapā tiek rādīts statuss **Gatavs**. Pašlaik tiek atbalstīti tālāk norādītie statusi.
