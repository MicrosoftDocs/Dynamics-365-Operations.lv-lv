...
# <a name="add-new-location-roles-and-party-relationship-types"></a>Jaunu atrašanās vietu lomu un pušu attiecību tipu pievienošana 

## <a name="add-new-location-roles"></a>Jaunu atrašanās vietu lomu pievienošana
...
## <a name="add-new-party-relationship-types"></a>Jaunu pušu attiecību tipu pievienošana 
