...
4.  Katrai bankas konta pārskatā iekļautai transakcijai, atlasiet izvēles rūtiņu **Dzēsts**, ja summa programmā Microsoft Dynamics 365 for Finance and Operations atbilst summai bankas konta pārskatā. Varat arī ievadīt vai mainīt vērtību laukā **Bankas transakcijas veids**. Šī lauka vērtība ir svarīga jūsu bankas konta statistikai un dažiem pārskatiem.
...
6.  Izveidojiet darbības ierakstiem (piemēram, komisijas un procenti), kas ir iekļauti bankas konta pārskatā, bet nav ierakstīti sistēmā Finance and Operations. Ievadiet **Bankas transakcijas veidu** un atbilstīgās finanšu dimensijas.
