...
ms.locfileid: "1865810"
---
# <a name="financial-consolidations-and-currency-translation-overview"></a>Pārskats par finanšu konsolidācijām un valūtas konvertāciju
...
> [!NOTE]
> Termins *juridiska persona* tiek izmantots programmā Finance and Operations, un termins *uzņēmums* tiek izmantots finanšu pārskatu sniegšanā. Šajā tēmā tiek izmantoti abi minētie termini. Tomēr šīs tēmas ietvaros to nozīmes ir vienādas.
...
Programmā Finance and Operations konsolidācijas apstrādei tiek izmantota atsevišķa juridiska persona. Tas iespējo vienas instances konsolidāciju, bet nodrošina opciju papildināt datus no citiem avotiem. Konsolidācijas process ir jāveic katru reizi, kad izcelsmes juridiskajām personām tiek veiktas izmaiņas.
...
![Organizatoriskā struktūra](./media/organizational-structure.png "Organizatoriskā struktūra")
...
![Juridiska persona, kas tiek izmantota gan konsolidēšanai, gan eliminācijai](./media/sep-elimination-company.png "Juridiska persona, kas tiek izmantota gan konsolidēšanai, gan eliminācijai")
...
![Kartēšanas lapā Papildu konsolidācijas konti](./media/additional-consolidation-accounts.png "Kartēšanas lapā Papildu konsolidācijas konti")

## <a name="consolidating-online"></a>Konsolidācija tiešsaistē
Lai uzzinātu, kā ievadīt datus konsolidācijai tiešsaistē, skatiet sadaļu [Konsolidēt tiešsaistē](./consolidate-online.md).
...
- Konsolidācijas transakciju sarakstā lapā**Konsolidācijas** skatiet bilances, kas tiek izveidotas pēc datuma katram izcelsmes uzņēmumam par katru periodu.
    ...
    ![Konsolidācijas transakcijas lapā Konsolidācijas](./media/managing-consolidation-transactions.png "Konsolidācijas transakcijas lapā Konsolidācijas")
...
![Eliminācijas kārtulas pamatīpašības](./media/ledger-elimination-rule-journal.png "Eliminācijas kārtulas pamatīpašības")
...
![Virsgrāmatas eliminācijas kārtulas rindas lapa](./media/ledger-elimination-rule-line.png "Virsgrāmatas eliminācijas kārtulas rindas lapa")
...
- **Datu dziļums** — var izveidot konsolidētus pārskatus, kas apvieno faktiskos un budžeta datus gan konta līmenī, gan dimensiju līmenī. Programmā Finance and Operations šie dati ietver datus gan no budžeta kontroles, gan no budžeta plānošanas.
...
- **Racionalizēta valūtas pārrēķināšana** — pēc minimālā uzstādījuma programmā Finance and Operations jebkuru funkcijas Finanšu pārskatu veidošana pārskatu var pārrēķināt uzstādītajā pārskata valūtā. Turklāt jūs varat iestatīt neierobežotu pārskata valūtu skaitu.
