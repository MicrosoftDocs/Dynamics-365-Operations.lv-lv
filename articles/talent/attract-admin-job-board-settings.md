...
---
# <a name="enable-broadbean-integration"></a>Iespējot Broadbean integrāciju
...
3. Sazinieties ar Broadbean un ievadiet informāciju laukā **Lietotājvārds**, **Klienta ID**, un **Šifrēšanas pilnvara**.
