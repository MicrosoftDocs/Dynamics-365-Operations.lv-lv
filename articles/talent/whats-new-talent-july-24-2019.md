...
### <a name="pdf-renderer-for-candidate-documents"></a>Kandidātu dokumentu PDF atveidotājs

Attract lietotāji tagad var skatīt kandidātu PDF pielikumus dokumentu skatītājā tā vietā, lai pielikumus lejupielādētu.

### <a name="signing-up-for-attract-user-research-group"></a>Pieteikšanās Attract lietotāju izpētes grupai 

Tā kā mēs plānojam jaunas produktu iespējas vai priekšskatījuma līdzekļu pārvietošanu, mēs meklējam mūsu lietotājus, kas palīdzētu ar informāciju attiecībā uz mūsu virzienu. Ieinteresētie lietotāji tagad var pieteikties kā daļa no mūsu lietotāju izpētes grupas, izmantojot pierakstīšanās saiti mūsu programmā.
...
Ar šo laidienu **Darba kalendārs** un **Darba kalendāra** diena tagad atbalsta pielāgotos laukus Common Data Service.
