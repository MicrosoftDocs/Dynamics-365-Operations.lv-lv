...
## <a name="leave-and-absence--accrue-time-based-on-hours-worked"></a>Atvaļinājumi un prombūtne — uzkrājuma laiks pēc nostrādātājām stundām
...
## <a name="platform-update-18-for-finance-and-operations"></a>Platformas update 18 for Finance and Operations
...
-   Atjauninājumā Finance and Operations Platform update 18 Talent tīmekļa vietnes klients tagad savieto tās vizuālo informāciju, izmantojot Microsoft Fluent Design.
    ...
    -   Lasīšanas režīmā atvērtu lauku parādīšanas izmaiņas.

    -   Darbvietu un lapu virsraksti ir treknrakstā.

-   Pārlūkošanas rezultātu neaizvietošanas darbība ir uzlabota. Sīkāku informāciju skatiet šeit: [Pārlūkošanas rezultātu neaizvietošanas darbības uzlabojums](https://docs.microsoft.com/business-applications-release-notes/October18/dynamics365-finance-operations/non-replacing-lookups).
