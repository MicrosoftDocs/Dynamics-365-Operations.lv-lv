...
ms.locfileid: "2008224"
---
# <a name="troubleshoot-integration-with-linkedin"></a>Integrācijas ar LinkedIn problēmu novēršana
...
## <a name="you-cant-sign-in-to-linkedin-from-attract"></a>Jūs nevarat pieteikties vietnē LinkedIn no sistēmas Attract

Ja rodas problēmas, pierakstoties vietnē LinkedIn no sistēmas Attract, veiciet tālāk norādītās darbības.

1. Pārbaudiet, vai sistēmā Attract ievadītie LinkedIn akreditācijas dati ir derīgi un pareizi.
2. Ja akreditācijas dati ir derīgi un pareizi, sazinieties ar [LinkedIn atbalsta centru](https://www.linkedin.com/help/linkedin).
3. Ja problēma joprojām pastāv, sazinieties ar [Microsoft atbalsta centru](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Vakanču publikācijas no sistēmas Attract neparādās vietnē LinkedIn
