...
---
# <a name="digital-asset-management-overview"></a>Digitālo līdzekļu pārvaldības pārskats

[!include [banner](includes/banner.md)]

Šajā tēmā sniegts pārskats par digitālo līdzekļu pārvaldību programmas Microsoft Dynamics 365 Commerce vietnes veidotājā.
...
- Attēli
- Video līdzekļi
- Citi bināro līdzekļu veidi, piemēram, Office dokumenti un PDF faili
- Lokalizēti attēli
- Mapju augšupielādes
- Attēlu apgriešana
- Attēlu fokusa punktu pielāgošana
- Daudzkanālu attēlu līdzekļi (prece, preču varianti, katalogs, kategorija, nodarbinātais un klienta attēli)

Digitālie līdzekļi ir specifiski kanālam, izņemot daudzkanālu līdzekļus, kas pēc noklusējuma ir vides līmeņa. 

Digitālie līdzekļi un pārvaldības līdzekļi atrodas vietnes veidotāja sadaļā **Multivides bibliotēka**, kas atrodas vietnes kreisajā navigācijas rūtī.
