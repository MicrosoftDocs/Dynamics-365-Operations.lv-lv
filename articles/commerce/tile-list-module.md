...
1. Dialoglodziņā **Pievienot moduli** atlasiet moduli **Elementu saraksts** un pēc tam atlasiet **Labi**.
...
1. Slotā **Elementu saraksts** atlasiet daudzpunktes pogu (**...**) un pēc tam atlasiet **Pievienot moduli**.
1. Dialoglodziņā **Pievienot moduli** atlasiet moduli **Elementu modulis** un pēc tam atlasiet **Labi**.
