...
description: Šajā rakstā ir apskatīti virsrakstu moduļi un aprakstīts, kā izveidot lapu virsrakstus Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9275790"
---
# <a name="header-module"></a>Galvenes modulis

[!include [banner](includes/banner.md)]

Šajā rakstā ir apskatīti virsrakstu moduļi un aprakstīts, kā izveidot lapu virsrakstus Microsoft Dynamics 365 Commerce.
...
1. Dialoglodziņā Atlasīt **moduļus** atlasiet moduļus Sīkfaila **atļauja**, **Galvene** un **Rādīšanas moduļi** un pēc tam atlasiet **Labi**.
...
1. Virsraksta moduļa **navigācijas** izvēlnes slotā atlasiet daudzpunkti (**...**) un pēc tam atlasiet Pievienot **moduli**.
1. Dialoglodziņā Moduļu **atlase** atlasiet navigācijas izvēlnes **moduli** un pēc tam atlasiet **Labi**.
...
1. Virsraksta moduļa **meklēšanas** slotā atlasiet daudzpunkti (**...**) un pēc tam atlasiet Pievienot **moduli**.
1. Dialoglodziņā Moduļu **atlase** atlasiet meklēšanas moduli **un** pēc tam atlasiet **Labi**.
1. Meklēšanas moduļa rekvizītu rūtī konfigurējiet rekvizītus pēc vajadzības.
1. Virsraksta moduļa **groza** ikonu slotā atlasiet daudzpunkti (**...**) un pēc tam atlasiet Pievienot **moduli**.
1. Dialoglodziņā Moduļu **atlase** atlasiet ikonu moduli **Grozs un** pēc tam atlasiet **Labi**.
