...
1. Dialoglodziņā **Pievienot moduli** atlasiet moduli **Attēlu saraksts** un pēc tam atlasiet **Labi**.
...
1. Dialoglodziņā **Pievienot moduli** atlasiet **Attēlu saraksts** un pēc tam atlasiet **Labi**.
