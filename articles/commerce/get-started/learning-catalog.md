...
---
# <a name="dynamics-365-commerce-learning-catalog"></a>Dynamics 365 Commerce apmācību katalogs 

Atrodiet pareizo tiešsaistes apmācību, personiskās darbnīcas un notikumus savai lomai kā Dynamics 365 Commerce programmas lietotājam.
...
<!-- ![Universal Windows Platform (UWP)](images/platform-uwp.png)  -->  
    ...
    [Komercija](learning-catalog-business-user.md#commerce)

    [E-komercija](learning-catalog-business-user.md#e-commerce)
...
:::row:::
    ...
    [Sākt darbu](learning-catalog-administrator.md#get-started)

    [Komercija](learning-catalog-administrator.md#commerce)

    [E-komercija](learning-catalog-administrator.md#e-commerce)
...
:::row:::
    ...
    [Komercija](learning-catalog-developer.md#commerce)
    ...
    [Komercija](learning-catalog-functional-consultant.md#commerce)

    [E-komercija](learning-catalog-functional-consultant.md#e-commerce)
...
:::row:::
    ...
    [Komercija](learning-catalog-partner-sales.md#commerce)

    [E-komercija](learning-catalog-partner-sales.md#e-commerce)
    ...
    [Komercija](learning-catalog-solution-architect.md#commerce)
