...
description: Šajā rakstā ir aprakstīta Dynamics 365 Commerce izmaksu konfigurācijas sadalīto pasūtījumu pārvaldības (distributed order management — DOM) funkcionalitāte.
author: josaw1
ms.date: 12/05/2018
ms.topic: index-page
ms.prod: ''
