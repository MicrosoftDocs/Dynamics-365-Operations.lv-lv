...
Šajā rakstā ir aprakstītas programmā Microsoft Dynamics 365 for Retail pieejamās mazumtirdzniecības hierarhijas.
...
## <a name="retail-hierarchy-types"></a>Mazumtirdzniecības hierarhijas tipi
Nākamajā tabulā ir norādīti pieejamo mazumtirdzniecības kategoriju hierarhijas tipi un katra tipa vispārējais mērķis.

| Kategoriju hierarhijas tips       | Mērķis                                                                                                                                                                                                                                                                                                            |
|-------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Mazumtirdzniecības preču hierarhija      | Izmantojiet šo hierarhijas tipu, lai definētu vispārējo savas organizācijas preču hierarhiju. Varat izmantot šo hierarhijas tipu preču virzīšanai tirgū, cenu noteikšanai un reklamēšanas pasākumiem, kā arī ziņojumu izveides un preču klāsta plānošanai. Šim hierarhijas tipam var piešķirt tikai vienu mazumtirdzniecības preču hierarhiju.                                       |
| Papildu mazumtirdzniecības hierarhija | Lietojiet šo hierarhijas tipu papildu mazumtirdzniecības kategoriju hierarhijām, kuras vēlaties izveidot. Pavasarī, piemēram, jūs reklamējat peldkostīmus. Tādēļ varat iekļaut peldkostīmus atsevišķā kategoriju hierarhijā un veikt reklāmas cenu noteikšanu uz dažādu preču kategorijām. |
