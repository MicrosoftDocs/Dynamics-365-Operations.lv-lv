---
title: "Izvēle starp Retail Modern POS (MPOS) un Cloud POS"
...
# <a name="choose-between-retail-modern-pos-mpos-and-cloud-pos"></a>Izvēle starp Retail Modern POS (MPOS) un Cloud POS
