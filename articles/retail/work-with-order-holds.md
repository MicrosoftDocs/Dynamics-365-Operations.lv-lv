...
description: Šajā tēmā ir aprakstīts, kā strādāt ar pasūtījumu aizturēšanu, izmantojot Dynamics 365 Retail.
author: josaw1
manager: AnnBe
ms.date: 05/14/2018
ms.topic: article
...
Šajā tēmā ir aprakstītas pasūtījumu aizturēšanas funkcijas, kuras ir ietvertas programmā Dynamics 365 Retail zvanu centra pasūtījumiem.
...
Lai izveidotu aizturēšanas iemeslu kodu papildu kopu, dodieties uz **Mazumtirdzniecība** \> **Kanāla iestatīšana** \> **Informācijas kodi**. Šos informācijas kodus var izmantot kā sekundāro iemesla kodu, lai papildus definētu galveno aizturēšanas kodu. Atlasiet **Jauns**, lai izveidotu iemeslu kodu kopu, un pēc tam atlasiet **Apakškodi**, lai definētu papildu iemeslu sarakstu. Lai saistītu definētos informācijas kodus ar zvanu centra kanālu, dodieties uz **Mazumtirdzniecība** \> **Kanāli** \> **Zvanu centri** \> **Visi zvanu centri**. Kopsavilkuma cilnē **Vispārīgi** iestatiet lauku **Aizturēšanas kods**.

## <a name="putting-orders-on-hold"></a>Pasūtījumu aizturēšana

Pasūtījumus, kurus zvanu centra lietotāji izveido uzskaites daļas programmā Retail, var aizturēt manuāli vai automātiski īpašās situācijās.
...
Lai skatītu visus pasūtījumus, kas ir aizturēti manuāli vai automātiski, dodieties uz **Mazumtirdzniecība** \> **Debitori** \> **Pasūtījumu aizturēšana**.
