...
|   Klients                |Atvērt jaunā logā |Atv. iekš. pr. | Atvērt ar POS            | Informācija                           |
|-------------------------|-------------------|----------------|--------------------------|-----------------------------------|
| Modern POS Windows   | ✓*                |    ✓          |       ✓                  | *Atveras jaunā Modern POS logā   |
| Cloud POS               | ✓*                |    ✓          |       X                   |  *Atv. jaunā pārl. cilnē       |
| Modern POS iOS       | ✓*                |    ✓          |       X                  |  *Atv. jaunā pārl. cilnē        |
| Modern POS Android   | ✓*                |    ✓          |       X                  |  *Atv. jaunā pārl. cilnē        |
