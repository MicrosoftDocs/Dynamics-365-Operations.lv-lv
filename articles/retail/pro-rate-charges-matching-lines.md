...
Šajā gadījumā tiek aprakstīta funkcionalitāte, ja automātiskās maksas iestatījumos ir iestatīta opcijas **Proporcionāls aprēķins atbilstošajām pārdošanas rindām** vērtība **Nē**. (Funkcionalitāte ir līdzvērtīga virsraksta līmeņa maksas funkcionalitātei Retail versijā, kas ir vecāka par versiju 10.0.1).
...
2. Sistēma meklē virsraksta līmeņa automātisko maksu konfigurāciju, kas atbilst debitora un piegādes režīma iestatījumiem katrai krājumu grupai. Ja konfigurācija tiek atrasta, sistēma pārskata pakāpēs sadalīto konfigurāciju, lai atrastu maksu, kura ir jāsaista pēc krājumu piegādes grupas režīmā kopējās preču vērtības.
    ...
    **Piegādes režīms 11**
    ...
    - Kopējā mazumtirdzniecības preces vērtība = $70
    - **Maksas vērtība = $7**

    **Piegādes režīms 99**

    - Kopējā mazumtirdzniecības preces vērtība = $80
    - **Maksas vērtība = $15**

    **Piegādes režīms 21**

    - Kopējā mazumtirdzniecības preces vērtība = $15
