...
Šajā tēmā ir sniegts apskats par visu kanālu maksājumiem programmā Microsoft Dynamics 365 for Retail. Tajā ir visaptverošs atbalstīto scenāriju saraksts, informācija par funkcionalitāti, iestatīšanu un problēmu novēršanu, kā arī dažu tipisko problēmu apraksti.
...
- **Visu kanālu maksājumu konfigurācija:** iekšējās uzskaites daļā dodieties uz **Retail \> Headquarters iestatīšana \> Parametri \> Mazumtirdzniecības koplietojamie parametri**. Pēc tam cilnē **Visu kanālu maksājumi** opcijai **Izmantot visu kanālu maksājumus** iestatiet vērtību **Jā**.
...
- Opcija **Visu kanālu maksājumi** lapā **Mazumtirdzniecības koplietojamie parametri** ir iestatīta uz **True**.
...
3. Programmā Retail izmantojiet pakešuzdevumu **Sinhronizēt pasūtījumus** un sadales grafiku **P-001**, lai izveidotu pasūtījumus iekšējās uzskaites daļā.
...
1. Programmas Retail lapas **Klientu apkalpošana** meklēšanas lodziņā ievadiet **Zane Siliņa** un pēc tam atlasiet **Meklēt**. 
