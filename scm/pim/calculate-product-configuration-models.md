---
title: "Aprēķini par produkta konfigurācijas modeļi: bieži uzdotie jautājumi"
description: "Šajā rakstā aprakstīta produkta konfigurācijas modeļu aprēķinus un izskaidrots, kā izmantot aprēķinus, kā arī ierobežojumus."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="calculations-for-product-configuration-models-faq"></a>Aprēķini par produkta konfigurācijas modeļi: bieži uzdotie jautājumi

Šajā rakstā aprakstīta produkta konfigurācijas modeļu aprēķinus un izskaidrots, kā izmantot aprēķinus, kā arī ierobežojumus.
...
**Izteiksme:** ja\[decimalAttribute1 &lt;= decimalAttribute2, True, False\]  

**DecimalAttribute1** galda garums un **decimalAttribute2** galdautu garums. Šī izteiksme mērķa atribūtam atgriež vērtību **True**, ja vērtība **decimalAttribute2** ir lielāka par vai vienāda ar vērtību **decimalAttribute1**. Pretējā gadījumā izteiksme atgriež vērtību **False**. Tātad galdauta mērījums ir pieņemams, ja galdauta garums ir vienāds ar vai lielāks par galda garumu.
...
Šajā izteiksmē, mērķa aprēķināšanai ir strāvas vadu garums un ievades vērtība ir krāsu:  

**Izteiksme:**\[ja krāsa = = "Zaļie", 1.5, 1.0\]  

Konfigurējot krājumu, strāvas vadu garums ir iestatīts uz **1.5** ja norādāt **Green** kā krāsu atribūta vērtību. Ja norādāt jebkuru citu krāsu, garums ir iestatīts uz **1,0**. Tomēr, tā kā aprēķini ir vienvirziena, šis aprēķins neiestata krāsas atribūta vērtību kā **Zaļa**, kad norādāt garumu **1,5**.
...
## <a name="how-do-i-set-a-target-attribute-as-hidden-or-readonly"></a>Kā iestatīt mērķa atribūtu kā slēptu vai tikai lasāms?
Lai atribūtu iestatītu kā slēptu vai tikai lasāmu, izpildiet tālāk aprakstītās darbības.

1.  Noklikšķiniet uz **produkta informācijas pārvaldības**&gt;**kopējo**&gt;**produkta konfigurācijas modeļiem**.
...
Nr.p.k. Vērtības, ko iestatāt, konfigurējot produkts ir vērtības, kas tiek izmantotas. Aprēķins, kas notiek, kad ir mainītas aprēķina ievades vērtības, nevar pārrakstīt vērtības, kuras jūs norādījāt attiecīgajam atribūtam.
...
-   Aprēķina atgrieztās vērtības neatbilst atribūta sfērai. Piemērs tam ir vesels skaitlis no \[1..10\], kas tiek aprēķināta uz 0.
