...
- Lauks **CustomerGroupId** jāatjaunina uz derīgu vērtību programmā Finance and Operations. Varat norādīt noklusējuma vērtību vai arī vērtību varat iestatīt, izmantojot vērtības karti. Noklusējuma veidnes vērtība ir **10**.
- Lauks **Adreses valsts reģiona kods** programmā Finance and Operations ir obligāts. Lai izvairītos no sinhronizācijas kļūdām, varat norādīt noklusējuma vērtību. Šo noklusējuma vērtību izmanto, ja lauks programmā Sales ir atstāts tukšs.
