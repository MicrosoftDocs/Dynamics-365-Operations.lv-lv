...
-   Pārliecinieties, vai mērvienības **Atbalstītās decimāldaļas** atbilst prasībām sadaļā **CDS -\> Adresāts**. Ja jums ir nepieciešamas citas vērtības katrai mērvienībai, tās var mainīt, izmantojot mērvienības **ValueMap**, piemēram, [Katrs: 0] un [Mārciņa: 2].

    -   Veidnes vērtība tiek iestatīta uz noklusējuma vērtību 0.
