...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Pārskatiet un mainiet pašizmaksas jaunās versijas konversijas ierakstam
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. identificē krājumus, lai konvertētu standarta izmaksu
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Ievadiet vai aprēķinātu gaida standarta pašizmaksa katrai precei, kas konvertē
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Pārbaudiet un atrisinātu visus jautājumus attiecībā uz precēm, kas ir pārvēršamā
...
## <a name="6-change-the-status-of-the-conversion-record-to-ready"></a>6. mainīt Ready konversijas ieraksta statusu
...
## <a name="7-back-up-the-database-before-conversion"></a>7. dublēt datu bāzi, pirms pārvēršanas
Dublējums ļauj atjaunot datu bāzi, ja pārveidošanas procesa laikā rodas kļūdas.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. veikt konvertēšanu, kad konvertēšanas ierakstam ir gatava statuss
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. pārbaudīt un saskaņot krājumu vērtības konvertēto krājumiem
