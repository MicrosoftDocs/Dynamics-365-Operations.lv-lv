---
title: "Manuāli pielāgojiet bāzes prognoze"
...
# <a name="make-manual-adjustments-to-the-baseline-forecast"></a>Manuāli pielāgojiet bāzes prognoze
...
-   Pirmajā kolonnā ir redzami krājumi, krājumu sadalījuma principi, uzņēmumi un citi elementi, par kuriem ir ģenerēta prognoze. Lapas apakšvirsraksts norāda pašreizējo prognozes dimensiju, kas redzamas režģī, aprakstu. Piemēram, ja lapā apakšvirsraksts ir **uzņēmuma / Site / krājumu sadalījuma**, un viens no režģa rindu virsrakstos ir **USMF / 1 / D\_Alloc**, šīs rindas parāda prognoze USMF uzņēmumam, vietas 1, un **D\_Alloc** krājumu sadalījuma atslēgu.
...
## <a name="forecast-aggregation-and-deaggregation"></a>Budžeta apvienošana un deaggregation
...
Kad no prognozētā daudzuma korekciju kopsavilkuma līmenī, sistēma izmanto svērto sadalījuma izplatīt izmaiņas starp rindām, kas izveidotu summēšanas. 
...
-   Ja izmantojat Dynamics 365 operācijas pieprasījuma prognozēšanas Microsoft Azure mašīnu apmācības pakalpojumu, varat norādīt ticamības līmeni procentos, kuru vajadzētu būt prognozi, kura tiek ģenerēta. Ticamības intervālu veido vairākas vērtības, kas darbojas kā labs pieprasījuma apjoma prognozes aprēķins. Ticamības līmenis 95 % norāda, ka pastāv 5 % risks, ka pieprasījuma apjoma prognoze nav ticamības intervāla diapazonā.
