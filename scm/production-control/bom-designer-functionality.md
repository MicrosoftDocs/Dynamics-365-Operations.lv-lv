...
<li>Ja princips ir iestatīts uz <strong>atlasītie/aktīvo vai atlasītās</strong>, MK versijas vai maršruta versijas var atlasīt, noklikšķinot uz <strong>MK</strong>&gt;<strong>MK versijas</strong> vai <strong>maršruta</strong>&gt;<strong>maršruta versijas</strong>.</li>
</ul></td>
</tr>
<tr class="even">
...
Lietojot MK struktūras veidotāju, lai pārskatītu vai rediģētu MK, kas sastāv no viena vai vairākiem veidošanas līmeņiem, maršruts, kas ir saistīts ar augstākā līmeņa krājumu, parasti aptver pilnu MK hierarhiju. Lai vienkāršotu pārskatu, displejā var bloķēt augšējā līmeņa maršrutu, noklikšķinot uz **View**&gt;**atslēga maršruta**. Lai atbloķētu maršrutu, noklikšķiniet **View**&gt;**Unlock maršruta**.

## <a name="adding-and-editing-boms-and-bom-lines"></a>MK un MK rindu pievienošana un rediģēšana
Izmantošanas * * MK rindas * * vai **MK** funkcijas, lai mainītu MK rindu vai MK. Atlasot zaru kokā, zara tips nosaka, funkcijas, kas ir pieejamas.
...
| MK rindas &gt;dzēšana               | Dzēst MK rindu no atlasītā MK.                                                                  | Šī funkcija ir pieejama, kad MK rindas zars ir atlasīts, un MK nav slēgta rediģēšanai.                                                                                                                                                                                             |
| MK rindas &gt;pirms rindiņas pievienošana      | Atveriet dialoglodziņu, kurā var atlasīt preces variantu, ko iekļaut pirms atlasītās MK rindas.         | Šī funkcija ir pieejama, ja ir atlasīts MK rindas zars.                                                                                                                                                                                                                                   |
| MK rindas &gt;IMS komponentu pievienošana | Atveriet dialoglodziņu, kurā var atlasīt preces variantu, ko iekļaut atlasītās MK rindas beigās.       | Šī funkcija ir pieejama, ja atlasītajam zaram ir atlasīts MK. Ja šī funkcija nav pieejama, atlasītajam krājuma variantam, iespējams, nav norādīta MK versija. Šajā gadījumā jūs varat noklikšķināt uz **MK**&gt;**izveidot versija** veidot trūkstošo versija atlasītajā mezglā. |
| MK rindas &gt;pēc rindiņas pievienošana       | Atveriet dialoglodziņu, kurā var atlasīt preces variantu, ko iekļaut pēc atlasītās MK rindas.          | Šī funkcija ir pieejama, ja ir atlasīts MK rindas zars.                                                                                                                                                                                                                                   |
| MK &gt;izveidot versija             | Izveidojiet jaunu MK versiju vai MK atlasītā zara preces variantam.                             | Šī funkcija ir pieejama, ja atlasītais MK rindas zars ir saistīts ar krājumu, kura ražošanas veids ir **MK** vai **Formula**.                                                                                                                                                  |
| MK &gt;aprēķins                | Atveriet dialoglodziņu, kur var palaist izmaksu vai pārdošanas cenas aprēķinu atlasītās preces variantam. | Šī funkcija ir pieejama, ja atlasītais zars ir saistīts ar MK versiju.                                                                                                                                                                                                         |
| MK &gt;, pārbaudiet                      | Apstiprināt un pārbaudīt atlasīto MK.                                                                      | Šī funkcija ir pieejama, ja atlasītais zars ir saistīts ar MK versiju.                                                                                                                                                                                                         |
