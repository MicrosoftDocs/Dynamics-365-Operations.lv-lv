...
| Par                       | Skatiet informāciju par sistēmu, piemēram, versijas numuru, noliktavas ID un darbinieku, kurš pašlaik ir pieteicies.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
<td>Atlasiet darba veidni, kurā procesam tiks izveidots darbs. Piemēram, ja saņemat krājumu kādam pirkšanas pasūtījumam, izvietošanas darbs tiks ģenerēts, pamatojoties uz darba veidni. Ja neatlasāt darba veidni, Microsoft Dynamics 365 for Operations piešķir veidni, pamatojoties uz vaicājuma kritērijiem. Plašāku informāciju par darbu veidnēm skatiet sadaļā <a href="control-warehouse-location-directives.md">Noliktavas darbu kontrolēšana ar darba veidnēm un novietojuma direktīvām</a>.</td>
</tr>
</tbody>
</table>
...
[Iestatīt mobilās ierīces izvēlnes vienumu pirkšanas pasūtījuma darba veikšanai (uzdevuma ceļvedis)](https://ax.help.dynamics.com/en/wiki/set-up-a-mobile-device-menu-item-for-completing-work-of-type-purchase-order/)

[Iestatīt mobilās ierīces izvēlnes vienumu saņemto krājumu reģistrēšanai (uzdevuma ceļvedis)](https://ax.help.dynamics.com/en/wiki/set-up-a-mobile-device-menu-item-to-register-received-items/)
